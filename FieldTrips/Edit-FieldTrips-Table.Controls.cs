...
// Edit_FieldTrips_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_FieldTrips_Table
{
...
// Base class for the FieldTripOptionsTableControlRow control on the Edit_FieldTrips_Table page.
...
public class BaseFieldTripOptionsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetDescription1()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.Description1.ID))
            {
            
                this.Description1.Text = this.PreviousUIData[this.Description1.ID].ToString();
            ...
            // this.Description1 is the ASP:TextBox on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.DescriptionSpecified) {
              ...
              this.Description1.Text = FieldTripOptionsTable.Description.Format(FieldTripOptionsTable.Description.DefaultValue);
        ...
        public virtual void GetDescription1()
        {
            ...
            // save it into the Description field in DataSource DatabaseOLR_db%dbo.FieldTripOptions record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.Description1.Text, FieldTripOptionsTable.Description);							
        ...
        public virtual void GetPlacesAvailable()
        {
            ...
            // save it into the PlacesAvailable field in DataSource DatabaseOLR_db%dbo.FieldTripOptions record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.PlacesAvailable.Text, FieldTripOptionsTable.PlacesAvailable);							
      ...
      // To customize, override this method in FieldTripOptionsTableControlRow.
        ...
        FieldTripOptionsTableControl tc= ((FieldTripOptionsTableControl)MiscUtils.GetParentControlObject(this, "FieldTripOptionsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((FieldTripOptionsTableControlRow)this);
                    }
                    this.Visible = false;
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox Description1 {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Description1");
            }
        }
...
// Base class for the FieldTripOptionsTableControl control on the Edit_FieldTrips_Table page.
    ...
    // Setup default pagination settings.
      ...
      FieldTripOptionsRecord rec = new FieldTripOptionsRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("FieldTripOptionsTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (FieldTripOptionsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        FieldTripOptionsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual FieldTripOptionsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripOptionsTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_FieldTrips_Table.FieldTripOptionsTableControlRow")));
...
// Base class for the FieldTripsTableControlRow control on the Edit_FieldTrips_Table page.
...
public class BaseFieldTripsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetDate0()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.Date0.ID))
            {
            
                this.Date0.Text = this.PreviousUIData[this.Date0.ID].ToString();
        ...
        public virtual void SetTime()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.Time.ID))
            {
            
                this.Time.Text = this.PreviousUIData[this.Time.ID].ToString();
              
                return;
            }
            
                    
            // Set the Time TextBox on the webpage with value from the
            // DatabaseOLR_db%dbo.FieldTrips database record.

            // this.DataSource is the DatabaseOLR_db%dbo.FieldTrips record retrieved from the database.
            // this.Time is the ASP:TextBox on the webpage.
        ...
        public virtual void GetDate0()
        {
            ...
            // save it into the Date field in DataSource DatabaseOLR_db%dbo.FieldTrips record.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.Date0.Text, FieldTripsTable.Date0);							
        ...
        public virtual void GetDescription()
        {
            ...
            // Retrieve the value entered by the user on the Description ASP:TextBox, and
            // save it into the Description field in DataSource DatabaseOLR_db%dbo.FieldTrips record.
        ...
        public virtual void GetTime()
        {
            ...
            // Retrieve the value entered by the user on the Time ASP:TextBox, and
            // save it into the Time field in DataSource DatabaseOLR_db%dbo.FieldTrips record.
            // Parse will also validate the date to ensure it is of the proper format
            // and a valid date.  The format is verified based on the current culture 
            // settings including the order of month, day and year and the separator character.
            // Parse throws an exception if the date is invalid.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.Time.Text, FieldTripsTable.Time);							
      ...
      // To customize, override this method in FieldTripsTableControlRow.
        ...
        public virtual void DeleteRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            if (!this.Page.IsPageRefresh) {
        FieldTripsTableControl tc= ((FieldTripsTableControl)MiscUtils.GetParentControlObject(this, "FieldTripsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((FieldTripsTableControlRow)this);
                    }
                    this.Visible = false;
                    tc.SetFormulaControls();                    
                }
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void Time_TextChanged(object sender, EventArgs args)
        {
...
// Base class for the FieldTripsTableControl control on the Edit_FieldTrips_Table page.
    ...
    // Setup default pagination settings.
      ...
      FieldTripsRecord rec = new FieldTripsRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            protected virtual void SetFocusToAddedRow()
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("FieldTripsTableControlRepeater");
            if (rep == null || rep.Items.Count == 0) return; 			
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items) {
                // Loop through all rows in the table, set its DataSource and call DataBind().
                FieldTripsTableControlRow recControl = (FieldTripsTableControlRow)repItem.FindControl("FieldTripsTableControlRow");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (FieldTripsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        FieldTripsTableControlRow[] selectedList = this.GetSelectedRecordControls();
            if (selectedList.Length == 0) {
            return null;
            }
            return selectedList[0];
        ...
        public virtual FieldTripsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripsTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_FieldTrips_Table.FieldTripsTableControlRow")));
