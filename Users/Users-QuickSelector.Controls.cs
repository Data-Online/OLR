...
namespace OLR.UI.Controls.Users_QuickSelector
{
...
public class BaseSelectorTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        {
            // Load the data from the database into the DataSource DatabaseOLR_db%dbo.Users record.
...
public class BaseSelectorTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OLR.Business.UsersRecord);
                      this.DataSource = (UsersRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    Type myrec = typeof(OLR.Business.UsersRecord);
                    this.DataSource = (UsersRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual UsersRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
                  ...
                  
            {
                ...
                return UsersTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                UsersTable databaseTable = new UsersTable();
                ...
                return (recList.ToArray(typeof(UsersRecord)) as UsersRecord[]);
            }            
        ...
        {    
            ...
            {
                BaseColumn col = UsersTable.GetColumnByName(field);
            ...
            if (includeFormulaAndDFKAParameter) 
            {
                if (formula != "")
                {
                    foreach (BaseColumn col in MiscUtils.GetFormulaFieldList(formula, UsersTable.Instance.TableDefinition))
                    {
                        if (col != null && !columnList.Contains(col))
                            columnList.Add(col);             
                    }
                ...
                {
                    BaseColumn col = UsersTable.GetColumnByName(displayFieldName);
                    if (col != null && !columnList.Contains(col))
                        columnList.Add(col);             
                }
            }
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.Search, this.GetFromSession(this.Search)), true, false);
		        ...
		        if (!string.IsNullOrEmpty(this.Page.Request["dependOnField"]) && this.Page.Request["dependOnVal"] != null) {
			          BaseColumn dependOnCol = UsersTable.GetColumnByName(this.Page.GetDecryptedURLParameter("dependOnField"));
                if (dependOnCol != null){                
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_Search(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OLR.Business.UsersRecord[] recordList  = UsersTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (UsersRecord rec in recordList ){
      ...
      UsersRecord rec = new UsersRecord();
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OLR.Business.UsersRecord);
                this.DataSource = (UsersRecord[])(finalList.ToArray(myrec));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.Page.Response.Redirect(url);
        ...
        public  UsersRecord[] DataSource {
            ...
            get {
                return (UsersRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public virtual SelectorTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (SelectorTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Users_QuickSelector.SelectorTableControlRow")));
