...
// Show_Contacts_Gallery3.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Contacts_Gallery3
{
...
// Base class for the ContactsTableControlRow control on the Show_Contacts_Gallery3 page.
        ...
        public virtual void SetImagewithOverlaidText()
                  {
                        ...
                        this.ImagewithOverlaidText.Text = EvaluateFormula("ContactsTableControlRow.GetImageWithOverlaidText(\"\", \"<a class=\\\"button_link\\\" href=\\\"\" + ContactsTableControlRow.ModifyRedirectUrl(\"../Contacts/Show-Contacts.aspx?Contacts={PK}\", \"\", True) + \"\\\">\" + Address2 + \"</a>\", ContactsTableControlRow.ModifyRedirectUrl(\"../Contacts/Show-Contacts.aspx?Contacts={PK}\", \"\", True))");
...
// Base class for the ContactsTableControl control on the Show_Contacts_Gallery3 page.
...
public class BaseContactsTableControl : OLR.UI.BaseApplicationTableControl
{
       ...
       public BaseContactsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.Address2Filter)) 				
                    initialVal = this.GetFromSession(this.Address2Filter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"Address2\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] Address2FilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in Address2FilteritemListFromSession)
                    {
                        ...
                        {
                            this.Address2Filter.Items.Add(item);
                            this.Address2Filter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.Address2Filter.Items)
                    {
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.SortControl.SelectedIndexChanged += new EventHandler(SortControl_SelectedIndexChanged);
              ...
              this.Address2Filter.SelectedIndexChanged += Address2Filter_SelectedIndexChanged;                  
        ...
        {    
                  ...
                  
            {
                ...
                return ContactsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual ContactsRecord[] CopyArray(int index, ContactsRecord[,] recs, int columns)
      {
        ContactsRecord[] recsCopy = new ContactsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            ContactsRecord[,] recs = new ContactsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            ContactsRecord[] HColDataSource = new ContactsRecord[Convert.ToInt32(rows)];
            ...
            System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "ContactsTableControlRepeater1");
            ...
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep1.Items)
            {
              ...
              ContactsRecord[] VColDataSource = new ContactsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("ContactsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              ContactsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                ContactsTableControlRow recControl = (ContactsTableControlRow)innerRepItem.FindControl("ContactsTableControlRow");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.Address2Filter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.Address2Filter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.Address2Filter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.Address2Filter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(ContactsTable.Address2, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String Address2FilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "Address2Filter_Ajax"];
            if (MiscUtils.IsValueSelected(Address2FilterSelectedValue)) {

              
        if (Address2FilterSelectedValue != null){
                        string[] Address2FilteritemListFromSession = Address2FilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in Address2FilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(ContactsTable.Address2, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              ...
              ContactsTableControlRow[] recControls = this.GetRecordControls();
                foreach (ContactsTableControlRow recControl in recControls) 
		{
      ...
      ContactsRecord rec = new ContactsRecord();
        ...
        public virtual void SetAddress2Filter()
        {
            
            ArrayList Address2FilterselectedFilterItemList = new ArrayList();
            string Address2FilteritemsString = null;
            if (this.InSession(this.Address2Filter))
                Address2FilteritemsString = this.GetFromSession(this.Address2Filter);
            
            if (Address2FilteritemsString != null)
            {
                string[] Address2FilteritemListFromSession = Address2FilteritemsString.Split(',');
                foreach (string item in Address2FilteritemListFromSession)
                {
                    Address2FilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateAddress2Filter(MiscUtils.GetSelectedValueList(this.Address2Filter, Address2FilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../Contacts/Contacts-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.Address2Filter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("Address2")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.Address2Filter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(Address2Filter.AutoPostBack).ToLower() + ", event); return false;";
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("PSNZ Applied For {Txt:Ascending}"), "PSNZAppliedFor Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("PSNZ Applied For {Txt:Descending}"), "PSNZAppliedFor Desc"));
        ...
        // Get the filters' data for Address2Filter.
                
        protected virtual void PopulateAddress2Filter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_Address2Filter();            
            this.Address2Filter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_Address2Filter function.
            // It is better to customize the where clause there.
             
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(ContactsTable.Address2, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = ContactsTable.GetValues(ContactsTable.Address2, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( ContactsTable.Address2.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = ContactsTable.Address2.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.Address2Filter.Items.FindByText(fvalue);
                ...
                this.Address2Filter.Items.Add(newItem);
            ...
            this.Address2Filter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.Address2Filter.Items.Count == 0)
                this.Address2Filter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OLR"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_Address2Filter()
        {
            // Create a where clause for the filter Address2Filter.
            // This function is called by the Populate method to load the items 
            // in the Address2FilterQuickSelector
            ...
            Address2FilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.Address2Filter, Address2FilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (Address2FilterselectedFilterItemList == null || Address2FilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in Address2FilterselectedFilterItemList)
                {
            
      
   
                    wc.iOR(ContactsTable.Address2, BaseFilter.ComparisonOperator.EqualsTo, item);
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList Address2FilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.Address2Filter, null);
            string Address2FilterSessionString = "";
            if (Address2FilterselectedFilterItemList != null){
                foreach (string item in Address2FilterselectedFilterItemList){
                    Address2FilterSessionString = String.Concat(Address2FilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.Address2Filter, Address2FilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("Address2Filter_Ajax", Address2FilterSessionString);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.Address2Filter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Contacts" ;
              ...
              
        {
              ...
              try
              {
                    string url = "../Contacts/Add-Contacts.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "ContactsTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "ContactsTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(Address2Filter))
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Contacts-Gallery3.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If Show-Contacts-Gallery3.PDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Address2}", record.Format(ContactsTable.Address2), ReportEnum.Align.Left);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Contacts-Gallery3.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If Show-Contacts-Gallery3.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void Address2Filter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector Address2Filter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Address2Filter");
            }
        }              
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Contacts_Gallery3.ContactsTableControlRow")));
