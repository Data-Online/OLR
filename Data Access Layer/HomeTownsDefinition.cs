...
/// <see cref="HomeTownsTable">OLR.HomeTownsTable</see> class
...
#region "Definition (XML) for HomeTownsDefinition table"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>HomeTownId</columnName>");
         tbf.Append(      @"<columnUIName>Home Town</columnUIName>");
