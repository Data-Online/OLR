...
// Show_Contacts_Table2.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Contacts_Table2
{
...
// Base class for the ContactsTableControlRow control on the Show_Contacts_Table2 page.
...
// Base class for the ContactsTableControl control on the Show_Contacts_Table2 page.
...
public class BaseContactsTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.MobileNumberFilter) || this.InSession(this.MobileNumberFilter)){
      ...
      ContactsRecord rec = new ContactsRecord();
        ...
        public virtual void SetMobileNumberFilter()
        {
            ...
            this.PopulateMobileNumberFilter(MiscUtils.GetSelectedValueList(this.MobileNumberFilter, MobileNumberFilterselectedFilterItemList), 500);
              ...
              url += "?Target=" + this.MobileNumberFilter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("MobileNumber")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldFilterMultiSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
                    ...
                    
        {
            ...
            if (this.MobileNumberFilter.Items.Count == 0)
                this.MobileNumberFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:PleaseSelect", "OLR"), "--PLEASE_SELECT--"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Contacts-Table2.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If Show-Contacts-Table2.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Contacts-Table2.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If Show-Contacts-Table2.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Contacts_Table2.ContactsTableControlRow")));
