...
/// <see cref="ConfigurationTable">OLR.ConfigurationTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="ConfigurationTable"></seealso>
public class ConfigurationDefinition
{
#region "Definition (XML) for ConfigurationDefinition table"
	//Next 173 lines contain Table Definition (XML) for table "ConfigurationDefinition"
	...
	/// <see cref="ConfigurationTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>ConfigurationId</columnName>");
         ...
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault>= 1</columnDefault>");
         tbf.Append(      @"<columnDBDefault></columnDBDefault>");
         ...
         tbf.Append(      @"<insertingRecordFormula>= 1</insertingRecordFormula>");
         tbf.Append(      @"<readingRecordFormula></readingRecordFormula>");
         tbf.Append(      @"<updatingRecordFormula>= 1</updatingRecordFormula>");
         tbf.Append(      @"<insertingFormula></insertingFormula>");
         tbf.Append(      @"<updatingFormula></updatingFormula>");
         tbf.Append(    "</Column>");
         tbf.Append(    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">");
         tbf.Append(      @"<columnName>SendEmailCopies</columnName>");
         tbf.Append(      @"<columnUIName>Send Email Copies</columnUIName>");
         ...
         tbf.Append(      @"<columnName>EmailCopiesAddress</columnName>");
         tbf.Append(      @"<columnUIName>Email Copies Address</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Configuration</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Configuration_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Configuration</TableCodeName>");
         tbf.Append(  @"<FolderName>Configuration</FolderName>");
         tbf.Append(  @"<MenuName>Configuration</MenuName>");
         tbf.Append(  @"<QSPath>../Configuration/Configuration-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOLRConfiguration</TableStoredProcPrefix>");
