...
// Edit_FieldTripOptions_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_FieldTripOptions_Table
{
...
// Base class for the FieldTripOptionsTableControlRow control on the Edit_FieldTripOptions_Table page.
...
public class BaseFieldTripOptionsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void GetFieldTripId()
        {
         // Retrieve the value entered by the user on the FieldTripId ASP:QuickSelector, and
            // save it into the FieldTripId field in DataSource DatabaseOLR_db%dbo.FieldTripOptions record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.FieldTripId), FieldTripOptionsTable.FieldTripId);			
...
// Base class for the FieldTripOptionsTableControl control on the Edit_FieldTripOptions_Table page.
    ...
    // Setup default pagination settings.
      ...
      FieldTripOptionsRecord rec = new FieldTripOptionsRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.FieldTripId)) {
                            rec.Parse(recControl.FieldTripId.SelectedItem.Value, FieldTripOptionsTable.FieldTripId);
                        }
...
#region "Helper Functions"
        ...
        public virtual FieldTripOptionsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripOptionsTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_FieldTripOptions_Table.FieldTripOptionsTableControlRow")));
