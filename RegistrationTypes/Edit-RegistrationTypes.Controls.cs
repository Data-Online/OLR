...
// Edit_RegistrationTypes.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_RegistrationTypes
{
...
// Base class for the RegistrationTypesRecordControl control on the Edit_RegistrationTypes page.
...
public class BaseRegistrationTypesRecordControl : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RegistrationTypesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-RegistrationTypes"] = recId;
