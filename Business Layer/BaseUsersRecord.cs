...
public class BaseUsersRecord : PrimaryKeyRecord, IUserIdentityRecord, IUserRoleRecord
{
...
#region "Convenience methods to get/set values of fields"
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's Users_.LastLoginDate field.
	/// </summary>
	public ColumnValue GetLastLoginDateValue()
	{
		return this.GetValue(TableUtils.LastLoginDateColumn);
	}

	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's Users_.LastLoginDate field.
	/// </summary>
	public DateTime GetLastLoginDateFieldValue()
	{
		return this.GetValue(TableUtils.LastLoginDateColumn).ToDateTime();
	}
	...
	/// This is a convenience method that allows direct modification of the value of the record's Users_.LastLoginDate field.
	/// </summary>
	public void SetLastLoginDateFieldValue(string val)
	{
		this.SetString(val, TableUtils.LastLoginDateColumn);
	}
	...
	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's Users_.ActiveEventId field.
	/// </summary>
	public ColumnValue GetActiveEventIdValue()
	{
		return this.GetValue(TableUtils.ActiveEventIdColumn);
	}

	/// <summary>
	/// This is a convenience method that provides direct access to the value of the record's Users_.ActiveEventId field.
	/// </summary>
	public Int32 GetActiveEventIdFieldValue()
	{
		return this.GetValue(TableUtils.ActiveEventIdColumn).ToInt32();
	}

	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's Users_.ActiveEventId field.
	/// </summary>
	public void SetActiveEventIdFieldValue(ColumnValue val)
	{
		this.SetValue(val, TableUtils.ActiveEventIdColumn);
	}

	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's Users_.ActiveEventId field.
	/// </summary>
	public void SetActiveEventIdFieldValue(string val)
	{
		this.SetString(val, TableUtils.ActiveEventIdColumn);
	}

	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's Users_.ActiveEventId field.
	/// </summary>
	public void SetActiveEventIdFieldValue(double val)
	{
		ColumnValue cv = new ColumnValue(val);
		this.SetValue(cv, TableUtils.ActiveEventIdColumn);
	}

	/// <summary>
	/// This is a convenience method that allows direct modification of the value of the record's Users_.ActiveEventId field.
	/// </summary>
	public void SetActiveEventIdFieldValue(decimal val)
	{
		ColumnValue cv = new ColumnValue(val);
		this.SetValue(cv, TableUtils.ActiveEventIdColumn);
	}
	...
	/// This is a convenience method that allows direct modification of the value of the record's Users_.ActiveEventId field.
	/// </summary>
	public void SetActiveEventIdFieldValue(long val)
	{
		ColumnValue cv = new ColumnValue(val);
		this.SetValue(cv, TableUtils.ActiveEventIdColumn);
	}
...
#region "Convenience methods to get field names"
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's Users_.LastLoginDate field.
	/// </summary>
	...
	public bool LastLoginDateSpecified
	{
		get
		{
			ColumnValue val = this.GetValue(TableUtils.LastLoginDateColumn);
            if (val == null || val.IsNull)
            {
                return false;
            }
	...
	/// This is a convenience method that allows direct modification of the value of the record's Users_.LastLoginDate field.
	/// </summary>
	public string LastLoginDateDefault
	{
		get
		{
			return TableUtils.LastLoginDateColumn.DefaultValue;
		}
	}
	/// <summary>
	...
	/// <summary>
	/// This is a property that provides direct access to the value of the record's Users_.ActiveEventId field.
	/// </summary>
	public Int32 ActiveEventId
	{
		get
		{
			return this.GetValue(TableUtils.ActiveEventIdColumn).ToInt32();
	...
	/// This is a convenience method that can be used to determine that the column is set.
	/// </summary>
	public bool ActiveEventIdSpecified
	{
		get
		{
			ColumnValue val = this.GetValue(TableUtils.ActiveEventIdColumn);
            if (val == null || val.IsNull)
            {
                return false;
            }
	...
	/// This is a convenience method that allows direct modification of the value of the record's Users_.ActiveEventId field.
	/// </summary>
	public string ActiveEventIdDefault
	{
		get
		{
			return TableUtils.ActiveEventIdColumn.DefaultValue;
		}
	}
