...
// Show_FieldTrips_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_FieldTrips_Table
{
    ...
    public class FieldTripOptionsTableControlRow : BaseFieldTripOptionsTableControlRow
    {
        ...
        {
            base.DataBind();
            AssignTotalAllocated();
        }


        private void AssignTotalAllocated()
        {

            this.FieldTripChoicesCountControl2.Text = EvaluateFormula("LOOKUP(FieldTripChoicesCountQuery2, FieldTripAllocated)");

            WhereClause wc = new WhereClause();

            wc.iAND(FieldTripChoicesTable.FieldTripAllocated, BaseFilter.ComparisonOperator.EqualsTo, this.FieldTripOptionId.Text);
...
//}
//
//public class AvailableWorkshopsRecordControl : BaseAvailableWorkshopsRecordControl
//{
//      
//        // The BaseAvailableWorkshopsRecordControl implements the LoadData, DataBind and other
...
//}
//
public class RegistrationTypesTableControl : BaseRegistrationTypesTableControl
{
    // The BaseRegistrationTypesTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The RegistrationTypesTableControlRow class offers another place where you can customize
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
    
}
public class RegistrationTypesTableControlRow : BaseRegistrationTypesTableControlRow
{
      
        // The BaseRegistrationTypesTableControlRow implements code for a ROW within the
        // the RegistrationTypesTableControl table.  The BaseRegistrationTypesTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of RegistrationTypesTableControl.

        // This is the ideal place to add your code customizations. For example, you can override the DataBind, 
        // SaveData, GetUIData, and Validate methods.
        
}
public class AvailableWorkshopsTableControl : BaseAvailableWorkshopsTableControl
{
    // The BaseAvailableWorkshopsTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The AvailableWorkshopsTableControlRow class offers another place where you can customize
    // the DataBind, GetUIData, SaveData and Validate methods specific to each row displayed on the table.
    
}
public class AvailableWorkshopsTableControlRow : BaseAvailableWorkshopsTableControlRow
{
      
        // The BaseAvailableWorkshopsTableControlRow implements code for a ROW within the
        // the AvailableWorkshopsTableControl table.  The BaseAvailableWorkshopsTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of AvailableWorkshopsTableControl.
...
// Base class for the AvailableWorkshopsTableControlRow control on the Show_FieldTrips_Table page.
// Do not modify this class. Instead override any method in AvailableWorkshopsTableControlRow.
public class BaseAvailableWorkshopsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        public BaseAvailableWorkshopsTableControlRow()
        {
        ...
        // To customize, override this method in AvailableWorkshopsTableControlRow.
        ...
        {
            // Load the data from the database into the DataSource DatabaseOLR_db%dbo.AvailableWorkshops record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = AvailableWorkshopsTable.GetRecord(this.RecordUniqueId, true);
              
                return;
            }
      
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseAvailableWorkshopsTableControl when the data for the entire
            // table is loaded.
            
            this.DataSource = new AvailableWorkshopsRecord();
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetLabel2();
                SetPlacesAvailable1();
                SetPlacesAvailableLabel2();
                SetWorkshopDescription();
                SetWorkshopsCountControl1();
        ...
        public virtual void SetCost()
        {
            ...
            // Set the Cost Literal on the webpage with value from the
            // DatabaseOLR_db%dbo.AvailableWorkshops database record.

            // this.DataSource is the DatabaseOLR_db%dbo.AvailableWorkshops record retrieved from the database.
            // this.Cost is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.CostSpecified) {
                								
                // If the Cost is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(AvailableWorkshopsTable.Cost);
              ...
              this.Cost.Text = AvailableWorkshopsTable.Cost.Format(AvailableWorkshopsTable.Cost.DefaultValue);
            		
            }
            
            // If the Cost is NULL or blank, then use the value specified  
            // on Properties.
            if (this.Cost.Text == null ||
                this.Cost.Text.Trim().Length == 0) {
        ...
        public virtual void SetPlacesAvailable1()
        {
            ...
            // this.DataSource is the DatabaseOLR_db%dbo.AvailableWorkshops record retrieved from the database.
            // this.PlacesAvailable1 is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.PlacesAvailableSpecified) {
                								
                // If the PlacesAvailable is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(AvailableWorkshopsTable.PlacesAvailable);
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.PlacesAvailable1.Text = formattedValue;
              ...
              this.PlacesAvailable1.Text = AvailableWorkshopsTable.PlacesAvailable.Format(AvailableWorkshopsTable.PlacesAvailable.DefaultValue);
            		
            }
            
            // If the PlacesAvailable is NULL or blank, then use the value specified  
            // on Properties.
            if (this.PlacesAvailable1.Text == null ||
                this.PlacesAvailable1.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.PlacesAvailable1.Text = "&nbsp;";
            }
        ...
        public virtual void SetWorkshopDescription()
        {
            ...
            if (this.DataSource != null && this.DataSource.WorkshopDescriptionSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(AvailableWorkshopsTable.WorkshopDescription);
              ...
              this.WorkshopDescription.Text = AvailableWorkshopsTable.WorkshopDescription.Format(AvailableWorkshopsTable.WorkshopDescription.DefaultValue);
        ...
        public virtual void SetPlacesAvailableLabel2()
                  {
                  
                    
        }
                
        public virtual void SetWorkshopsCountControl1()
                  {
                  
                        this.WorkshopsCountControl1.Text = EvaluateFormula("LOOKUP(WorkshopsCountQuery2, AvailableWorkshopId)");
        ...
        public virtual string EvaluateFormula(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS, FormulaEvaluator e)
        {
            ...
            if (includeDS)
            {
                ...
                // add datasource as variables for formula evaluation
                  AvailableWorkshopsTableControl panel;
                panel = (AvailableWorkshopsTableControl)(this.GetParentTableControl());
                  
                e.Variables.Add("WorkshopsCountQuery2", panel.WorkshopsCountQuery2);                                                       
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((AvailableWorkshopsTableControl)MiscUtils.GetParentControlObject(this, "AvailableWorkshopsTableControl")).DataChanged = true;
                ((AvailableWorkshopsTableControl)MiscUtils.GetParentControlObject(this, "AvailableWorkshopsTableControl")).ResetData = true;
            }
        ...
        public virtual void GetPlacesAvailable1()
        {
      ...
      // To customize, override this method in AvailableWorkshopsTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersAvailableWorkshopsTableControl = false;
            hasFiltersAvailableWorkshopsTableControl = hasFiltersAvailableWorkshopsTableControl && false; // suppress warning
            ...
            bool hasFiltersRegistrationTypesTableControl = false;
            hasFiltersRegistrationTypesTableControl = hasFiltersRegistrationTypesTableControl && false; // suppress warning
        ...
        public virtual void Delete()
        {
          ...
          AvailableWorkshopsTable.DeleteRecord(pkValue);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseAvailableWorkshopsTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseAvailableWorkshopsTableControlRow_Rec"] = value;
            }
        }
        
        public AvailableWorkshopsRecord DataSource {
            get {
                return (AvailableWorkshopsRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal Cost {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Cost");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal PlacesAvailable1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PlacesAvailable1");
            }
        }
            
        public System.Web.UI.WebControls.Literal PlacesAvailableLabel2 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PlacesAvailableLabel2");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal WorkshopsCountControl1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "WorkshopsCountControl1");
            }
        }
    ...
    AvailableWorkshopsRecord rec = null;
        ...
        public virtual AvailableWorkshopsRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return AvailableWorkshopsTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the AvailableWorkshopsTableControl control on the Show_FieldTrips_Table page.
// Do not modify this class. Instead override any method in AvailableWorkshopsTableControl.
public class BaseAvailableWorkshopsTableControl : OLR.UI.BaseApplicationTableControl
{
         
       public BaseAvailableWorkshopsTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OLR.Business.AvailableWorkshopsRecord);
                      this.DataSource = (AvailableWorkshopsRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (AvailableWorkshopsTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(OLR.Business.AvailableWorkshopsRecord);
                    this.DataSource = (AvailableWorkshopsRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual AvailableWorkshopsRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(AvailableWorkshopsTable.Column1, true);          
            // selCols.Add(AvailableWorkshopsTable.Column2, true);          
            // selCols.Add(AvailableWorkshopsTable.Column3, true);          
                  ...
                  
            {
                ...
                return AvailableWorkshopsTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                AvailableWorkshopsTable databaseTable = new AvailableWorkshopsTable();
                ...
                return (recList.ToArray(typeof(AvailableWorkshopsRecord)) as AvailableWorkshopsRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return AvailableWorkshopsTable.GetRecordCount(join, where);
            else
            {
                AvailableWorkshopsTable databaseTable = new AvailableWorkshopsTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AvailableWorkshopsTableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            AvailableWorkshopsTableControlRow recControl = (AvailableWorkshopsTableControlRow)(repItem.FindControl("AvailableWorkshopsTableControlRow"));
        ...
        public virtual void RegisterPostback()
        {
          ...
          public virtual string EvaluateFormula(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS, FormulaEvaluator e)
          {
            ...
            if (includeDS)
            {
                ...
                if (WorkshopsCountQuery2 != null) e.Variables.Add("WorkshopsCountQuery2", WorkshopsCountQuery2);                                                       
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for AvailableWorkshopsTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (AvailableWorkshopsTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            AvailableWorkshopsTable.Instance.InnerFilter = null;
            WhereClause wc = new WhereClause();
      ...
      AvailableWorkshopsRecord rec = new AvailableWorkshopsRecord();
        
                        if (recControl.Cost.Text != "") {
                            rec.Parse(recControl.Cost.Text, AvailableWorkshopsTable.Cost);
                  }
                
                        if (recControl.PlacesAvailable1.Text != "") {
                            rec.Parse(recControl.PlacesAvailable1.Text, AvailableWorkshopsTable.PlacesAvailable);
                  }
                
                        if (recControl.WorkshopDescription.Text != "") {
                            rec.Parse(recControl.WorkshopDescription.Text, AvailableWorkshopsTable.WorkshopDescription);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new AvailableWorkshopsRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OLR.Business.AvailableWorkshopsRecord);
                this.DataSource = (AvailableWorkshopsRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(AvailableWorkshopsTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(AvailableWorkshopsTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual WhereClause CreateWhereClause_WorkshopsCountQuery2()
        
        {
            ...
            WhereClause qc = this.CreateQueryClause_WorkshopsCountQuery2();
            if (qc != null) {
                wc.iAND(qc);
            }
        ...
        public virtual WhereClause CreateQueryClause_WorkshopsCountQuery2()
        
        {
            ...
            if (EvaluateFormula("1", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OLR.Business.WorkshopsTable, OLR.Business").TableDefinition.ColumnList.GetByUniqueName(@"Workshops_.Attending"), EvaluateFormula("1", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
        ...
        public virtual void LoadData_WorkshopsCountQuery2()
        
        {
          
              if (!(this.ResetData || this.DataChanged || _WorkshopsCountQuery2.DataChanged) && this.Page.IsPostBack  && this.Page.Request["__EVENTTARGET"] != "isd_geo_location") return;
        
              _WorkshopsCountQuery2.DataChanged = true;
          
              this._WorkshopsCountQuery2.Initialize("WorkshopsCountQuery2", AvailableWorkshopsTable.Instance, 0, 0);
            
               
              // Add the primary key of the record
              WhereClause wc = CreateWhereClause_WorkshopsCountQuery2();
              this._WorkshopsCountQuery2.WhereClause.iAND(wc);                      
          
              // Define selects
          
              this._WorkshopsCountQuery2.AddSelectItem(new SelectItem(AvailableWorkshopsTable.AvailableWorkshopId, AvailableWorkshopsTable.Instance, false, "", ""));
              
                    this._WorkshopsCountQuery2.AddSelectItem(new SelectItem(SelectItem.Operation.COUNT, new SelectItem(SelectItem.ItemType.AllColumns, WorkshopsTable.Instance, "WorkshopsCount", ""), "WorkshopsCount"));
              
              // Define joins if there are any
          
              this._WorkshopsCountQuery2.AddJoin(AvailableWorkshopsTable.AvailableWorkshopId, AvailableWorkshopsTable.Instance, "", WorkshopsTable.AvailableWorkshopId, WorkshopsTable.Instance, "");
          
              this._WorkshopsCountQuery2.LoadData(false, this._WorkshopsCountQuery2.PageSize, this._WorkshopsCountQuery2.PageIndex);                       
                        
        }
      
        private DataSource _WorkshopsCountQuery2 = new DataSource();
        public DataSource WorkshopsCountQuery2
        {
            get
            {
                return _WorkshopsCountQuery2;
             }
        }
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["AvailableWorkshopsTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["AvailableWorkshopsTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = AvailableWorkshopsTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  AvailableWorkshopsRecord[] DataSource {
            ...
            get {
                return (AvailableWorkshopsRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                AvailableWorkshopsTableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        public virtual AvailableWorkshopsTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual AvailableWorkshopsTableControlRow[] GetSelectedRecordControls()
        {
        
            return (AvailableWorkshopsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Table.AvailableWorkshopsTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            AvailableWorkshopsTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OLR"));
            }
            
            foreach (AvailableWorkshopsTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual AvailableWorkshopsTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "AvailableWorkshopsTableControlRow");
	          List<AvailableWorkshopsTableControlRow> list = new List<AvailableWorkshopsTableControlRow>();
	          foreach (AvailableWorkshopsTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
...
// Base class for the FieldTripOptionsTableControlRow control on the Show_FieldTrips_Table page.
...
public class BaseFieldTripOptionsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetDescription2()
        {
            ...
            if (this.DataSource != null && this.DataSource.DescriptionSpecified) {
              ...
              this.Description2.Text = FieldTripOptionsTable.Description.Format(FieldTripOptionsTable.Description.DefaultValue);
        ...
        public virtual void SetFieldTripOptionId()
        {
            ...
            if (this.DataSource != null && this.DataSource.FieldTripOptionIdSpecified) {
                ...
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(FieldTripOptionsTable.FieldTripOptionId);
              ...
              this.FieldTripOptionId.Text = FieldTripOptionsTable.FieldTripOptionId.Format(FieldTripOptionsTable.FieldTripOptionId.DefaultValue);
        ...
        public virtual void SetFieldTripChoicesCountControl()
                  {
                        ...
                        this.FieldTripChoicesCountControl.Text = EvaluateFormula("LOOKUP(FieldTripChoicesCountQuery, FieldTripOptionId)");
        ...
        public virtual void SetFieldTripChoicesCountControl2()
                  {
                        ...
                        this.FieldTripChoicesCountControl2.Text = EvaluateFormula("LOOKUP(FieldTripChoicesCountQuery2, FieldTripOptionId)");
        ...
        public virtual string EvaluateFormula(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS, FormulaEvaluator e)
        {
            ...
            if (includeDS)
            {
                ...
                // add datasource as variables for formula evaluation
                  FieldTripOptionsTableControl panel;
                panel = (FieldTripOptionsTableControl)(this.GetParentTableControl());
        ...
        FieldTripsTableControlRow parentCtrl;
      
            parentCtrl = (FieldTripsTableControlRow)MiscUtils.GetParentControlObject(this, "FieldTripsTableControlRow");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OLR"));
          ...
          this.DataSource.FieldTripId = parentCtrl.DataSource.FieldTripId;
...
// Base class for the FieldTripOptionsTableControl control on the Show_FieldTrips_Table page.
...
public class BaseFieldTripOptionsTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
              ...
              this.PlacesAvailableLabel1.Click += PlacesAvailableLabel1_Click;
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue fieldTripsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = fieldTripsRecordObj;
          fieldTripsRecordObj = tmp;
        FieldTripsTableControlRow fieldTripsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "FieldTripsTableControlRow") as FieldTripsTableControlRow);
          
              if (fieldTripsTableControlObjRow != null && fieldTripsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(FieldTripOptionsTable.FieldTripId, BaseFilter.ComparisonOperator.EqualsTo, fieldTripsTableControlObjRow.GetRecord().FieldTripId.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["FieldTripOptionsTableControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
      ...
      string selectedRecordInFieldTripsTableControl = HttpContext.Current.Session["FieldTripOptionsTableControlWhereClause"] as string;
      
      if (selectedRecordInFieldTripsTableControl != null && KeyValue.IsXmlKey(selectedRecordInFieldTripsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInFieldTripsTableControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(FieldTripOptionsTable.FieldTripId))
      {
      wc.iAND(FieldTripOptionsTable.FieldTripId, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(FieldTripOptionsTable.FieldTripId).ToString());
      }
      ...
      FieldTripOptionsRecord rec = new FieldTripOptionsRecord();
                        ...
                        if (recControl.Description2.Text != "") {
                            rec.Parse(recControl.Description2.Text, FieldTripOptionsTable.Description);
                  }
                
                        if (recControl.FieldTripOptionId.Text != "") {
                            rec.Parse(recControl.FieldTripOptionId.Text, FieldTripOptionsTable.FieldTripOptionId);
                  }
        ...
        public virtual void SetPlacesAvailableLabel1()
                  {
        ...
        
        {
              ...
              this._FieldTripChoicesCountQuery.Initialize("FieldTripChoicesCountQuery", FieldTripOptionsTable.Instance, 0, 0);
              ...
              this._FieldTripChoicesCountQuery.AddSelectItem(new SelectItem(FieldTripOptionsTable.FieldTripOptionId, FieldTripOptionsTable.Instance, false, "", ""));
              ...
              this._FieldTripChoicesCountQuery.AddJoin(FieldTripOptionsTable.FieldTripOptionId, FieldTripOptionsTable.Instance, "", FieldTripChoicesTable.FieldTripOptionId, FieldTripChoicesTable.Instance, "");
        ...
        
        {
              ...
              this._FieldTripChoicesCountQuery1.Initialize("FieldTripChoicesCountQuery1", FieldTripChoicesTable.Instance, 0, 0);
        ...
        
        {
              ...
              this._FieldTripChoicesCountQuery2.Initialize("FieldTripChoicesCountQuery2", FieldTripOptionsTable.Instance, 0, 0);
              ...
              this._FieldTripChoicesCountQuery2.AddSelectItem(new SelectItem(FieldTripOptionsTable.FieldTripOptionId, FieldTripOptionsTable.Instance, false, "", ""));
              ...
              this._FieldTripChoicesCountQuery2.AddJoin(FieldTripOptionsTable.FieldTripOptionId, FieldTripOptionsTable.Instance, "", FieldTripChoicesTable.FieldTripOptionId, FieldTripChoicesTable.Instance, "");
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PlacesAvailableLabel1_Click(object sender, EventArgs args)
        {
            //Sorts by PlacesAvailable when clicked.
              
            // Get previous sorting state for PlacesAvailable.
        
            OrderByItem sd = this.CurrentSortOrder.Find(FieldTripOptionsTable.PlacesAvailable);
            if (sd == null || (this.CurrentSortOrder.Items != null && this.CurrentSortOrder.Items.Length > 1)) {
                // First time sort, so add sort order for PlacesAvailable.
                this.CurrentSortOrder.Reset();
              ...
              this.CurrentSortOrder.Add(FieldTripOptionsTable.PlacesAvailable, OrderByItem.OrderDir.Asc);
            
            } else {
                // Previously sorted by PlacesAvailable, so just reverse.
                sd.Reverse();
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton PlacesAvailableLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PlacesAvailableLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual FieldTripOptionsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripOptionsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Table.FieldTripOptionsTableControlRow")));
...
// Base class for the FieldTripsTableControlRow control on the Show_FieldTrips_Table page.
...
public class BaseFieldTripsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public override void DataBind()
        {
            ...
            bool shouldResetControl = false;
            if (shouldResetControl) { }; // prototype usage to void compiler warnings
            FieldTripOptionsTableControl.FieldTripChoicesCountQuery.DataChanged = true;    
        FieldTripOptionsTableControl.FieldTripChoicesCountQuery1.DataChanged = true;    
        FieldTripOptionsTableControl.FieldTripChoicesCountQuery2.DataChanged = true;    
        ...
        public virtual void SetTime()
        {
            ...
            // Set the Time Literal on the webpage with value from the
            // DatabaseOLR_db%dbo.FieldTrips database record.

            // this.DataSource is the DatabaseOLR_db%dbo.FieldTrips record retrieved from the database.
            // this.Time is the ASP:Literal on the webpage.
                  
            if (this.DataSource != null && this.DataSource.TimeSpecified) {
                								
                // If the Time is non-NULL, then format the value.
                // The Format method will use the Display Format
               string formattedValue = this.DataSource.Format(FieldTripsTable.Time, @"t");
                                
                formattedValue = HttpUtility.HtmlEncode(formattedValue);
                this.Time.Text = formattedValue;
                   
            } 
            
            else {
            
                // Time is NULL in the database, so use the Default Value.  
                // Default Value could also be NULL.
        
              this.Time.Text = FieldTripsTable.Time.Format(FieldTripsTable.Time.DefaultValue, @"t");
            		
            }
            
            // If the Time is NULL or blank, then use the value specified  
            // on Properties.
            if (this.Time.Text == null ||
                this.Time.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.Time.Text = "&nbsp;";
            }
        ...
        public virtual void SetFieldTripsTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "FieldTripsTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "FieldTripsTabContainer").Visible = false;
      ...
      this.Page.CommitTransaction(sender);
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../FieldTrips/Edit-FieldTrips-Table.aspx?FieldTrips={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ExpandRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                FieldTripsTableControl panelControl = (MiscUtils.GetParentControlObject(this, "FieldTripsTableControl") as FieldTripsTableControl);

          FieldTripsTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (FieldTripsTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "FieldTripsTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
...
#region "Helper Properties"
        ...
        public AjaxControlToolkit.TabContainer FieldTripsTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FieldTripsTabContainer");
            }
        }
        
        public System.Web.UI.WebControls.Literal Time {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Time");
            }
        }
            
        public System.Web.UI.WebControls.Literal TimeLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "TimeLabel");
            }
        }
...
// Base class for the FieldTripsTableControl control on the Show_FieldTrips_Table page.
...
public class BaseFieldTripsTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        FieldTripsTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "FieldTripsTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
      ...
      FieldTripsRecord rec = new FieldTripsRecord();
                        ...
                        if (recControl.Time.Text != "") {
                            rec.Parse(recControl.Time.Text, FieldTripsTable.Time);
                  }
...
#region "Helper Functions"
        ...
        public virtual FieldTripsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Table.FieldTripsTableControlRow")));
...
// Base class for the RegistrationsTableControlRow control on the Show_FieldTrips_Table page.
...
public class BaseRegistrationsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual string EvaluateFormula(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS, FormulaEvaluator e)
        {
            ...
            if (includeDS)
            {
                ...
                e.Variables.Add("RegistrationsCountQuery1", panel.RegistrationsCountQuery1);                                                       
...
// Base class for the RegistrationsTableControl control on the Show_FieldTrips_Table page.
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
                  ...
                  LoadData_RegistrationsCountQuery1();
        ...
        SetRegistrationTypesTableControl();
        ...
        public virtual void RegisterPostback()
        {
          ...
          public virtual string EvaluateFormula(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS, FormulaEvaluator e)
          {
            ...
            if (includeDS)
            {
                ...
                if (RegistrationsCountQuery1 != null) e.Variables.Add("RegistrationsCountQuery1", RegistrationsCountQuery1);                                                       
        ...
        public virtual void SaveData()
        {
          ...
          RegistrationTypesTableControl recRegistrationTypesTableControl = (RegistrationTypesTableControl)(MiscUtils.FindControlRecursively(this, "RegistrationTypesTableControl"));
        recRegistrationTypesTableControl.SaveData();
      ...
      RegistrationsRecord rec = new RegistrationsRecord();
        ...
        public virtual void SetRegistrationTypesTableControl()           
        
        {        
            if (RegistrationTypesTableControl.Visible)
            {
                RegistrationTypesTableControl.LoadData();
                RegistrationTypesTableControl.DataBind();
            }
        }
        ...
        public virtual WhereClause CreateWhereClause_RegistrationsCountQuery1()
        ...
        public virtual void LoadData_RegistrationsCountQuery1()
        
        {
          
              if (!(this.ResetData || this.DataChanged || _RegistrationsCountQuery1.DataChanged) && this.Page.IsPostBack  && this.Page.Request["__EVENTTARGET"] != "isd_geo_location") return;
        
              _RegistrationsCountQuery1.DataChanged = true;
          
              this._RegistrationsCountQuery1.Initialize("RegistrationsCountQuery1", RegistrationsTable.Instance, 0, 0);
            
               
              // Add the primary key of the record
              WhereClause wc = CreateWhereClause_RegistrationsCountQuery1();
              this._RegistrationsCountQuery1.WhereClause.iAND(wc);                      
          
              // Define selects
          
                    this._RegistrationsCountQuery1.AddSelectItem(new SelectItem(SelectItem.Operation.COUNT, new SelectItem(SelectItem.ItemType.AllColumns, RegistrationsTable.Instance, "RegistrationsCount", ""), "RegistrationsCount"));
              
              // Define joins if there are any
          
              this._RegistrationsCountQuery1.LoadData(false, this._RegistrationsCountQuery1.PageSize, this._RegistrationsCountQuery1.PageIndex);                       
        ...
        private DataSource _RegistrationsCountQuery1 = new DataSource();
        public DataSource RegistrationsCountQuery1
        {
            get
            {
                return _RegistrationsCountQuery1;
             }
        }
...
#region "Helper Properties"
        ...
        public RegistrationTypesTableControl RegistrationTypesTableControl {
            get {
                return (RegistrationTypesTableControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegistrationTypesTableControl");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual RegistrationsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RegistrationsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Table.RegistrationsTableControlRow")));
...
// Base class for the RegistrationTypesTableControlRow control on the Show_FieldTrips_Table page.
// Do not modify this class. Instead override any method in RegistrationTypesTableControlRow.
public class BaseRegistrationTypesTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        public BaseRegistrationTypesTableControlRow()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in RegistrationTypesTableControlRow.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        public virtual void LoadData()  
        {
            ...
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseRegistrationTypesTableControl when the data for the entire
            // table is loaded.
        ...
        public virtual void SetRegistrationsCountControl1()
                  {
                  
                        this.RegistrationsCountControl1.Text = EvaluateFormula("LOOKUP(RegistrationsCountQuery2, RegistrationTypeId)");
        ...
        public virtual string EvaluateFormula(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS, FormulaEvaluator e)
        {
            ...
            if (includeDS)
            {
                ...
                // add datasource as variables for formula evaluation
                  RegistrationTypesTableControl panel;
                panel = (RegistrationTypesTableControl)(this.GetParentTableControl());
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                // Set the DataChanged flag to True for the for the related panels so they get refreshed as well.
                ((RegistrationTypesTableControl)MiscUtils.GetParentControlObject(this, "RegistrationTypesTableControl")).DataChanged = true;
                ((RegistrationTypesTableControl)MiscUtils.GetParentControlObject(this, "RegistrationTypesTableControl")).ResetData = true;
            }
      ...
      // To customize, override this method in RegistrationTypesTableControlRow.
        ...
        public virtual void Delete()
        {
            ...
            KeyValue pkValue = KeyValue.XmlToKey(this.RecordUniqueId);
          RegistrationTypesTable.DeleteRecord(pkValue);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseRegistrationTypesTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseRegistrationTypesTableControlRow_Rec"] = value;
            }
        }
        
        public RegistrationTypesRecord DataSource {
            get {
                return (RegistrationTypesRecord)(this._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal RegistrationsCountControl1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegistrationsCountControl1");
            }
        }
    ...
    public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
    {
        RegistrationTypesRecord rec = null;
    ...
    RegistrationTypesRecord rec = null;
        ...
        public virtual RegistrationTypesRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return RegistrationTypesTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the RegistrationTypesTableControl control on the Show_FieldTrips_Table page.
// Do not modify this class. Instead override any method in RegistrationTypesTableControl.
public class BaseRegistrationTypesTableControl : OLR.UI.BaseApplicationTableControl
{
         
       public BaseRegistrationTypesTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                        // Initialize an empty array of records
                      ArrayList alist = new ArrayList(0);
                      Type myrec = typeof(OLR.Business.RegistrationTypesRecord);
                      this.DataSource = (RegistrationTypesRecord[])(alist.ToArray(myrec));
                      // Add records to the list if needed.
                      this.AddNewRecords();
                      this._TotalRecords = 0;
                      this._TotalPages = 0;
                ...
                if (this.AddNewRecord > 0) {
                    // Make sure to preserve the previously entered data on new rows.
                    ArrayList postdata = new ArrayList(0);
                    foreach (RegistrationTypesTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                            rc.DataSource = rc.GetRecord();
                            rc.GetUIData();
                            postdata.Add(rc.DataSource);
                    ...
                    Type myrec = typeof(OLR.Business.RegistrationTypesRecord);
                    this.DataSource = (RegistrationTypesRecord[])(postdata.ToArray(myrec));
                } 
                else {
                    // Get the records from the database
        ...
        public virtual RegistrationTypesRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            // by default, Select * will be executed to get a list of records.  If you want to run Select Distinct with certain column only, add the column to selCols
            ColumnList selCols = new ColumnList();                 
            ...
            // However, if you don't specify PK, row button click might show an error message.
            // And make sure you write similar code in GetRecordCount as well
            // selCols.Add(RegistrationTypesTable.Column1, true);          
            // selCols.Add(RegistrationTypesTable.Column2, true);          
            // selCols.Add(RegistrationTypesTable.Column3, true);          
                  ...
                  
            {
                ...
                return RegistrationTypesTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                RegistrationTypesTable databaseTable = new RegistrationTypesTable();
                databaseTable.SelectedColumns.Clear();
                databaseTable.SelectedColumns.AddRange(selCols);
                ...
                orderBy.ExpandForeignKeyColums = false;
                recList = databaseTable.GetRecordList(join, where.GetFilter(), null, orderBy, pageIndex, pageSize);
                return (recList.ToArray(typeof(RegistrationTypesRecord)) as RegistrationTypesRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return RegistrationTypesTable.GetRecordCount(join, where);
            else
            {
                RegistrationTypesTable databaseTable = new RegistrationTypesTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegistrationTypesTableControlRepeater"));
        if (rep == null){return;}
        rep.DataSource = this.DataSource;
        rep.DataBind();
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Loop through all rows in the table, set its DataSource and call DataBind().
            RegistrationTypesTableControlRow recControl = (RegistrationTypesTableControlRow)(repItem.FindControl("RegistrationTypesTableControlRow"));
            recControl.DataSource = this.DataSource[index];            
            if (this.UIData.Count > index)
                recControl.PreviousUIData = this.UIData[index];
            recControl.DataBind();
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for RegistrationTypesTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (RegistrationTypesTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        {
            // This CreateWhereClause is used for loading the data.
            RegistrationTypesTable.Instance.InnerFilter = null;
            WhereClause wc = new WhereClause();
      ...
      RegistrationTypesRecord rec = new RegistrationTypesRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new RegistrationTypesRecord());
                newUIDataList.Insert(0, new Hashtable());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OLR.Business.RegistrationTypesRecord);
                this.DataSource = (RegistrationTypesRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(RegistrationTypesTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(RegistrationTypesTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        
        {
              ...
              if (!(this.ResetData || this.DataChanged || _RegistrationsCountQuery2.DataChanged) && this.Page.IsPostBack  && this.Page.Request["__EVENTTARGET"] != "isd_geo_location") return;
        
              _RegistrationsCountQuery2.DataChanged = true;
          
              this._RegistrationsCountQuery2.Initialize("RegistrationsCountQuery2", RegistrationTypesTable.Instance, 0, 0);
            
               
              // Add the primary key of the record
              WhereClause wc = CreateWhereClause_RegistrationsCountQuery2();
              this._RegistrationsCountQuery2.WhereClause.iAND(wc);                      
          
              // Define selects
          
              this._RegistrationsCountQuery2.AddSelectItem(new SelectItem(RegistrationTypesTable.RegistrationTypeId, RegistrationTypesTable.Instance, false, "", ""));
              
                    this._RegistrationsCountQuery2.AddSelectItem(new SelectItem(SelectItem.Operation.COUNT, new SelectItem(SelectItem.ItemType.AllColumns, RegistrationsTable.Instance, "RegistrationsCount", ""), "RegistrationsCount"));
              
              // Define joins if there are any
          
              this._RegistrationsCountQuery2.AddJoin(RegistrationTypesTable.RegistrationTypeId, RegistrationTypesTable.Instance, "", RegistrationsTable.RegistrationTypeId, RegistrationsTable.Instance, "");
          
              this._RegistrationsCountQuery2.LoadData(false, this._RegistrationsCountQuery2.PageSize, this._RegistrationsCountQuery2.PageIndex);                       
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["RegistrationTypesTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["RegistrationTypesTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = RegistrationTypesTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
                return (this._TotalRecords);
            }
            set {
        ...
        public  RegistrationTypesRecord[] DataSource {
            ...
            get {
                return (RegistrationTypesRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            bool needToProcess = AreAnyUrlParametersForMe(url, arg);
            if (needToProcess) {
                RegistrationTypesTableControlRow recCtl = this.GetSelectedRecordControl();
                if (recCtl == null && url.IndexOf("{") >= 0) {
                    // Localization.
                    throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OLR"));
                }
        ...
        public virtual RegistrationTypesTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual RegistrationTypesTableControlRow[] GetSelectedRecordControls()
        {
        
            return (RegistrationTypesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Table.RegistrationTypesTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            RegistrationTypesTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OLR"));
            }
            
            foreach (RegistrationTypesTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
                    if (!recCtl.IsNewRecord) {
        ...
        public virtual RegistrationTypesTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "RegistrationTypesTableControlRow");
	          List<RegistrationTypesTableControlRow> list = new List<RegistrationTypesTableControlRow>();
	          foreach (RegistrationTypesTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
