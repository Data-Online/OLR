...
/// <see cref="OtherCostsTable">OLR.OtherCostsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="OtherCostsTable"></seealso>
public class OtherCostsDefinition
{
#region "Definition (XML) for OtherCostsDefinition table"
	//Next 147 lines contain Table Definition (XML) for table "OtherCostsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>OtherCostId</columnName>");
         tbf.Append(      @"<columnUIName>Other Cost</columnUIName>");
         ...
         tbf.Append(      @"<columnName>CostDescription</columnName>");
         tbf.Append(      @"<columnUIName>Cost Description</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_OtherCosts_Events</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>OtherCosts</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>OtherCosts_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>OtherCosts</FolderName>");
         tbf.Append(  @"<MenuName>Other Costs</MenuName>");
         tbf.Append(  @"<QSPath>../OtherCosts/OtherCosts-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>OtherCosts</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOLROtherCosts</TableStoredProcPrefix>");
