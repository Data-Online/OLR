...
// This file implements the code-behind class for Edit_OtherCosts_Table.aspx.
// Edit_OtherCosts_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_OtherCosts_Table
        : BaseApplicationPage
// Code-behind class for the Edit_OtherCosts_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_OtherCosts_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetOtherCostsTableControl()
        {
            SetOtherCostsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Edit_OtherCosts_Table.OtherCostsTableControl OtherCostsTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Other Costs");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "OtherCostsTableControl":
                 SetOtherCostsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.OtherCostsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Edit_OtherCosts_Table.OtherCostsTableControl control = new OLR.UI.Controls.Edit_OtherCosts_Table.OtherCostsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetOtherCostsTableControl_Base()           
        
        {        
            if (OtherCostsTableControl.Visible)
            {
                OtherCostsTableControl.LoadData();
                OtherCostsTableControl.DataBind();
            }
        }
