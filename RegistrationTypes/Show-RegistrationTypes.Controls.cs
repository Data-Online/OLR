...
// Show_RegistrationTypes.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_RegistrationTypes
{
...
// Base class for the RegistrationTypesRecordControl control on the Show_RegistrationTypes page.
...
public class BaseRegistrationTypesRecordControl : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RegistrationTypesRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-RegistrationTypes"] = recId;
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void EventId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Events/Show-Events.aspx?Events={RegistrationTypesRecordControl:FK:FK_RegistrationTypes_Events}";
