...
<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Show_PhotoClubs_Gallery" Assembly="OLR" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-PhotoClubs-Gallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OLR.UI.Show_PhotoClubs_Gallery" %>
...
<BaseClasses:QuickSelector runat="server" id="DescriptionFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="PhotoClubsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3"></th></tr><asp:Repeater runat="server" id="PhotoClubsTableControlRepeater">		<ITEMTEMPLATE>
...
<td class="galleryttc" style="width:33%;"><asp:LinkButton runat="server" id="Description" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <br />
</td></OLR:PhotoClubsTableControlRow>
</ITEMTEMPLATE>
