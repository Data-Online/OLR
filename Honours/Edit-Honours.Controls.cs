...
// Edit_Honours.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_Honours
{
...
public class HonoursRecordControl : BaseHonoursRecordControl
{
      
        // The BaseHonoursRecordControl implements the LoadData, DataBind and other
...
// Base class for the HonoursRecordControl control on the Edit_Honours page.
// Do not modify this class. Instead override any method in HonoursRecordControl.
public class BaseHonoursRecordControl : OLR.UI.BaseApplicationRecordControl
{
        public BaseHonoursRecordControl()
        {
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "HonoursRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            this.DataSource = HonoursTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in HonoursRecordControl.
         ...
         
        {
            ...
            bool hasFiltersHonoursRecordControl = false;
            hasFiltersHonoursRecordControl = hasFiltersHonoursRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Honours"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OLR").Replace("{URL}", "Honours"));
            }
            HttpContext.Current.Session["QueryString in Edit-Honours"] = recId;
          ...
          wc.iAND(HonoursTable.HonourId, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(HonoursTable.HonourId));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(HonoursTable.HonourId, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseHonoursRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseHonoursRecordControl_Rec"] = value;
            }
        }
