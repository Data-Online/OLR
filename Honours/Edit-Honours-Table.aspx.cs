...
// This file implements the code-behind class for Edit_Honours_Table.aspx.
// Edit_Honours_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Honours_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Honours_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Honours_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetHonoursTableControl()
        {
            SetHonoursTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "HonoursTableControl":
                 SetHonoursTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.HonoursTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetHonoursTableControl_Base()           
        
        {        
            if (HonoursTableControl.Visible)
            {
                HonoursTableControl.LoadData();
                HonoursTableControl.DataBind();
            }
        }
