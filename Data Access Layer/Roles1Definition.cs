...
/// <see cref="Roles1Table">OLR.Roles1Table</see> class
...
#region "Definition (XML) for Roles1Definition table"
	//Next 179 lines contain Table Definition (XML) for table "Roles1Definition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pOLRRoles1</TableStoredProcPrefix>");
