...
// Show_Honors_Gallery1.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Honors_Gallery1
{
...
// Base class for the HonorsTableControlRow control on the Show_Honors_Gallery1 page.
        ...
        public virtual void SetImagewithOverlaidText()
                  {
                        ...
                        this.ImagewithOverlaidText.Text = EvaluateFormula("HonorsTableControlRow.GetImageWithOverlaidText(\"\", \"<a class=\\\"button_link\\\" href=\\\"\" + HonorsTableControlRow.ModifyRedirectUrl(\"../Honors/Show-Honors.aspx?Honors={PK}\", \"\", True) + \"\\\">\" + Description + \"</a>\", HonorsTableControlRow.ModifyRedirectUrl(\"../Honors/Show-Honors.aspx?Honors={PK}\", \"\", True))");
...
// Base class for the HonorsTableControl control on the Show_Honors_Gallery1 page.
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Honors-Gallery1.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Honors";
                // If Show-Honors-Gallery1.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Honors-Gallery1.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Honors";
                // If Show-Honors-Gallery1.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual HonorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (HonorsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Honors_Gallery1.HonorsTableControlRow")));
