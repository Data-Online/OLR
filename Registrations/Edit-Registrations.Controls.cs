...
// Edit_Registrations.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_Registrations
{
...
// Base class for the PhotoClubContactLinksTableControlRow control on the Edit_Registrations page.
...
// Base class for the PhotoClubContactLinksTableControl control on the Edit_Registrations page.
...
#region "Helper Functions"
        ...
        public virtual PhotoClubContactLinksTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PhotoClubContactLinksTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Edit_Registrations.PhotoClubContactLinksTableControlRow")));
...
// Base class for the ContactsRecordControl control on the Edit_Registrations page.
...
// Base class for the RegistrationsRecordControl control on the Edit_Registrations page.
...
public class BaseRegistrationsRecordControl : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RegistrationsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Edit-Registrations"] = recId;
