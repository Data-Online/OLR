...
/// <see cref="HonorsTable">OLR.HonorsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="HonorsTable"></seealso>
public class HonorsDefinition
{
#region "Definition (XML) for HonorsDefinition table"
	//Next 73 lines contain Table Definition (XML) for table "HonorsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>HonorId</columnName>");
         tbf.Append(      @"<columnUIName>Honor</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Honors</TableName>");
         tbf.Append(  @"<Version></Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Honors_</TableAliasName>");
         ...
         tbf.Append(  @"<FolderName>Honors</FolderName>");
         tbf.Append(  @"<MenuName>Honors</MenuName>");
         tbf.Append(  @"<QSPath>../Honors/Honors-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableCodeName>Honors</TableCodeName>");
         tbf.Append(  @"<TableStoredProcPrefix>pOLRHonors</TableStoredProcPrefix>");
