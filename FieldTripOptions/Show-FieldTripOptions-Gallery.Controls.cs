...
// Show_FieldTripOptions_Gallery.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_FieldTripOptions_Gallery
{
...
// Base class for the FieldTripOptionsTableControlRow control on the Show_FieldTripOptions_Gallery page.
...
public class BaseFieldTripOptionsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetFieldTripId()
        {
            ...
            if (this.DataSource != null && this.DataSource.FieldTripIdSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&FieldTripOptionsTable.FieldTripId.IsApplyDisplayAs)
                     ...
                     formattedValue = FieldTripOptionsTable.GetDFKA(this.DataSource.FieldTripId.ToString(),FieldTripOptionsTable.FieldTripId, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(FieldTripOptionsTable.FieldTripId);
              ...
              this.FieldTripId.Text = FieldTripOptionsTable.FieldTripId.Format(FieldTripOptionsTable.FieldTripId.DefaultValue);
      ...
      // To customize, override this method in FieldTripOptionsTableControlRow.
        ...
        public virtual void FieldTripId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../FieldTripOptions/Show-FieldTripOptions.aspx?FieldTripOptions={PK}";
...
// Base class for the FieldTripOptionsTableControl control on the Show_FieldTripOptions_Gallery page.
...
public class BaseFieldTripOptionsTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(FieldTripOptionsTable.FieldTripId, this.DataSource);
        }
      ...
      FieldTripOptionsRecord rec = new FieldTripOptionsRecord();
                        ...
                        if (recControl.FieldTripId.Text != "") {
                            rec.Parse(recControl.FieldTripId.Text, FieldTripOptionsTable.FieldTripId);
                  }
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTripOptions-Gallery.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTripOptions";
                // If Show-FieldTripOptions-Gallery.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTripOptions-Gallery.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTripOptions";
                // If Show-FieldTripOptions-Gallery.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual FieldTripOptionsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripOptionsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTripOptions_Gallery.FieldTripOptionsTableControlRow")));
