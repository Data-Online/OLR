...
// This file implements the code-behind class for Edit_Users_Table.aspx.
// Edit_Users_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Users_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Users_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Users_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetUsersTableControl()
        {
            SetUsersTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public System.Web.UI.WebControls.Literal UserNameLabel1;
        
        public OLR.UI.Controls.Edit_Users_Table.UsersTableControl UsersTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Users");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "UsersTableControl":
                 SetUsersTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.UsersTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Edit_Users_Table.UsersTableControl control = new OLR.UI.Controls.Edit_Users_Table.UsersTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetUsersTableControl_Base()           
        
        {        
            if (UsersTableControl.Visible)
            {
                UsersTableControl.LoadData();
