...
// This file implements the code-behind class for Show_Events_Gallery.aspx.
// Show_Events_Gallery.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Events_Gallery
        : BaseApplicationPage
// Code-behind class for the Show_Events_Gallery page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Events_Gallery()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Show_Events_Gallery.EventsTableControl EventsTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Show_Events_Gallery.EventsTableControl control = new OLR.UI.Controls.Show_Events_Gallery.EventsTableControl();
