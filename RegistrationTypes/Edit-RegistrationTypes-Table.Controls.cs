...
// Edit_RegistrationTypes_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_RegistrationTypes_Table
{
...
// Base class for the RegistrationTypesTableControlRow control on the Edit_RegistrationTypes_Table page.
...
public class BaseRegistrationTypesTableControlRow : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RegistrationTypesTableControlRow.
        ...
        RegistrationTypesTableControl tc= ((RegistrationTypesTableControl)MiscUtils.GetParentControlObject(this, "RegistrationTypesTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((RegistrationTypesTableControlRow)this);
                    }
                    this.Visible = false;
...
// Base class for the RegistrationTypesTableControl control on the Edit_RegistrationTypes_Table page.
    ...
    // Setup default pagination settings.
      ...
      RegistrationTypesRecord rec = new RegistrationTypesRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("RegistrationTypesTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (RegistrationTypesTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        RegistrationTypesTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual RegistrationTypesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RegistrationTypesTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_RegistrationTypes_Table.RegistrationTypesTableControlRow")));
