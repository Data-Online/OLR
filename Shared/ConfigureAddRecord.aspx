<%@ Page Language="vb" AutoEventWireup="false" Inherits="OLR.UI.BaseApplicationPage" MasterPageFile="../Master Pages/Blank.master"%>
			...
			<td class="configureErrorPagesText"><br />
				...
				<ol>
			      ...
			      <ul style="list-style-type:disc">
			      	<li>Select the New button or icon on the page. Then click the 'Redirect' property present in the 'Button Actions' section on the Properties sheet.</li>
			      	<li>In the Redirect Action Wizard dialog, select the type of Redirect action and click the Next button.</li>
				<li>Now modify the Redirect URL to point to your Add Record page.<br />Example:  ../MyPages/MyAddRecordPage.aspx<br /><br /></li>
			      </ul>
			      </li>
