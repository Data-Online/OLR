...
// This file implements the code-behind class for Add_Contacts1.aspx.
// Add_Contacts1.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Contacts1
        : BaseApplicationPage
// Code-behind class for the Add_Contacts1 page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_Contacts1()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Add_Contacts1.ContactsRecordControl ContactsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Contacts");
      ...
      public void SaveData_Base()
      {
        ...
        this.ContactsRecordControl.SaveData();
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.ContactsRecordControl != null && this.ContactsRecordControl.DataSource != null)
                  {
                        id = this.ContactsRecordControl.DataSource.GetValue(this.ContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.ContactsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.ContactsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.ContactsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.ContactsRecordControl.DataSource.GetValue(this.ContactsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
