...
<asp:Literal runat="server" id="FieldTripChoicesCountControl2">	</asp:Literal></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="5"></td></tr></OLR:FieldTripOptionsTableControlRow>
	...
	<asp:hiddenfield id="FieldTripsTableControl_PostbackTracker" runat="server" />
            ...
            </td></tr><tr><td><OLR:RegistrationsTableControl runat="server" id="RegistrationsTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr hidden="true"><td><asp:panel id="CollapsibleRegion2" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
