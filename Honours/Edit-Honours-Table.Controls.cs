...
// Edit_Honours_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_Honours_Table
{
...
public class HonoursTableControlRow : BaseHonoursTableControlRow
{
      
        // The BaseHonoursTableControlRow implements code for a ROW within the
        // the HonoursTableControl table.  The BaseHonoursTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of HonoursTableControl.
...
public class HonoursTableControl : BaseHonoursTableControl
{
    // The BaseHonoursTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The HonoursTableControlRow class offers another place where you can customize
...
// Base class for the HonoursTableControlRow control on the Edit_Honours_Table page.
// Do not modify this class. Instead override any method in HonoursTableControlRow.
public class BaseHonoursTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        public BaseHonoursTableControlRow()
        {
        ...
        // To customize, override this method in HonoursTableControlRow.
        ...
        public virtual void LoadData()  
        {
            ...
            // LoadData method of the BaseHonoursTableControl when the data for the entire
            // table is loaded.
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((HonoursTableControl)MiscUtils.GetParentControlObject(this, "HonoursTableControl")).DataChanged = true;
                ((HonoursTableControl)MiscUtils.GetParentControlObject(this, "HonoursTableControl")).ResetData = true;
            }
      ...
      // To customize, override this method in HonoursTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersHonoursTableControl = false;
            hasFiltersHonoursTableControl = hasFiltersHonoursTableControl && false; // suppress warning
        ...
        public virtual void Delete()
        {
          ...
          HonoursTable.DeleteRecord(pkValue);
        ...
        HonoursTableControl tc= ((HonoursTableControl)MiscUtils.GetParentControlObject(this, "HonoursTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((HonoursTableControlRow)this);
                    }
                    this.Visible = false;
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Honours/Edit-Honours.aspx?Honours={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseHonoursTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseHonoursTableControlRow_Rec"] = value;
            }
        }
        
        public HonoursRecord DataSource {
            get {
                return (HonoursRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    HonoursRecord rec = null;
        ...
        public virtual HonoursRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return HonoursTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the HonoursTableControl control on the Edit_Honours_Table page.
// Do not modify this class. Instead override any method in HonoursTableControl.
public class BaseHonoursTableControl : OLR.UI.BaseApplicationTableControl
{
         
       public BaseHonoursTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OLR.Business.HonoursRecord);
                      this.DataSource = (HonoursRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (HonoursTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(OLR.Business.HonoursRecord);
                    this.DataSource = (HonoursRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual HonoursRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(HonoursTable.Column1, true);          
            // selCols.Add(HonoursTable.Column2, true);          
            // selCols.Add(HonoursTable.Column3, true);          
                  ...
                  
            {
                ...
                return HonoursTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
                 
            }
            else
            {
                HonoursTable databaseTable = new HonoursTable();
                ...
                return (recList.ToArray(typeof(HonoursRecord)) as HonoursRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return HonoursTable.GetRecordCount(join, where);
            else
            {
                HonoursTable databaseTable = new HonoursTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public override void DataBind()
      {
        ...
        System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HonoursTableControlRepeater"));
        if (rep == null){return;}
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            HonoursTableControlRow recControl = (HonoursTableControlRow)(repItem.FindControl("HonoursTableControlRow"));
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for HonoursTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (HonoursTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            HonoursTable.Instance.InnerFilter = null;
      ...
      HonoursRecord rec = new HonoursRecord();
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new HonoursRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OLR.Business.HonoursRecord);
                this.DataSource = (HonoursRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(HonoursTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(HonoursTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("HonoursTableControlRepeater");
    ...
    this.RemoveFromSession(this, "Page_Size");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["HonoursTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["HonoursTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        protected virtual void SortControl_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in HonoursTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(HonoursTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (HonoursTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && HonoursTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(HonoursTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(HonoursTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = HonoursTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  HonoursRecord[] DataSource {
            ...
            get {
                return (HonoursRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                HonoursTableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        {
            int counter = 0;
            foreach (HonoursTableControlRow recControl in this.GetRecordControls())
            {
        ...
        public virtual HonoursTableControlRow GetSelectedRecordControl()
        {
        HonoursTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual HonoursTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (HonoursTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_Honours_Table.HonoursTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            HonoursTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OLR"));
            }
            
            foreach (HonoursTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual HonoursTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "HonoursTableControlRow");
	          List<HonoursTableControlRow> list = new List<HonoursTableControlRow>();
	          foreach (HonoursTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
