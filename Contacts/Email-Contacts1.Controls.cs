...
// Email_Contacts1.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Email_Contacts1
{
...
// Base class for the ContactsRecordControl control on the Email_Contacts1 page.
...
public class BaseContactsRecordControl : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ContactsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Email-Contacts1"] = recId;
