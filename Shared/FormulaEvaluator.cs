...
namespace OLR
{
    ...
    public class FormulaEvaluator:BaseFormulaEvaluator
    {
        ...
        public FormulaEvaluator()
        {
            ...
            Evaluator.Imports.AddType(typeof(FormulaUtilsGEN));
            Evaluator.Imports.AddType(typeof(BaseFormulaUtils));
            Evaluator.Imports.AddType(typeof(BaseFormulaUtilsGEN));
        ...
        public override object Evaluate(string expression)
        {
            ...
            // if the cultural format is Turkish, replace upper case I with lower case
