...
// This file implements the code-behind class for Edit_View_Registered_Table.aspx.
// Edit_View_Registered_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_View_Registered_Table
        : BaseApplicationPage
// Code-behind class for the Edit_View_Registered_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_View_Registered_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetView_RegisteredTableControl()
        {
            SetView_RegisteredTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Edit_View_Registered_Table.View_RegisteredTableControl View_RegisteredTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Registered");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "View_RegisteredTableControl":
                 SetView_RegisteredTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.View_RegisteredTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Edit_View_Registered_Table.View_RegisteredTableControl control = new OLR.UI.Controls.Edit_View_Registered_Table.View_RegisteredTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetView_RegisteredTableControl_Base()           
        
        {        
            if (View_RegisteredTableControl.Visible)
            {
                View_RegisteredTableControl.LoadData();
                View_RegisteredTableControl.DataBind();
            }
        }
