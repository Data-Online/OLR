...
// Add_RegistrationTypes.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Add_RegistrationTypes
{
...
// Base class for the RegistrationTypesRecordControl control on the Add_RegistrationTypes page.
...
public class BaseRegistrationTypesRecordControl : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (RegistrationTypesRecord)RegistrationTypesRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in RegistrationTypesRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["RegistrationTypes"];
            ...
            HttpContext.Current.Session["QueryString in Add-RegistrationTypes"] = recId;
...
#region "Helper Properties"
    ...
    RegistrationTypesRecord rec = null;
             ...
             
        {
            ...
            return new RegistrationTypesRecord();
