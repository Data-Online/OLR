...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-FieldTrips-Table3.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OLR.UI.Show_FieldTrips_Table3" %>
...
<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Show_FieldTrips_Table3" Assembly="OLR" %>
...
</td><td class="tableCellValue"><asp:LinkButton runat="server" id="EventId" causesvalidation="False" commandname="Redirect"></asp:LinkButton> </td><td class="tableCellLabel"></td><td class="tableCellValue"></td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr id="FieldTripsTableControlAltRow" runat="server"><td class="tableRowButton" scope="row">&nbsp;</td><td class="tableRowButton" scope="row">&nbsp;</td><td class="tableRowButton" scope="row">&nbsp;</td><td class="tableCellValue" colspan="6"><BaseClasses:TabContainer runat="server" id="FieldTripsTabContainer" panellayout="Tabbed">
 <BaseClasses:TabPanel runat="server" id="FieldTripOptionsTabPanel" HeaderText="Field Trip Options">	<ContentTemplate>
  <OLR:FieldTripOptionsTableControl runat="server" id="FieldTripOptionsTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td></td><td></td><td></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
...
<tr><td class="tableCellLabel"><asp:Literal runat="server" id="DescriptionLabel1" Text="Description">	</asp:Literal> 
</td><td class="tableCellValue"><asp:Literal runat="server" id="Description2"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="PlacesAvailableLabel" Text="Places Available">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</BaseClasses:TabContainer></td></tr><tr><td class="tableRowDivider" colspan="9"></td></tr></OLR:FieldTripsTableControlRow>
</ITEMTEMPLATE>
