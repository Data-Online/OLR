...
// Edit_AvailableWorkshops_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_AvailableWorkshops_Table
{
...
// Base class for the AvailableWorkshopsTableControlRow control on the Edit_AvailableWorkshops_Table page.
...
public class BaseAvailableWorkshopsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.WorkshopDescription.TextChanged += WorkshopDescription_TextChanged;
        ...
        public virtual void SetEventId()
        {
            ...
            if (this.DataSource != null && this.DataSource.IsCreated) {
               ...
               Boolean _isExpandableNonCompositeForeignKey = AvailableWorkshopsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(AvailableWorkshopsTable.EventId);
               if(_isExpandableNonCompositeForeignKey &&AvailableWorkshopsTable.EventId.IsApplyDisplayAs)
                                  
                     formattedValue = AvailableWorkshopsTable.GetDFKA(this.DataSource.EventId.ToString(),AvailableWorkshopsTable.EventId, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(AvailableWorkshopsTable.EventId);
        ...
        public virtual void SetPlacesAvailable()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.PlacesAvailable.ID))
            {
            
                this.PlacesAvailable.Text = this.PreviousUIData[this.PlacesAvailable.ID].ToString();
              
                return;
            }
            
                    
            // Set the PlacesAvailable TextBox on the webpage with value from the
            // DatabaseOLR_db%dbo.AvailableWorkshops database record.

            // this.DataSource is the DatabaseOLR_db%dbo.AvailableWorkshops record retrieved from the database.
            // this.PlacesAvailable is the ASP:TextBox on the webpage.
        ...
        public virtual void SetWorkshopDescription()
        {
            ...
            // If data was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.WorkshopDescription.ID))
            {
            
                this.WorkshopDescription.Text = this.PreviousUIData[this.WorkshopDescription.ID].ToString();
              
                return;
            }
            
                    
            // Set the WorkshopDescription TextBox on the webpage with value from the
            // DatabaseOLR_db%dbo.AvailableWorkshops database record.

            // this.DataSource is the DatabaseOLR_db%dbo.AvailableWorkshops record retrieved from the database.
            // this.WorkshopDescription is the ASP:TextBox on the webpage.
        ...
        public virtual void GetPlacesAvailable()
        {
            ...
            // Retrieve the value entered by the user on the PlacesAvailable ASP:TextBox, and
            // save it into the PlacesAvailable field in DataSource DatabaseOLR_db%dbo.AvailableWorkshops record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.PlacesAvailable.Text, AvailableWorkshopsTable.PlacesAvailable);							
        ...
        public virtual void GetWorkshopDescription()
        {
            ...
            // Retrieve the value entered by the user on the WorkshopDescription ASP:TextBox, and
            // save it into the WorkshopDescription field in DataSource DatabaseOLR_db%dbo.AvailableWorkshops record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.WorkshopDescription.Text, AvailableWorkshopsTable.WorkshopDescription);							
      ...
      // To customize, override this method in AvailableWorkshopsTableControlRow.
        ...
        AvailableWorkshopsTableControl tc= ((AvailableWorkshopsTableControl)MiscUtils.GetParentControlObject(this, "AvailableWorkshopsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((AvailableWorkshopsTableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void PlacesAvailable_TextChanged(object sender, EventArgs args)
        {
                    
              }
            
        protected virtual void WorkshopDescription_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox WorkshopDescription {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "WorkshopDescription");
            }
        }
...
// Base class for the AvailableWorkshopsTableControl control on the Edit_AvailableWorkshops_Table page.
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(AvailableWorkshopsTable.EventId, this.DataSource);
        }
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.EventIdFilter)) {
                ...
                foreach (ListItem item in this.EventIdFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(AvailableWorkshopsTable.EventId, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String EventIdFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "EventIdFilter_Ajax"];
        ...
        if (EventIdFilterSelectedValue != null){
                        ...
                        foreach (string item in EventIdFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(AvailableWorkshopsTable.EventId, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      AvailableWorkshopsRecord rec = new AvailableWorkshopsRecord();
                        ...
                        if (recControl.EventId.Text != "") {
                            rec.Parse(recControl.EventId.Text, AvailableWorkshopsTable.EventId);
                  }
                    ...
                    foreach (EventsRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.EventIdSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.EventIdFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                Boolean _isExpandableNonCompositeForeignKey = AvailableWorkshopsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(AvailableWorkshopsTable.EventId);
                                if(_isExpandableNonCompositeForeignKey && AvailableWorkshopsTable.EventId.IsApplyDisplayAs)
                                     fvalue = AvailableWorkshopsTable.GetDFKA(itemValue, AvailableWorkshopsTable.EventId);
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("AvailableWorkshopsTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (AvailableWorkshopsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        AvailableWorkshopsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual AvailableWorkshopsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (AvailableWorkshopsTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_AvailableWorkshops_Table.AvailableWorkshopsTableControlRow")));
