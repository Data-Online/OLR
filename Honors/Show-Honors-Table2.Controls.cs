...
// Show_Honors_Table2.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Honors_Table2
{
...
// Base class for the HonorsTableControlRow control on the Show_Honors_Table2 page.
...
public class BaseHonorsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
      ...
      this.Page.CommitTransaction(sender);
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Honors/Edit-Honors.aspx?Honors={PK}";
...
// Base class for the HonorsTableControl control on the Show_Honors_Table2 page.
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return HonorsTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            HonorsTableControlRow recControl = (HonorsTableControlRow)(repItem.FindControl("HonorsTableControlRow"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Honors-Table2.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Honors";
                // If Show-Honors-Table2.PDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Description}", record.Format(HonorsTable.Description), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Honors-Table2.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Honors";
                // If Show-Honors-Table2.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual HonorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (HonorsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Honors_Table2.HonorsTableControlRow")));
