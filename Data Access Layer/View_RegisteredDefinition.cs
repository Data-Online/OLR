...
/// <see cref="View_RegisteredView">OLR.View_RegisteredView</see> class
...
#region "Definition (XML) for View_RegisteredDefinition table"
	...
	/// <see cref="View_RegisteredView"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Town&quot;</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>50</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(        @"<columnFKName>VFK_view_Registered_RegistrationId_1</columnFKName>");
         ...
         tbf.Append(  @"<TableCodeName>View_Registered</TableCodeName>");
         tbf.Append(  @"<FolderName>view_Registered</FolderName>");
         tbf.Append(  @"<MenuName>Registered</MenuName>");
         tbf.Append(  @"<QSPath>../view_Registered/View-Registered-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOLRView_Registered</TableStoredProcPrefix>");
