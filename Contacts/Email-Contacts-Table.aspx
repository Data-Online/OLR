<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Email-Contacts-Table.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/Email.master" Inherits="OLR.UI.Email_Contacts_Table" %>
<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Email_Contacts_Table" Assembly="OLR" %>
