...
/// Also provides access to the <see cref="ConfigurationTable"></see> that each record is associated with.
/// </summary>
/// <remarks>
/// <para>
...
public class ConfigurationRecord : BaseConfigurationRecord
{
