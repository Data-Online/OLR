...
// Show_FieldTripOptions_Table1.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_FieldTripOptions_Table1
{
...
// Base class for the FieldTripOptionsTableControlRow control on the Show_FieldTripOptions_Table1 page.
...
public class BaseFieldTripOptionsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void FieldTripId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../FieldTrips/Show-FieldTrips.aspx?FieldTrips={FieldTripOptionsTableControlRow:FK:FK_FieldTripOptions_FieldTrips}";
...
// Base class for the FieldTripOptionsTableControl control on the Show_FieldTripOptions_Table1 page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             FieldTripOptionsTable.PlacesAvailable,
             null};
             ...
             data.ColumnList.Add(new ExcelColumn(FieldTripOptionsTable.PlacesAvailable, "0"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTripOptions-Table1.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTripOptions";
                // If Show-FieldTripOptions-Table1.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(FieldTripOptionsTable.PlacesAvailable.Name, ReportEnum.Align.Right, "${PlacesAvailable}", ReportEnum.Align.Right, 15);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${PlacesAvailable}", record.Format(FieldTripOptionsTable.PlacesAvailable), ReportEnum.Align.Right, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTripOptions-Table1.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTripOptions";
                // If Show-FieldTripOptions-Table1.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual FieldTripOptionsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripOptionsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTripOptions_Table1.FieldTripOptionsTableControlRow")));
