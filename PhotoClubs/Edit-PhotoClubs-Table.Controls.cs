...
// Edit_PhotoClubs_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_PhotoClubs_Table
{
...
// Base class for the PhotoClubsTableControlRow control on the Edit_PhotoClubs_Table page.
...
public class BasePhotoClubsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void GetDescription()
        {
            ...
            // save it into the Description field in DataSource DatabaseOLR_db%dbo.PhotoClubs record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.Description.Text, PhotoClubsTable.Description);							
      ...
      // To customize, override this method in PhotoClubsTableControlRow.
        ...
        PhotoClubsTableControl tc= ((PhotoClubsTableControl)MiscUtils.GetParentControlObject(this, "PhotoClubsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((PhotoClubsTableControlRow)this);
                    }
                    this.Visible = false;
...
// Base class for the PhotoClubsTableControl control on the Edit_PhotoClubs_Table page.
    ...
    // Setup default pagination settings.
      ...
      PhotoClubsRecord rec = new PhotoClubsRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("PhotoClubsTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (PhotoClubsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        PhotoClubsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual PhotoClubsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PhotoClubsTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_PhotoClubs_Table.PhotoClubsTableControlRow")));
