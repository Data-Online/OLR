...
// Show_RegistrationTypes_Table2.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_RegistrationTypes_Table2
{
...
// Base class for the RegistrationTypesTableControlRow control on the Show_RegistrationTypes_Table2 page.
...
public class BaseRegistrationTypesTableControlRow : OLR.UI.BaseApplicationRecordControl
{
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void EventId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Events/Show-Events.aspx?Events={RegistrationTypesTableControlRow:FK:FK_RegistrationTypes_Events}";
...
// Base class for the RegistrationTypesTableControl control on the Show_RegistrationTypes_Table2 page.
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SearchText, this.GetFromSession(this.SearchText)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.EventIdFilter) || this.InSession(this.EventIdFilter)){
      ...
      RegistrationTypesRecord rec = new RegistrationTypesRecord();
        ...
        public virtual void SetEventIdFilter()
        {
            ...
            this.PopulateEventIdFilter(MiscUtils.GetSelectedValueList(this.EventIdFilter, EventIdFilterselectedFilterItemList), 500);
              ...
              url += "?Target=" + this.EventIdFilter.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("EventName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("EventId")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldFilterMultiSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
                    ...
                    
        {
            ...
            if (this.EventIdFilter.Items.Count == 0)
                this.EventIdFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:PleaseSelect", "OLR"), "--PLEASE_SELECT--"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RegistrationTypes-Table2.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RegistrationTypes";
                // If Show-RegistrationTypes-Table2.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RegistrationTypes-Table2.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RegistrationTypes";
                // If Show-RegistrationTypes-Table2.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RegistrationTypesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RegistrationTypesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_RegistrationTypes_Table2.RegistrationTypesTableControlRow")));
