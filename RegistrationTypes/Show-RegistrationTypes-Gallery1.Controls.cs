...
// Show_RegistrationTypes_Gallery1.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_RegistrationTypes_Gallery1
{
...
// Base class for the RegistrationTypesTableControlRow control on the Show_RegistrationTypes_Gallery1 page.
        ...
        public virtual void SetImagewithOverlaidText()
                  {
                        ...
                        this.ImagewithOverlaidText.Text = EvaluateFormula("RegistrationTypesTableControlRow.GetImageWithOverlaidText(\"\", \"<a class=\\\"button_link\\\" href=\\\"\" + RegistrationTypesTableControlRow.ModifyRedirectUrl(\"../RegistrationTypes/Show-RegistrationTypes.aspx?RegistrationTypes={PK}\", \"\", True) + \"\\\">\" + EventId + \"</a>\", RegistrationTypesTableControlRow.ModifyRedirectUrl(\"../RegistrationTypes/Show-RegistrationTypes.aspx?RegistrationTypes={PK}\", \"\", True))");
...
// Base class for the RegistrationTypesTableControl control on the Show_RegistrationTypes_Gallery1 page.
...
public class BaseRegistrationTypesTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return RegistrationTypesTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual RegistrationTypesRecord[] CopyArray(int index, RegistrationTypesRecord[,] recs, int columns)
      {
        RegistrationTypesRecord[] recsCopy = new RegistrationTypesRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            RegistrationTypesRecord[,] recs = new RegistrationTypesRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            RegistrationTypesRecord[] HColDataSource = new RegistrationTypesRecord[Convert.ToInt32(rows)];
            ...
            System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "RegistrationTypesTableControlRepeater1");
            ...
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep1.Items)
            {
              ...
              RegistrationTypesRecord[] VColDataSource = new RegistrationTypesRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("RegistrationTypesTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              RegistrationTypesRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                RegistrationTypesTableControlRow recControl = (RegistrationTypesTableControlRow)innerRepItem.FindControl("RegistrationTypesTableControlRow");
      ...
      String EventIdFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "EventIdFilter_Ajax"];
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegistrationTypesTableControlRepeater"));
              if (rep == null){return;}
              RegistrationTypesTableControlRow[] recControls = this.GetRecordControls();
                foreach (RegistrationTypesTableControlRow recControl in recControls) 
		{
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=RegistrationTypes" ;
              ...
              
        {
              ...
              try
              {
                    string url = "../RegistrationTypes/Add-RegistrationTypes.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "RegistrationTypesTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "RegistrationTypesTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = RegistrationTypesTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             RegistrationTypesTable.EventId,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(RegistrationTypesTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(RegistrationTypesTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(RegistrationTypesTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(RegistrationTypesTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(RegistrationTypesTable.EventId, "Default"));
              ...
              {
                val = RegistrationTypesTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RegistrationTypes-Gallery1.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RegistrationTypes";
                // If Show-RegistrationTypes-Gallery1.PDFButton.report specifies a valid report template,
                ...
                ColumnList columns = RegistrationTypesTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = RegistrationTypesTable.GetRecordCount(joinFilter,whereClause);
                RegistrationTypesRecord[] records = null;
                
                do
                {
                    
                    records = RegistrationTypesTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( RegistrationTypesRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = RegistrationTypesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(RegistrationTypesTable.EventId);
                                 _DFKA = RegistrationTypesTable.GetDFKA(record.EventId.ToString(), RegistrationTypesTable.EventId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  RegistrationTypesTable.EventId.IsApplyDisplayAs){
                                     report.AddData("${EventId}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${EventId}", record.Format(RegistrationTypesTable.EventId), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RegistrationTypes-Gallery1.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RegistrationTypes";
                // If Show-RegistrationTypes-Gallery1.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RegistrationTypesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RegistrationTypesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_RegistrationTypes_Gallery1.RegistrationTypesTableControlRow")));
