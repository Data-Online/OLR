...
// Edit_Honors_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_Honors_Table
{
...
// Base class for the HonorsTableControlRow control on the Edit_Honors_Table page.
...
public class BaseHonorsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void GetDescription()
        {
            ...
            // save it into the Description field in DataSource DatabaseOLR_db%dbo.Honors record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.Description.Text, HonorsTable.Description);							
      ...
      // To customize, override this method in HonorsTableControlRow.
        ...
        HonorsTableControl tc= ((HonorsTableControl)MiscUtils.GetParentControlObject(this, "HonorsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((HonorsTableControlRow)this);
                    }
                    this.Visible = false;
...
// Base class for the HonorsTableControl control on the Edit_Honors_Table page.
    ...
    // Setup default pagination settings.
      ...
      HonorsRecord rec = new HonorsRecord();
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("HonorsTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (HonorsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        HonorsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual HonorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (HonorsTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_Honors_Table.HonorsTableControlRow")));
