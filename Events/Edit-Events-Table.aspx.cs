...
// This file implements the code-behind class for Edit_Events_Table.aspx.
// Edit_Events_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Events_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Events_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Events_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEventsTableControl()
        {
            SetEventsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Edit_Events_Table.EventsTableControl EventsTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "EventsTableControl":
                 SetEventsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.EventsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Edit_Events_Table.EventsTableControl control = new OLR.UI.Controls.Edit_Events_Table.EventsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEventsTableControl_Base()           
        
        {        
            if (EventsTableControl.Visible)
            {
                EventsTableControl.LoadData();
                EventsTableControl.DataBind();
            }
        }
