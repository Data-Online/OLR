...
// EditRegistration.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.EditRegistration
{
...
// Base class for the FieldTripChoicesTableControlRow control on the EditRegistration page.
...
public class BaseFieldTripChoicesTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetFieldTripAllocated()
        {
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.FieldTripAllocated.ID))
            {
                if (this.PreviousUIData[this.FieldTripAllocated.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.FieldTripAllocated.ID].ToString();
            }
            
            
            // Set the FieldTripAllocated DropDownList on the webpage with value from the
            // DatabaseOLR_db%dbo.FieldTripChoices database record.
            
            // this.DataSource is the DatabaseOLR_db%dbo.FieldTripChoices record retrieved from the database.
            // this.FieldTripAllocated is the ASP:DropDownList on the webpage.
            
            // You can modify this method directly, or replace it with a call to
            //     base.SetFieldTripAllocated();
            // and add your own custom code before or after the call to the base function.
            ...
            if (this.DataSource != null && this.DataSource.FieldTripAllocatedSpecified)
            {
                ...
                // The Format method will return the Display Foreign Key As (DFKA) value
                selectedValue = this.DataSource.FieldTripAllocated.ToString();
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = FieldTripChoicesTable.FieldTripAllocated.DefaultValue;
            ...
            this.PopulateFieldTripAllocatedDropDownList(selectedValue, 100);              
        ...
        {
         // Retrieve the value entered by the user on the FieldTripAllocated ASP:DropDownList, and
            // save it into the FieldTripAllocated field in DataSource DatabaseOLR_db%dbo.FieldTripChoices record.
      ...
      // To customize, override this method in FieldTripChoicesTableControlRow.
        ...
        // Fill the FieldTripAllocated list.
        protected virtual void PopulateFieldTripAllocatedDropDownList(string selectedValue, int maxItems) 
        {
            		  					                
            this.FieldTripAllocated.Items.Clear();
            
            // 1. Setup the static list items        
            
              // Add the Please Select item.
              this.FieldTripAllocated.Items.Insert(0, new ListItem(this.Page.GetResourceValue("Txt:PleaseSelect", "OLR"), "--PLEASE_SELECT--"));
            		  			
            // 2. Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_FieldTripAllocatedDropDownList function.
            // It is better to customize the where clause there.
            
                      
            WhereClause wc = CreateWhereClause_FieldTripAllocatedDropDownList();
            ...
            // 3. Read a total of maxItems from the database and insert them into the FieldTripAllocatedDropDownList.
            FieldTripOptionsRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                ...
                do
                {
                    ...
                    foreach (FieldTripOptionsRecord itemValue in itemValues) 
                    {
                        ...
                        {
                            cvalue = itemValue.FieldTripOptionId.ToString().ToString();
                            if (counter < maxItems && this.FieldTripAllocated.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.FieldTripAllocated.Items.FindByText(fvalue);
                                ...
                                ListItem newItem = new ListItem(fvalue, cvalue);
                                this.FieldTripAllocated.Items.Add(newItem);
            ...
            if (selectedValue != null &&
                selectedValue.Trim() != "" &&
                !MiscUtils.SetSelectedValue(this.FieldTripAllocated, selectedValue) &&
                !MiscUtils.SetSelectedDisplayText(this.FieldTripAllocated, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        if (fvalue == null || fvalue.Trim() == "") fvalue = cvalue;
                        MiscUtils.ResetSelectedItem(this.FieldTripAllocated, new ListItem(fvalue, cvalue));                      
                    }
                }
                catch
                {
        ...
        protected virtual void FieldTripAllocated_SelectedIndexChanged(object sender, EventArgs args)
        {
            // for the value inserted by quick add button or large list selector, 
            // the value is necessary to be inserted by this event during postback 
            string val = (string)(this.Page.Session[FieldTripAllocated.ClientID + "_SelectedValue"]);
            string displayText = (string)(this.Page.Session[FieldTripAllocated.ClientID + "_SelectedDisplayText"]);
            if (!string.IsNullOrEmpty(displayText) && !string.IsNullOrEmpty(val)) {
	            this.FieldTripAllocated.Items.Add(new ListItem(displayText, val));
...
// Base class for the FieldTripChoicesTableControl control on the EditRegistration page.
...
#region "Helper Functions"
        ...
        public virtual FieldTripChoicesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripChoicesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.EditRegistration.FieldTripChoicesTableControlRow")));
...
// Base class for the HonourContactLinksTableControlRow control on the EditRegistration page.
...
// Base class for the HonourContactLinksTableControl control on the EditRegistration page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
              ...
              
        {
              ...
              try
              {
                    string url = "../HonourContactLinks/Add-HonourContactLinks.aspx?ContactId={ContactsRecordControlRow:FV:ContactId}&TabVisible=False&SaveAndNewVisible=False";
...
#region "Helper Functions"
        ...
        public virtual HonourContactLinksTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (HonourContactLinksTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.EditRegistration.HonourContactLinksTableControlRow")));
...
// Base class for the PhotoClubContactLinksTableControlRow control on the EditRegistration page.
...
// Base class for the PhotoClubContactLinksTableControl control on the EditRegistration page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
              ...
              
        {
              ...
              try
              {
                    string url = "../PhotoClubContactLinks/Add-PhotoClubContactLinks.aspx?ContactId={ContactsRecordControlRow:FV:ContactId}&TabVisible=False&SaveAndNewVisible=False";
...
#region "Helper Functions"
        ...
        public virtual PhotoClubContactLinksTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PhotoClubContactLinksTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.EditRegistration.PhotoClubContactLinksTableControlRow")));
...
// Base class for the ContactsRecordControl control on the EditRegistration page.
...
// Base class for the RegistrationsRecordControl control on the EditRegistration page.
...
public class BaseRegistrationsRecordControl : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void GetDatePaid()
        {
            ...
            // save it into the DatePaid field in DataSource DatabaseOLR_db%dbo.Registrations record.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.DatePaid.Text, RegistrationsTable.DatePaid);							
        ...
        public virtual void GetInitialCreationDate()
        {
            ...
            // save it into the InitialCreationDate field in DataSource DatabaseOLR_db%dbo.Registrations record.
            // Parse will also validate the date to ensure it is of the proper format
            // and a valid date.  The format is verified based on the current culture 
            // settings including the order of month, day and year and the separator character.
            // Parse throws an exception if the date is invalid.
            ...
            // Save the value to data source
            this.DataSource.Parse(this.InitialCreationDate.Text, RegistrationsTable.InitialCreationDate);							
      ...
      // To customize, override this method in RegistrationsRecordControl.
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OLR.Business.RegistrationsTable, OLR.Business").TableDefinition.ColumnList.GetByUniqueName(@"Registrations_.ContactId"), EvaluateFormula("URL(\"Contact\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"Contact\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"Contact\")", false) == "--ANY--") whereClause.RunQuery = false;
