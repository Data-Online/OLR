...
// This file implements the code-behind class for Add_Honours.aspx.
// Add_Honours.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Honours
        : BaseApplicationPage
// Code-behind class for the Add_Honours page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetHonoursRecordControl()
        {
            SetHonoursRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Honours");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "HonoursRecordControl":
                 SetHonoursRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.HonoursRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetHonoursRecordControl_Base()           
        
        {        
            if (HonoursRecordControl.Visible)
            {
                HonoursRecordControl.LoadData();
                HonoursRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.HonoursRecordControl != null && this.HonoursRecordControl.DataSource != null)
                  {
                        id = this.HonoursRecordControl.DataSource.GetValue(this.HonoursRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.HonoursRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.HonoursRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.HonoursRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.HonoursRecordControl.DataSource.GetValue(this.HonoursRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
