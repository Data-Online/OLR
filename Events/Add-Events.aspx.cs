...
// This file implements the code-behind class for Add_Events.aspx.
// Add_Events.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Events
        : BaseApplicationPage
// Code-behind class for the Add_Events page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetEventsRecordControl()
        {
            SetEventsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Add_Events.EventsRecordControl EventsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Events");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "EventsRecordControl":
                 SetEventsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.EventsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetEventsRecordControl_Base()           
        
        {        
            if (EventsRecordControl.Visible)
            {
                EventsRecordControl.LoadData();
                EventsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.EventsRecordControl != null && this.EventsRecordControl.DataSource != null)
                  {
                        id = this.EventsRecordControl.DataSource.GetValue(this.EventsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.EventsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.EventsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.EventsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.EventsRecordControl.DataSource.GetValue(this.EventsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
