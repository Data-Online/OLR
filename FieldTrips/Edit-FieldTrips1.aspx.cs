...
// This file implements the code-behind class for Edit_FieldTrips1.aspx.
// Edit_FieldTrips1.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_FieldTrips1
        : BaseApplicationPage
// Code-behind class for the Edit_FieldTrips1 page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_FieldTrips1()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetFieldTripsTabContainer()
        {
            SetFieldTripsTabContainer_Base(); 
        }
        
        public void SetFieldTripOptionsTableControl()
        {
            SetFieldTripOptionsTableControl_Base(); 
        }
        
        public void SetFieldTripsRecordControl()
        {
            SetFieldTripsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Edit_FieldTrips1.FieldTripOptionsTableControl FieldTripOptionsTableControl;
          
        public OLR.UI.Controls.Edit_FieldTrips1.FieldTripsRecordControl FieldTripsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Field Trips");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "FieldTripOptionsTableControl":
                 SetFieldTripOptionsTableControl();
                 break;
          
              case "FieldTripsRecordControl":
                 SetFieldTripsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.FieldTripsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetFieldTripsTabContainer_Base()           
        ...
        public void SetFieldTripOptionsTableControl_Base()           
        ...
        public void SetFieldTripsRecordControl_Base()           
        
        {        
            if (FieldTripsRecordControl.Visible)
            {
                FieldTripsRecordControl.LoadData();
                FieldTripsRecordControl.DataBind();
            }
        }
