<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Edit_Honours" Assembly="OLR" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Edit-Honours.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OLR.UI.Edit_Honours" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                        ...
                        <OLR:HonoursRecordControl runat="server" id="HonoursRecordControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(GetResourceValue(&quot;Title:Edit&quot;),&quot;&quot;,&quot; Honours&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="HonourTextBoxMaxLengthValidator" ControlToValidate="Honour" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OLR&quot;).Replace(&quot;{FieldName}&quot;, &quot;Honour&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator></span>
	...
	<asp:hiddenfield id="HonoursRecordControl_PostbackTracker" runat="server" />
</OLR:HonoursRecordControl>
