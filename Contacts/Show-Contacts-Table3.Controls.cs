...
// Show_Contacts_Table3.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Contacts_Table3
{
...
// Base class for the ContactsTableControlRow control on the Show_Contacts_Table3 page.
...
// Base class for the ContactsTableControl control on the Show_Contacts_Table3 page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Contacts-Table3.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If Show-Contacts-Table3.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Contacts-Table3.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If Show-Contacts-Table3.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Contacts_Table3.ContactsTableControlRow")));
