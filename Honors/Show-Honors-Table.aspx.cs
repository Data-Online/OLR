...
// This file implements the code-behind class for Show_Honors_Table.aspx.
// Show_Honors_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_Honors_Table
        : BaseApplicationPage
// Code-behind class for the Show_Honors_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_Honors_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Show_Honors_Table.HonorsTableControl HonorsTableControl;
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Show_Honors_Table.HonorsTableControl control = new OLR.UI.Controls.Show_Honors_Table.HonorsTableControl();
