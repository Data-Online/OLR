...
// Show_Registrations_Table1.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Registrations_Table1
{
...
// Base class for the RegistrationsTableControlRow control on the Show_Registrations_Table1 page.
...
// Base class for the RegistrationsTableControl control on the Show_Registrations_Table1 page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Registrations-Table1.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Registrations";
                // If Show-Registrations-Table1.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Registrations-Table1.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Registrations";
                // If Show-Registrations-Table1.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RegistrationsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RegistrationsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Registrations_Table1.RegistrationsTableControlRow")));
