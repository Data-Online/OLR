...
// Show_Contacts1.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Contacts1
{
...
// Base class for the ContactsRecordControl control on the Show_Contacts1 page.
...
public class BaseContactsRecordControl : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ContactsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Contacts1"] = recId;
