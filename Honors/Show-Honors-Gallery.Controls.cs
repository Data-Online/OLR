...
// Show_Honors_Gallery.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Honors_Gallery
{
...
public class HonorsTableControlRow : BaseHonorsTableControlRow
{
      
        // The BaseHonorsTableControlRow implements code for a ROW within the
        // the HonorsTableControl table.  The BaseHonorsTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of HonorsTableControl.
...
public class HonorsTableControl : BaseHonorsTableControl
{
    // The BaseHonorsTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The HonorsTableControlRow class offers another place where you can customize
...
// Base class for the HonorsTableControlRow control on the Show_Honors_Gallery page.
// Do not modify this class. Instead override any method in HonorsTableControlRow.
public class BaseHonorsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        public BaseHonorsTableControlRow()
        {
        ...
        // To customize, override this method in HonorsTableControlRow.
        ...
        {
            // Load the data from the database into the DataSource DatabaseOLR_db%dbo.Honors record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = HonorsTable.GetRecord(this.RecordUniqueId, true);
              
                return;
            }
      
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BaseHonorsTableControl when the data for the entire
            // table is loaded.
            
            this.DataSource = new HonorsRecord();
        ...
        public virtual void SetDescription()
        {
            ...
            // DatabaseOLR_db%dbo.Honors database record.

            // this.DataSource is the DatabaseOLR_db%dbo.Honors record retrieved from the database.
            ...
            if (this.DataSource != null && this.DataSource.DescriptionSpecified) {
               ...
               string formattedValue = this.DataSource.Format(HonorsTable.Description);
              ...
              this.Description.Text = HonorsTable.Description.Format(HonorsTable.Description.DefaultValue);
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((HonorsTableControl)MiscUtils.GetParentControlObject(this, "HonorsTableControl")).DataChanged = true;
                ((HonorsTableControl)MiscUtils.GetParentControlObject(this, "HonorsTableControl")).ResetData = true;
            }
      ...
      // To customize, override this method in HonorsTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersHonorsTableControl = false;
            hasFiltersHonorsTableControl = hasFiltersHonorsTableControl && false; // suppress warning
        ...
        public virtual void Delete()
        {
          ...
          HonorsTable.DeleteRecord(pkValue);
        ...
        public virtual void Description_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Honors/Show-Honors.aspx?Honors={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseHonorsTableControlRow_Rec"];
            }
            set {
                this.ViewState["BaseHonorsTableControlRow_Rec"] = value;
            }
        }
        
        public HonorsRecord DataSource {
            get {
                return (HonorsRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    HonorsRecord rec = null;
        ...
        public virtual HonorsRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return HonorsTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the HonorsTableControl control on the Show_Honors_Gallery page.
// Do not modify this class. Instead override any method in HonorsTableControl.
public class BaseHonorsTableControl : OLR.UI.BaseApplicationTableControl
{
         
       public BaseHonorsTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OLR.Business.HonorsRecord);
                      this.DataSource = (HonorsRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (HonorsTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(OLR.Business.HonorsRecord);
                    this.DataSource = (HonorsRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual HonorsRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(HonorsTable.Column1, true);          
            // selCols.Add(HonorsTable.Column2, true);          
            // selCols.Add(HonorsTable.Column3, true);          
                  ...
                  
            {
                ...
                return HonorsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
                 
            }
            else
            {
                HonorsTable databaseTable = new HonorsTable();
                ...
                return (recList.ToArray(typeof(HonorsRecord)) as HonorsRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return HonorsTable.GetRecordCount(join, where);
            else
            {
                HonorsTable databaseTable = new HonorsTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public virtual HonorsRecord[] CopyArray(int index, HonorsRecord[,] recs, int columns)
      {
        HonorsRecord[] recsCopy = new HonorsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            HonorsRecord[,] recs = new HonorsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            HonorsRecord[] HColDataSource = new HonorsRecord[Convert.ToInt32(rows)];

            // Bind the repeater with the list of records to expand the UI.
            
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HonorsTableControlRepeater");
            if (rep == null) return;
            ...
            System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "HonorsTableControlRepeater1");
            ...
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep1.Items)
            {
              ...
              HonorsRecord[] VColDataSource = new HonorsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("HonorsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              HonorsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                HonorsTableControlRow recControl = (HonorsTableControlRow)innerRepItem.FindControl("HonorsTableControlRow");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for HonorsTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (HonorsTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            HonorsTable.Instance.InnerFilter = null;
            ...
            if (MiscUtils.IsValueSelected(this.DescriptionFilter)) {
                ...
                foreach (ListItem item in this.DescriptionFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(HonorsTable.Description, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      cols.Add(HonorsTable.Description, true);
      ...
      String DescriptionFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "DescriptionFilter_Ajax"];
        ...
        if (DescriptionFilterSelectedValue != null){
                        ...
                        foreach (string item in DescriptionFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(HonorsTable.Description, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OLR.Business.HonorsRecord[] recordList  = HonorsTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (HonorsRecord rec in recordList ){
                ...
                resultItem = rec.Format(HonorsTable.Description);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(HonorsTable.Description.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, HonorsTable.Description.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HonorsTableControlRepeater"));
              if (rep == null){return;}
              HonorsTableControlRow[] recControls = this.GetRecordControls();
                foreach (HonorsTableControlRow recControl in recControls) 
		{
              
                // Loop through all rows in the table, set its DataSource and call DataBind().
                
                    if (recControl.Visible && recControl.IsNewRecord) {
      HonorsRecord rec = new HonorsRecord();
        
                        if (recControl.Description.Text != "") {
                            rec.Parse(recControl.Description.Text, HonorsTable.Description);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new HonorsRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OLR.Business.HonorsRecord);
                this.DataSource = (HonorsRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(HonorsTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(HonorsTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetDescriptionFilter()
        {
            ...
            this.PopulateDescriptionFilter(MiscUtils.GetSelectedValueList(this.DescriptionFilter, DescriptionFilterselectedFilterItemList), 500);
              ...
              string url = this.ModifyRedirectUrl("../Honors/Honors-QuickSelector.aspx", "", true);
                    ...
                    
        {
            ...
            orderBy.Add(HonorsTable.Description, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = HonorsTable.GetValues(HonorsTable.Description, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( HonorsTable.Description.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = HonorsTable.Description.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
        ...
        public virtual WhereClause CreateWhereClause_DescriptionFilter()
        {
            ...
            else            
            {
                foreach (string item in DescriptionFilterselectedFilterItemList)
                {
                    ...
                    wc.iOR(HonorsTable.Description, BaseFilter.ComparisonOperator.EqualsTo, item);
    ...
    this.RemoveFromSession(this, "Page_Size");
      ...
      this.RemoveFromSession(this, "Vertical_Columns");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["HonorsTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["HonorsTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=Honors" ;
              ...
              
        {
              ...
              try
              {
                    string url = "../Honors/Add-Honors.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "HonorsTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "HonorsTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = HonorsTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             HonorsTable.Description,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(HonorsTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(HonorsTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(HonorsTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(HonorsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(HonorsTable.Description, "Default"));
              ...
              {
                val = HonorsTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Honors-Gallery.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Honors";
                // If Show-Honors-Gallery.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(HonorsTable.Description.Name, ReportEnum.Align.Left, "${Description}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = HonorsTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = HonorsTable.GetRecordCount(joinFilter,whereClause);
                HonorsRecord[] records = null;
                
                do
                {
                    
                    records = HonorsTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( HonorsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Description}", record.Format(HonorsTable.Description), ReportEnum.Align.Left);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Honors-Gallery.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Honors";
                // If Show-Honors-Gallery.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void SortControl_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in HonorsTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(HonorsTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (HonorsTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && HonorsTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(HonorsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(HonorsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = HonorsTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  HonorsRecord[] DataSource {
            ...
            get {
                return (HonorsRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                HonorsTableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        public virtual HonorsTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual HonorsTableControlRow[] GetSelectedRecordControls()
        {
        
            return (HonorsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Honors_Gallery.HonorsTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            HonorsTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OLR"));
            }
            
            foreach (HonorsTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual HonorsTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "HonorsTableControlRow");
	          List<HonorsTableControlRow> list = new List<HonorsTableControlRow>();
	          foreach (HonorsTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
