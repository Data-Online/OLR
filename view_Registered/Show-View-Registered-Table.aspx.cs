...
// This file implements the code-behind class for Show_View_Registered_Table.aspx.
// Show_View_Registered_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_View_Registered_Table
        : BaseApplicationPage
// Code-behind class for the Show_View_Registered_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_View_Registered_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Show_View_Registered_Table.View_RegisteredTableControl control = new OLR.UI.Controls.Show_View_Registered_Table.View_RegisteredTableControl();
