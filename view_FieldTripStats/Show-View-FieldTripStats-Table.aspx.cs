...
// This file implements the code-behind class for Show_View_FieldTripStats_Table.aspx.
// Show_View_FieldTripStats_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_View_FieldTripStats_Table
        : BaseApplicationPage
// Code-behind class for the Show_View_FieldTripStats_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_View_FieldTripStats_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetView_FieldTripStatsTableControl()
        {
            SetView_FieldTripStatsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Show_View_FieldTripStats_Table.View_FieldTripStatsTableControl View_FieldTripStatsTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "View_FieldTripStatsTableControl":
                 SetView_FieldTripStatsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.View_FieldTripStatsTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetView_FieldTripStatsTableControl_Base()           
        
        {        
            if (View_FieldTripStatsTableControl.Visible)
            {
                View_FieldTripStatsTableControl.LoadData();
                View_FieldTripStatsTableControl.DataBind();
            }
        }
