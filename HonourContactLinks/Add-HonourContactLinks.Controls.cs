...
// Add_HonourContactLinks.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Add_HonourContactLinks
{
...
// Base class for the HonourContactLinksRecordControl control on the Add_HonourContactLinks page.
...
public class BaseHonourContactLinksRecordControl : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (HonourContactLinksRecord)HonourContactLinksRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in HonourContactLinksRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["HonourContactLinks"];
            ...
            HttpContext.Current.Session["QueryString in Add-HonourContactLinks"] = recId;
...
#region "Helper Properties"
    ...
    HonourContactLinksRecord rec = null;
             ...
             
        {
            ...
            return new HonourContactLinksRecord();
