...
// Email_FieldTripOptions_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Email_FieldTripOptions_Table
{
...
// Base class for the FieldTripOptionsTableControlRow control on the Email_FieldTripOptions_Table page.
...
// Base class for the FieldTripOptionsTableControl control on the Email_FieldTripOptions_Table page.
...
#region "Helper Functions"
        ...
        public virtual FieldTripOptionsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripOptionsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Email_FieldTripOptions_Table.FieldTripOptionsTableControlRow")));
