...
// This file implements the code-behind class for Add_FieldTripOptions.aspx.
// Add_FieldTripOptions.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_FieldTripOptions
        : BaseApplicationPage
// Code-behind class for the Add_FieldTripOptions page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_FieldTripOptions()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetFieldTripOptionsRecordControl()
        {
            SetFieldTripOptionsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Add_FieldTripOptions.FieldTripOptionsRecordControl FieldTripOptionsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Field Trip Options");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "FieldTripOptionsRecordControl":
                 SetFieldTripOptionsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.FieldTripOptionsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetFieldTripOptionsRecordControl_Base()           
        
        {        
            if (FieldTripOptionsRecordControl.Visible)
            {
                FieldTripOptionsRecordControl.LoadData();
                FieldTripOptionsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.FieldTripOptionsRecordControl != null && this.FieldTripOptionsRecordControl.DataSource != null)
                  {
                        id = this.FieldTripOptionsRecordControl.DataSource.GetValue(this.FieldTripOptionsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.FieldTripOptionsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.FieldTripOptionsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.FieldTripOptionsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.FieldTripOptionsRecordControl.DataSource.GetValue(this.FieldTripOptionsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
