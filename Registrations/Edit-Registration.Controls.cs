...
// Edit_Registration.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_Registration
{
...
// Base class for the FieldTripChoicesTableControlRow control on the Edit_Registration page.
...
// Base class for the FieldTripChoicesTableControl control on the Edit_Registration page.
...
#region "Helper Functions"
        ...
        public virtual FieldTripChoicesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripChoicesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Edit_Registration.FieldTripChoicesTableControlRow")));
...
// Base class for the PhotoClubContactLinksTableControlRow control on the Edit_Registration page.
...
// Base class for the PhotoClubContactLinksTableControl control on the Edit_Registration page.
...
#region "Helper Functions"
        ...
        public virtual PhotoClubContactLinksTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PhotoClubContactLinksTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Edit_Registration.PhotoClubContactLinksTableControlRow")));
...
// Base class for the ContactsRecordControl control on the Edit_Registration page.
...
// Base class for the RegistrationsRecordControl control on the Edit_Registration page.
...
public class BaseRegistrationsRecordControl : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RegistrationsRecordControl.
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OLR.Business.RegistrationsTable, OLR.Business").TableDefinition.ColumnList.GetByUniqueName(@"Registrations_.RegistrationId"), EvaluateFormula("URL(\"Registrations\")", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("URL(\"Registrations\")", false) == "--PLEASE_SELECT--" || EvaluateFormula("URL(\"Registrations\")", false) == "--ANY--") whereClause.RunQuery = false;
