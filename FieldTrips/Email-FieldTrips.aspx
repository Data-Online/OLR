<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Email_FieldTrips" Assembly="OLR" %>

<%@ Register Tagprefix="Selectors" Namespace="OLR" Assembly="OLR" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Email-FieldTrips.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/Email.master" Inherits="OLR.UI.Email_FieldTrips" %>
