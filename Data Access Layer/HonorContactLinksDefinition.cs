...
/// <see cref="HonorContactLinksTable">OLR.HonorContactLinksTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="HonorContactLinksTable"></seealso>
public class HonorContactLinksDefinition
{
#region "Definition (XML) for HonorContactLinksDefinition table"
	//Next 139 lines contain Table Definition (XML) for table "HonorContactLinksDefinition"
	...
	/// <see cref="HonorContactLinksTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKTable>OLR.Business.HonorsTable, OLR.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>HonorId</columnFKColumn>");
         ...
         tbf.Append(      @"<columnName>HonorContactLinkId</columnName>");
         tbf.Append(      @"<columnUIName>Honor Contact Link</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>HonorContactLinks</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>HonorContactLinks_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>HonorContactLinks</TableCodeName>");
         tbf.Append(  @"<FolderName>HonorContactLinks</FolderName>");
         tbf.Append(  @"<MenuName>Honor Contact Links</MenuName>");
         tbf.Append(  @"<QSPath>../HonorContactLinks/HonorContactLinks-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOLRHonorContactLinks</TableStoredProcPrefix>");
