...
// Email_Registrations_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Email_Registrations_Table
{
...
// Base class for the RegistrationsTableControlRow control on the Email_Registrations_Table page.
...
public class BaseRegistrationsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetRegistrationTypeId()
        {
            ...
            // Set the RegistrationTypeId Literal on the webpage with value from the
            // DatabaseOLR_db%dbo.Registrations database record.

            // this.DataSource is the DatabaseOLR_db%dbo.Registrations record retrieved from the database.
            // this.RegistrationTypeId is the ASP:Literal on the webpage.
            ...
            // If the RegistrationTypeId is NULL or blank, then use the value specified  
            // on Properties.
            if (this.RegistrationTypeId.Text == null ||
                this.RegistrationTypeId.Text.Trim().Length == 0) {
                // Set the value specified on the Properties.
                this.RegistrationTypeId.Text = "&nbsp;";
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal RegistrationTypeId {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegistrationTypeId");
            }
        }
...
// Base class for the RegistrationsTableControl control on the Email_Registrations_Table page.
...
#region "Helper Functions"
        ...
        public virtual RegistrationsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RegistrationsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Email_Registrations_Table.RegistrationsTableControlRow")));
