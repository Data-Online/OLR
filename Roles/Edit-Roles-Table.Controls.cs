...
// Edit_Roles_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_Roles_Table
{
...
// Base class for the Roles1TableControlRow control on the Edit_Roles_Table page.
// Do not modify this class. Instead override any method in Roles1TableControlRow.
public class BaseRoles1TableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              this.RoleName.TextChanged += RoleName_TextChanged;
        ...
        public virtual void SetRoleName()
        {
            ...
            if (this.PreviousUIData.ContainsKey(this.RoleName.ID))
            {
            
                this.RoleName.Text = this.PreviousUIData[this.RoleName.ID].ToString();
              
                return;
            }
            
                    
            // Set the RoleName TextBox on the webpage with value from the
            // DatabaseOLR_db%dbo.Roles database record.

            // this.DataSource is the DatabaseOLR_db%dbo.Roles record retrieved from the database.
            // this.RoleName is the ASP:TextBox on the webpage.
        ...
        public virtual void GetRoleName()
        {
            ...
            // Retrieve the value entered by the user on the RoleName ASP:TextBox, and
            // save it into the RoleName field in DataSource DatabaseOLR_db%dbo.Roles record.
            
            // Custom validation should be performed in Validate, not here.
                    
            // Save the value to data source
            this.DataSource.Parse(this.RoleName.Text, Roles1Table.RoleName);							
      ...
      // To customize, override this method in Roles1TableControlRow.
        ...
        Roles1TableControl tc= ((Roles1TableControl)MiscUtils.GetParentControlObject(this, "Roles1TableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((Roles1TableControlRow)this);
                    }
                    this.Visible = false;
      ...
      this.Page.Response.Redirect(url);
        ...
        protected virtual void RoleName_TextChanged(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox RoleName {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RoleName");
            }
        }
...
// Base class for the Roles1TableControl control on the Edit_Roles_Table page.
// Do not modify this class. Instead override any method in Roles1TableControl.
public class BaseRoles1TableControl : OLR.UI.BaseApplicationTableControl
{
      ...
      Roles1Record rec = new Roles1Record();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Role Name {Txt:Ascending}"), "RoleName Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Role Name {Txt:Descending}"), "RoleName Desc"));
                    ...
                    
        {
            ...
            if (this.RoleNameFilter.Items.Count == 0)
                this.RoleNameFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OLR"), "--ANY--"));
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("Roles1TableControlRepeater");
...
#region "Helper Functions"
        ...
        public virtual Roles1TableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (Roles1TableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_Roles_Table.Roles1TableControlRow")));
