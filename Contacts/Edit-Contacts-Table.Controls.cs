...
// Edit_Contacts_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_Contacts_Table
{
...
// Base class for the ContactsTableControlRow control on the Edit_Contacts_Table page.
...
// Base class for the ContactsTableControl control on the Edit_Contacts_Table page.
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_Contacts_Table.ContactsTableControlRow")));
