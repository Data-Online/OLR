...
<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Show_FieldTrips_Gallery" Assembly="OLR" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-FieldTrips-Gallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OLR.UI.Show_FieldTrips_Gallery" %>
...
<td class="galleryttc" style="width:33%;"><asp:Literal runat="server" id="Description"></asp:Literal> <br />
<span style="white-space:nowrap;">
<asp:LinkButton runat="server" id="Date0" causesvalidation="False" commandname="Redirect"></asp:LinkButton></span>
 <br />
</td></OLR:FieldTripsTableControlRow>
</ITEMTEMPLATE>
