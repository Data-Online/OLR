...
// This file implements the code-behind class for Edit_View_FieldTripSelections_Table.aspx.
// Edit_View_FieldTripSelections_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_View_FieldTripSelections_Table
        : BaseApplicationPage
// Code-behind class for the Edit_View_FieldTripSelections_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_View_FieldTripSelections_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetView_FieldTripSelectionsTableControl()
        {
            SetView_FieldTripSelectionsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Edit_View_FieldTripSelections_Table.View_FieldTripSelectionsTableControl View_FieldTripSelectionsTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Field Trip Selections");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "View_FieldTripSelectionsTableControl":
                 SetView_FieldTripSelectionsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.View_FieldTripSelectionsTableControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetView_FieldTripSelectionsTableControl_Base()           
        
        {        
            if (View_FieldTripSelectionsTableControl.Visible)
            {
                View_FieldTripSelectionsTableControl.LoadData();
                View_FieldTripSelectionsTableControl.DataBind();
            }
        }
