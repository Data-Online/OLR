...
// Add_FieldTrips.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Add_FieldTrips
{
...
// Base class for the FieldTripsRecordControl control on the Add_FieldTrips page.
...
public class BaseFieldTripsRecordControl : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (FieldTripsRecord)FieldTripsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in FieldTripsRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["FieldTrips"];
            ...
            HttpContext.Current.Session["QueryString in Add-FieldTrips"] = recId;
