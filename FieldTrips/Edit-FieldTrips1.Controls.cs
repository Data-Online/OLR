...
// Edit_FieldTrips1.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_FieldTrips1
{
...
public class FieldTripsRecordControl : BaseFieldTripsRecordControl
{
      
        // The BaseFieldTripsRecordControl implements the LoadData, DataBind and other
...
// Base class for the FieldTripOptionsTableControlRow control on the Edit_FieldTrips1 page.
...
public class BaseFieldTripOptionsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        FieldTripsRecordControl parentCtrl;
      
            parentCtrl = (FieldTripsRecordControl)this.Page.FindControlRecursively("FieldTripsRecordControl");
      ...
      // To customize, override this method in FieldTripOptionsTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersFieldTripsRecordControl = false;
            hasFiltersFieldTripsRecordControl = hasFiltersFieldTripsRecordControl && false; // suppress warning
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../FieldTripOptions/Edit-FieldTripOptions.aspx?FieldTripOptions={PK}";
...
// Base class for the FieldTripOptionsTableControl control on the Edit_FieldTrips1 page.
...
public class BaseFieldTripOptionsTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    OLR.UI.Controls.Edit_FieldTrips1.FieldTripsRecordControl fieldTripsRecordControlObj = (MiscUtils.FindControlRecursively(this.Page , "FieldTripsRecordControl") as OLR.UI.Controls.Edit_FieldTrips1.FieldTripsRecordControl);
              ...
              {
              wc.iAND(FieldTripOptionsTable.FieldTripId, BaseFilter.ComparisonOperator.EqualsTo, fieldTripsRecordControlObj.GetRecord().FieldTripId.ToString());
              selectedRecordKeyValue.AddElement(FieldTripOptionsTable.FieldTripId.InternalName, fieldTripsRecordControlObj.GetRecord().FieldTripId.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInFieldTripsRecordControl = HttpContext.Current.Session["FieldTripOptionsTableControlWhereClause"] as string;
      
      if (selectedRecordInFieldTripsRecordControl != null && KeyValue.IsXmlKey(selectedRecordInFieldTripsRecordControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInFieldTripsRecordControl);
      ...
      FieldTripOptionsRecord rec = new FieldTripOptionsRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Cost {Txt:Ascending}"), "Cost Asc"));
              
                this.SortControl1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Cost {Txt:Descending}"), "Cost Desc"));
...
#region "Helper Functions"
        ...
        public virtual FieldTripOptionsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripOptionsTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_FieldTrips1.FieldTripOptionsTableControlRow")));
...
// Base class for the FieldTripsRecordControl control on the Edit_FieldTrips1 page.
// Do not modify this class. Instead override any method in FieldTripsRecordControl.
public class BaseFieldTripsRecordControl : OLR.UI.BaseApplicationRecordControl
{
        public BaseFieldTripsRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in FieldTripsRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "FieldTripsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            FieldTripsRecord[] recList = FieldTripsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = FieldTripsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public override void DataBind()
        {
            ...
            bool shouldResetControl = false;
            if (shouldResetControl) { }; // prototype usage to void compiler warnings
            FieldTripOptionsTableControl recFieldTripOptionsTableControl = (FieldTripOptionsTableControl)(MiscUtils.FindControlRecursively(this.Page, "FieldTripOptionsTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recFieldTripOptionsTableControl.ResetControl();
          }
                  
        this.Page.SetControl("FieldTripOptionsTableControl");
        ...
        public virtual void SetEventId()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = FieldTripsTable.EventId.DefaultValue;
        ...
        public virtual void GetEventId()
        {
         // Retrieve the value entered by the user on the EventId ASP:QuickSelector, and
            // save it into the EventId field in DataSource DatabaseOLR_db%dbo.FieldTrips record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.EventId), FieldTripsTable.EventId);			
      ...
      // To customize, override this method in FieldTripsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["FieldTrips"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OLR").Replace("{URL}", "FieldTrips"));
            }
            HttpContext.Current.Session["QueryString in Edit-FieldTrips1"] = recId;
          ...
          wc.iAND(FieldTripsTable.FieldTripId, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(FieldTripsTable.FieldTripId));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(FieldTripsTable.FieldTripId, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseFieldTripsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseFieldTripsRecordControl_Rec"] = value;
            }
        }
