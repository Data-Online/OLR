...
public partial class DatePagination : BaseApplicationUserControl , IDatePagination
{
        
      #region "Section 1: Place your customizations here."

      public DatePagination()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void NextInterval_Click(object sender, EventArgs args)
        {
        ...
        public void PreviousInterval_Click(object sender, EventArgs args)
        {
        ...
        public void SetPreviousInterval()
        {
            SetPreviousInterval_Base(); 
        }              
...
#region "Section 2: Do not modify this section."
        ...
        private string Interval_Base
        {
            ...
            get{
                ...
                if (this.Year1.Visible) return "Year";
                
                if (this.Quarter1.Visible) return "Quarter";
                
                if (this.Month1.Visible) return "Month";
                
                if (this.Week1.Visible) return "Week";
                
                if (this.Day1.Visible) return "Day";
            ...
            set{
                ...
                //for the rest of the interval, set the corresponded link button to be visible, and literal to be invisible.
                  ...
                  this.Month1.Visible = false;
                
                  this.Quarter.Visible  = true;
                  this.Quarter1.Visible = false;
                ...
                switch (value)
                {
                    case "Year":
                        ...
                        this.Year1.Visible = true;
                
                        break;
                    case "Quarter":
                
                        this.Quarter.Visible  = false;
                        this.Quarter1.Visible = true;
                
                        break;
                    case "Month":
                
                        this.Month.Visible  = false;
                        this.Month1.Visible = true;
                
                        break;
                    case "Week":
                
                        this.Week.Visible  = false;
                        this.Week1.Visible = true;
                
                        break;
                    case "Day":
                
                        this.Day.Visible  = false;
                        this.Day1.Visible = true;
      ...
      public void Page_InitializeEventHandlers_Base(object sender, System.EventArgs e)
      {
          ...
          // Setup the pagination events.
                    ...
                    this.NextInterval.Button.Click += NextInterval_Click;
                        
                    this.NextPageInterval.Button.Click += NextPageInterval_Click;
                        
                    this.PreviousInterval.Button.Click += PreviousInterval_Click;
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetNextInterval_Base()                
        ...
        public void SetPreviousInterval_Base()                
        ...
        public void NextInterval_Click_Base(object sender, EventArgs args)
        {
        ...
        // event handler for Button
        public void PreviousInterval_Click_Base(object sender, EventArgs args)
        {
...
#region Interface Properties
        ...
        public System.Web.UI.WebControls.LinkButton Day {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Day");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public System.Web.UI.WebControls.Literal Day1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Day1");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public System.Web.UI.WebControls.LinkButton Month {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Month");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal Month1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Month1");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public IThemeButton NextInterval {
            get {
                return (IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_NextInterval");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public IThemeButton NextPageInterval {
            get {
                return (IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_NextPageInterval");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public IThemeButton PreviousInterval {
            get {
                return (IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_PreviousInterval");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public IThemeButton PreviousPageInterval {
            get {
                return (IThemeButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_PreviousPageInterval");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public System.Web.UI.WebControls.LinkButton Quarter {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Quarter");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public System.Web.UI.WebControls.Literal Quarter1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Quarter1");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public System.Web.UI.WebControls.LinkButton Week {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Week");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public System.Web.UI.WebControls.Literal Week1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Week1");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public System.Web.UI.WebControls.LinkButton Year {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Year");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal Year1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_Year1");
            }
        }
