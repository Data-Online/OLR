...
// Show_FieldTrips_Gallery1.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_FieldTrips_Gallery1
{
...
// Base class for the FieldTripsTableControlRow control on the Show_FieldTrips_Gallery1 page.
        ...
        public virtual void SetImagewithOverlaidText()
                  {
                        ...
                        this.ImagewithOverlaidText.Text = EvaluateFormula("FieldTripsTableControlRow.GetImageWithOverlaidText(\"\", \"<a class=\\\"button_link\\\" href=\\\"\" + FieldTripsTableControlRow.ModifyRedirectUrl(\"../FieldTrips/Show-FieldTrips.aspx?FieldTrips={PK}\", \"\", True) + \"\\\">\" + Date0 + \"</a>\", FieldTripsTableControlRow.ModifyRedirectUrl(\"../FieldTrips/Show-FieldTrips.aspx?FieldTrips={PK}\", \"\", True))");
...
// Base class for the FieldTripsTableControl control on the Show_FieldTrips_Gallery1 page.
...
public class BaseFieldTripsTableControl : OLR.UI.BaseApplicationTableControl
{
       ...
       public BaseFieldTripsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.DateFromFilter)) 				
                    initialVal = this.GetFromSession(this.DateFromFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"DateFrom\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.DateFromFilter.Text = initialVal;
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.DateToFilter)) 				
                    initialVal = this.GetFromSession(this.DateToFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"DateTo\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    this.DateToFilter.Text = initialVal;
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.DateFromFilter.Text = "";
            
            this.DateToFilter.Text = "";
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.DateFromFilter)) {
                string val = MiscUtils.GetSelectedValue(this.DateFromFilter, this.GetFromSession(this.DateFromFilter));
                DateTime d = DateParser.ParseDate(val, DateColumn.DEFAULT_FORMAT);
                    
                val = d.ToShortDateString() + " " + "00:00:00";
                wc.iAND(FieldTripsTable.Date0, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, val, false, false);
                    
            }
                      
            if (MiscUtils.IsValueSelected(this.DateToFilter)) {
                string val = MiscUtils.GetSelectedValue(this.DateToFilter, this.GetFromSession(this.DateToFilter));
                DateTime d = DateParser.ParseDate(val, DateColumn.DEFAULT_FORMAT);
                    
                val = d.ToShortDateString() + " " + "23:59:59";
                wc.iAND(FieldTripsTable.Date0, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, val, false, false);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual WhereClause CreateWhereClause(String searchText, String fromSearchControl, String AutoTypeAheadSearch, String AutoTypeAheadWordSeparators)
        {
            ...
            string DateFromFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "DateFromFilter_Ajax"];
            if (MiscUtils.IsValueSelected(DateFromFilterSelectedValue)) {
                DateTime d = DateParser.ParseDate(DateFromFilterSelectedValue, DateColumn.DEFAULT_FORMAT);
                DateFromFilterSelectedValue = d.ToShortDateString() + " " + "00:00:00";
                    
                wc.iAND(FieldTripsTable.Date0, BaseFilter.ComparisonOperator.Greater_Than_Or_Equal, DateFromFilterSelectedValue, false, false);
                    
            }         
            string DateToFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "DateToFilter_Ajax"];
            if (MiscUtils.IsValueSelected(DateToFilterSelectedValue)) {
                DateTime d = DateParser.ParseDate(DateToFilterSelectedValue, DateColumn.DEFAULT_FORMAT);
                DateToFilterSelectedValue = d.ToShortDateString() + " " + "23:59:59";
                    
                wc.iAND(FieldTripsTable.Date0, BaseFilter.ComparisonOperator.Less_Than_Or_Equal, DateToFilterSelectedValue, false, false);
      ...
      FieldTripsRecord rec = new FieldTripsRecord();
        ...
        protected override void SaveControlsToSession()
        {
            ...
            this.SaveToSession(this.DateFromFilter, this.DateFromFilter.Text);
                  
            this.SaveToSession(this.DateToFilter, this.DateToFilter.Text);
      ...
      this.SaveToSession("DateFromFilter_Ajax", this.DateFromFilter.Text);
              
      this.SaveToSession("DateToFilter_Ajax", this.DateToFilter.Text);
      ...
      this.SaveToSession("SearchText_Ajax", this.SearchText.Text);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.DateFromFilter);
            this.RemoveFromSession(this.DateToFilter);
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTrips-Gallery1.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTrips";
                // If Show-FieldTrips-Gallery1.PDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Date0}", record.Format(FieldTripsTable.Date0), ReportEnum.Align.Left);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTrips-Gallery1.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTrips";
                // If Show-FieldTrips-Gallery1.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox DateFromFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DateFromFilter");
            }
        }
        
        public System.Web.UI.WebControls.Literal DateLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DateLabel1");
            }
        }
        
        public System.Web.UI.WebControls.TextBox DateToFilter {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "DateToFilter");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual FieldTripsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Gallery1.FieldTripsTableControlRow")));
