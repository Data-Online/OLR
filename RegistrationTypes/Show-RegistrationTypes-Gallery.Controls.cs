...
// Show_RegistrationTypes_Gallery.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_RegistrationTypes_Gallery
{
...
// Base class for the RegistrationTypesTableControlRow control on the Show_RegistrationTypes_Gallery page.
        ...
        public virtual void SetEventId()
        {
            ...
            if (this.DataSource != null && this.DataSource.EventIdSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&RegistrationTypesTable.EventId.IsApplyDisplayAs)
                     ...
                     formattedValue = RegistrationTypesTable.GetDFKA(this.DataSource.EventId.ToString(),RegistrationTypesTable.EventId, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(RegistrationTypesTable.EventId);
              ...
              this.EventId.Text = RegistrationTypesTable.EventId.Format(RegistrationTypesTable.EventId.DefaultValue);
...
// Base class for the RegistrationTypesTableControl control on the Show_RegistrationTypes_Gallery page.
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              if (this.TotalRecords > 10000)
              {
                ...
                BaseColumn[] columns = new BaseColumn[] {
                             RegistrationTypesTable.Description,
             ...
             null};
              ...
              DataForExport data = new DataForExport(RegistrationTypesTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(RegistrationTypesTable.Description, "Default"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RegistrationTypes-Gallery.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RegistrationTypes";
                // If Show-RegistrationTypes-Gallery.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(RegistrationTypesTable.Description.Name, ReportEnum.Align.Left, "${Description}", ReportEnum.Align.Left, 28);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Description}", record.Format(RegistrationTypesTable.Description), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-RegistrationTypes-Gallery.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "RegistrationTypes";
                // If Show-RegistrationTypes-Gallery.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual RegistrationTypesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RegistrationTypesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_RegistrationTypes_Gallery.RegistrationTypesTableControlRow")));
