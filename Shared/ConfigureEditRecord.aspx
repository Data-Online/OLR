                                    ...
                                    <td class="configureErrorPagesText">
                                        ...
                                        <ol>
                                            ...
                                            <li>Go to the Application Explorer tab, navigate in the tree to the page that contains
                                                the Edit button or icon.<br />
                                                <br />
                                                <ul style="list-style-type: disc">
                                                    <li>Select the name of the Edit button or icon on the page. Then click the 'Redirect' property present in the 'Button Actions' section on the Properties sheet.</li>
						    <li>In the Redirect Action Wizard dialog, select the type of Redirect action and click the Next button.</li>
                                                    <li>Now modify the Redirect URL to point to your Edit Record page.<br />
