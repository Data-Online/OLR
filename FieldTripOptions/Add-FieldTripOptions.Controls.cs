...
// Add_FieldTripOptions.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Add_FieldTripOptions
{
...
// Base class for the FieldTripOptionsRecordControl control on the Add_FieldTripOptions page.
...
public class BaseFieldTripOptionsRecordControl : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            this.DataSource = (FieldTripOptionsRecord)FieldTripOptionsRecord.Copy(recList[0], false);
      ...
      // To customize, override this method in FieldTripOptionsRecordControl.
         ...
         
        {
            ...
            string recId = this.Page.Request.QueryString["FieldTripOptions"];
            ...
            HttpContext.Current.Session["QueryString in Add-FieldTripOptions"] = recId;
...
#region "Helper Properties"
    ...
    FieldTripOptionsRecord rec = null;
             ...
             
        {
            ...
            return new FieldTripOptionsRecord();
