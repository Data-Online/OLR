...
/// <see cref="FieldTripOptionsTable">OLR.FieldTripOptionsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="FieldTripOptionsTable"></seealso>
public class FieldTripOptionsDefinition
{
#region "Definition (XML) for FieldTripOptionsDefinition table"
	//Next 169 lines contain Table Definition (XML) for table "FieldTripOptionsDefinition"
	...
	/// <see cref="FieldTripOptionsTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_FieldTripOptions_FieldTrips</columnFKName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>FieldTripOptions</TableName>");
         tbf.Append(  @"<Version>1</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>FieldTripOptions_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>FieldTripOptions</TableCodeName>");
         tbf.Append(  @"<FolderName>FieldTripOptions</FolderName>");
         tbf.Append(  @"<MenuName>Field Trip Options</MenuName>");
         tbf.Append(  @"<QSPath>../FieldTripOptions/FieldTripOptions-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOLRFieldTripOptions</TableStoredProcPrefix>");
