...
// Show_FieldTrips_Gallery.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_FieldTrips_Gallery
{
...
// Base class for the FieldTripsTableControlRow control on the Show_FieldTrips_Gallery page.
...
public class BaseFieldTripsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetDate0()
        {
            ...
            // Set the Date LinkButton on the webpage with value from the
            ...
            // this.Date0 is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.Date0Specified) {
               ...
               string formattedValue = this.DataSource.Format(FieldTripsTable.Date0, @"d");
                ...
                this.Date0.Text = formattedValue;
                  ...
                  this.Date0.ToolTip = "Go to " + this.Date0.Text.Replace("<wbr/>", "");
      ...
      // To customize, override this method in FieldTripsTableControlRow.
        ...
        public virtual void Date0_Click(object sender, EventArgs args)
        {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton Date0 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Date0");
            }
        }
...
// Base class for the FieldTripsTableControl control on the Show_FieldTrips_Gallery page.
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTrips-Gallery.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTrips";
                // If Show-FieldTrips-Gallery.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTrips-Gallery.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTrips";
                // If Show-FieldTrips-Gallery.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual FieldTripsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Gallery.FieldTripsTableControlRow")));
