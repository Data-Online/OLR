...
// Base class for the PhotoClubContactLinksTableControlRow control on the Show_View_Registered_Table page.
...
public class BasePhotoClubContactLinksTableControlRow : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in PhotoClubContactLinksTableControlRow.
        ...
        public virtual void PhotoClubId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../PhotoClubs/Show-PhotoClubs.aspx?PhotoClubs={PhotoClubContactLinksTableControlRow:FK:FK_PhotoClubContactLinks_PhotoClubs}";
...
// Base class for the PhotoClubContactLinksTableControl control on the Show_View_Registered_Table page.
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return PhotoClubContactLinksTable.GetRecords(join, where, orderBy, this.PageIndex, this.PageSize);
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Loop through all rows in the table, set its DataSource and call DataBind().
            PhotoClubContactLinksTableControlRow recControl = (PhotoClubContactLinksTableControlRow)(repItem.FindControl("PhotoClubContactLinksTableControlRow"));
            recControl.DataSource = this.DataSource[index];            
            if (this.UIData.Count > index)
                recControl.PreviousUIData = this.UIData[index];
            recControl.DataBind();
        ...
        protected virtual WhereClause CreateQueryClause()
        {
            ...
            if (EvaluateFormula("View_RegisteredTableControlRow.ContactId.Text", false) != "")filter.AddFilter(new BaseClasses.Data.ColumnValueFilter(BaseClasses.Data.BaseTable.CreateInstance(@"OLR.Business.PhotoClubContactLinksTable, OLR.Business").TableDefinition.ColumnList.GetByUniqueName(@"PhotoClubContactLinks_.ContactId"), EvaluateFormula("View_RegisteredTableControlRow.ContactId.Text", false), BaseClasses.Data.BaseFilter.ComparisonOperator.EqualsTo, false));
         if (EvaluateFormula("View_RegisteredTableControlRow.ContactId.Text", false) == "--PLEASE_SELECT--" || EvaluateFormula("View_RegisteredTableControlRow.ContactId.Text", false) == "--ANY--") whereClause.RunQuery = false;
...
#region "Helper Functions"
        ...
        public virtual PhotoClubContactLinksTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PhotoClubContactLinksTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_View_Registered_Table.PhotoClubContactLinksTableControlRow")));
