...
// Email_FieldTripOptions.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Email_FieldTripOptions
{
...
// Base class for the FieldTripOptionsRecordControl control on the Email_FieldTripOptions page.
...
public class BaseFieldTripOptionsRecordControl : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in FieldTripOptionsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Email-FieldTripOptions"] = recId;
