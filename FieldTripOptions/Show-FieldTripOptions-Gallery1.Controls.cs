...
// Show_FieldTripOptions_Gallery1.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_FieldTripOptions_Gallery1
{
...
// Base class for the FieldTripOptionsTableControlRow control on the Show_FieldTripOptions_Gallery1 page.
        ...
        public virtual void SetImagewithOverlaidText()
                  {
                        ...
                        this.ImagewithOverlaidText.Text = EvaluateFormula("FieldTripOptionsTableControlRow.GetImageWithOverlaidText(\"\", \"<a class=\\\"button_link\\\" href=\\\"\" + FieldTripOptionsTableControlRow.ModifyRedirectUrl(\"../FieldTripOptions/Show-FieldTripOptions.aspx?FieldTripOptions={PK}\", \"\", True) + \"\\\">\" + FieldTripId + \"</a>\", FieldTripOptionsTableControlRow.ModifyRedirectUrl(\"../FieldTripOptions/Show-FieldTripOptions.aspx?FieldTripOptions={PK}\", \"\", True))");
...
// Base class for the FieldTripOptionsTableControl control on the Show_FieldTripOptions_Gallery1 page.
...
public class BaseFieldTripOptionsTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        {    
                  ...
                  
            {
                ...
                return FieldTripOptionsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
      ...
      public virtual FieldTripOptionsRecord[] CopyArray(int index, FieldTripOptionsRecord[,] recs, int columns)
      {
        FieldTripOptionsRecord[] recsCopy = new FieldTripOptionsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            FieldTripOptionsRecord[,] recs = new FieldTripOptionsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            FieldTripOptionsRecord[] HColDataSource = new FieldTripOptionsRecord[Convert.ToInt32(rows)];
            ...
            System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "FieldTripOptionsTableControlRepeater1");
            ...
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep1.Items)
            {
              ...
              FieldTripOptionsRecord[] VColDataSource = new FieldTripOptionsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("FieldTripOptionsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              FieldTripOptionsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                FieldTripOptionsTableControlRow recControl = (FieldTripOptionsTableControlRow)innerRepItem.FindControl("FieldTripOptionsTableControlRow");
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.FieldTripIdFilter)) {
                ...
                foreach (ListItem item in this.FieldTripIdFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(FieldTripOptionsTable.FieldTripId, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String FieldTripIdFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "FieldTripIdFilter_Ajax"];
        ...
        if (FieldTripIdFilterSelectedValue != null){
                        ...
                        foreach (string item in FieldTripIdFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(FieldTripOptionsTable.FieldTripId, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FieldTripOptionsTableControlRepeater"));
              if (rep == null){return;}
              FieldTripOptionsTableControlRow[] recControls = this.GetRecordControls();
                foreach (FieldTripOptionsTableControlRow recControl in recControls) 
		{
      ...
      FieldTripOptionsRecord rec = new FieldTripOptionsRecord();
        ...
        public virtual void SetFieldTripIdFilter()
        {
            ...
            this.PopulateFieldTripIdFilter(MiscUtils.GetSelectedValueList(this.FieldTripIdFilter, FieldTripIdFilterselectedFilterItemList), 500);
              ...
              url += "?Target=" + this.FieldTripIdFilter.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("Description")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("FieldTripId")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=FieldTripOptions" ;
              ...
              
        {
              ...
              try
              {
                    string url = "../FieldTripOptions/Add-FieldTripOptions.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "FieldTripOptionsTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "FieldTripOptionsTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = FieldTripOptionsTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             FieldTripOptionsTable.FieldTripId,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(FieldTripOptionsTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(FieldTripOptionsTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(FieldTripOptionsTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(FieldTripOptionsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(FieldTripOptionsTable.FieldTripId, "Default"));
              ...
              {
                val = FieldTripOptionsTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTripOptions-Gallery1.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTripOptions";
                // If Show-FieldTripOptions-Gallery1.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(FieldTripOptionsTable.FieldTripId.Name, ReportEnum.Align.Left, "${FieldTripId}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = FieldTripOptionsTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = FieldTripOptionsTable.GetRecordCount(joinFilter,whereClause);
                FieldTripOptionsRecord[] records = null;
                
                do
                {
                    
                    records = FieldTripOptionsTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( FieldTripOptionsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = FieldTripOptionsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(FieldTripOptionsTable.FieldTripId);
                                 _DFKA = FieldTripOptionsTable.GetDFKA(record.FieldTripId.ToString(), FieldTripOptionsTable.FieldTripId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  FieldTripOptionsTable.FieldTripId.IsApplyDisplayAs){
                                     report.AddData("${FieldTripId}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${FieldTripId}", record.Format(FieldTripOptionsTable.FieldTripId), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTripOptions-Gallery1.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTripOptions";
                // If Show-FieldTripOptions-Gallery1.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual FieldTripOptionsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripOptionsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTripOptions_Gallery1.FieldTripOptionsTableControlRow")));
