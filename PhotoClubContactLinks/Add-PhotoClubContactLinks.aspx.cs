...
// This file implements the code-behind class for Add_PhotoClubContactLinks.aspx.
// Add_PhotoClubContactLinks.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_PhotoClubContactLinks
        : BaseApplicationPage
// Code-behind class for the Add_PhotoClubContactLinks page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_PhotoClubContactLinks()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetPhotoClubContactLinksRecordControl()
        {
            SetPhotoClubContactLinksRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Add_PhotoClubContactLinks.PhotoClubContactLinksRecordControl PhotoClubContactLinksRecordControl;
        ...
        protected virtual void Page_Load(object sender, EventArgs e)
        {
            ...
            this.Authorize("Everyone");
             if (!this.IsPostBack)
             {
                    ...
                    this.ValidationSummary1.HeaderText = GetResourceValue("ValidationSummaryHeaderText", "OLR");
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "PhotoClubContactLinksRecordControl":
                 SetPhotoClubContactLinksRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.PhotoClubContactLinksRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPhotoClubContactLinksRecordControl_Base()           
        
        {        
            if (PhotoClubContactLinksRecordControl.Visible)
            {
                PhotoClubContactLinksRecordControl.LoadData();
                PhotoClubContactLinksRecordControl.DataBind();
            }
        }
              ...
              
        {
            ...
            if (EvaluateFormula("URL(\"SaveAndNewVisible\")").ToLower() == "true") 
                ...
                MiscUtils.FindControlRecursively(this, "SaveAndNewButton").Visible = false;
                    ...
                    this.SaveAndNewButton.Button.Attributes.Add("onclick", "SubmitHRefOnce(this, \"" + this.GetResourceValue("Txt:SaveRecord", "OLR") + "\");");
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.PhotoClubContactLinksRecordControl != null && this.PhotoClubContactLinksRecordControl.DataSource != null)
                  {
                        id = this.PhotoClubContactLinksRecordControl.DataSource.GetValue(this.PhotoClubContactLinksRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.PhotoClubContactLinksRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.PhotoClubContactLinksRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.PhotoClubContactLinksRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.PhotoClubContactLinksRecordControl.DataSource.GetValue(this.PhotoClubContactLinksRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
