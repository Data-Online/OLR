...
public class BaseFieldTripOptionsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in FieldTripOptionsTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersAvailableWorkshopsRecordControl = false;
            hasFiltersAvailableWorkshopsRecordControl = hasFiltersAvailableWorkshopsRecordControl && false; // suppress warning
...
public class BaseRegistrationsTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
      ...
      public override void DataBind()
      {
        ...
        foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetRegistrationsCountControl();
                  ...
                  RegistrationsTableControlRow recControl = (RegistrationsTableControlRow)(rep.Items[0].FindControl("RegistrationsTableControlRow"));
                  ...
                  RegistrationsTableControlRow row = (RegistrationsTableControlRow)(repItem.FindControl("RegistrationsTableControlRow"));
                  
                        if (row.GetRecord().RegistrationIdSpecified){
                        keyValue.AddElement(RegistrationsTable.RegistrationId.InternalName, row.GetRecord().RegistrationId.ToString());
                        }
                  ...
                  KeyValue keyValue = new KeyValue();
                        ...
                        if (recControl.GetRecord().RegistrationIdSpecified){
                        keyValue.AddElement(RegistrationsTable.RegistrationId.InternalName, recControl.GetRecord().RegistrationId.ToString());
                        }
        ...
        WorkshopsTableControl recWorkshopsTableControl = (WorkshopsTableControl)(MiscUtils.FindControlRecursively(this.Page, "WorkshopsTableControl"));
        
          if (shouldResetControl || this.Page.IsPageRefresh)
          {
             recWorkshopsTableControl.ResetControl();
          }
        
        recWorkshopsTableControl.WorkshopsCountQuery.DataChanged = true;    
                  
        this.Page.SetControl("WorkshopsTableControl");
...
// Base class for the WorkshopsTableControlRow control on the Show_FieldTrips_Table page.
...
public class BaseWorkshopsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        SetAvailableWorkshopsRecordControl();
        ...
        public virtual void SetWorkshopsCountControl()
                  {
                  
                        this.WorkshopsCountControl.Text = EvaluateFormula("LOOKUP(WorkshopsCountQuery, WorkshopId)");
                    
                    
        }
                
        public virtual void SetAvailableWorkshopsRecordControl()           
        
        {        
            if (AvailableWorkshopsRecordControl.Visible)
            {
                AvailableWorkshopsRecordControl.LoadData();
                AvailableWorkshopsRecordControl.DataBind();
            }
        }
        ...
        public virtual string EvaluateFormula(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS, FormulaEvaluator e)
        {
            ...
            if (includeDS)
            {
                ...
                // add datasource as variables for formula evaluation
                  WorkshopsTableControl panel;
                panel = (WorkshopsTableControl)(this.GetParentTableControl());
                  
                e.Variables.Add("WorkshopsCountQuery", panel.WorkshopsCountQuery);                                                       
        ...
        RegistrationsTableControlRow parentCtrl;
            ...
            parentCtrl = (RegistrationsTableControlRow)this.Page.FindControlRecursively("RegistrationsTableControlRow");
        ...
        throw new Exception(Page.GetResourceValue("Err:NoParentRecId", "OLR"));
          ...
          this.DataSource.RegistrationId = parentCtrl.DataSource.RegistrationId;
            ...
            this.CheckSum = "";
            // For Master-Detail relationships, save data on the Detail table(s)            
          AvailableWorkshopsRecordControl recAvailableWorkshopsRecordControl = (AvailableWorkshopsRecordControl)(MiscUtils.FindControlRecursively(this, "AvailableWorkshopsRecordControl"));
        recAvailableWorkshopsRecordControl.SaveData();
...
#region "Helper Properties"
        ...
        public AvailableWorkshopsRecordControl AvailableWorkshopsRecordControl {
            get {
                return (AvailableWorkshopsRecordControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "AvailableWorkshopsRecordControl");
            }
        }
        
        public System.Web.UI.WebControls.Literal WorkshopsCountControl {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "WorkshopsCountControl");
            }
        }
...
// Base class for the WorkshopsTableControl control on the Show_FieldTrips_Table page.
...
public class BaseWorkshopsTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
        ...
        public virtual void RegisterPostback()
        {
          ...
          public virtual string EvaluateFormula(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS, FormulaEvaluator e)
          {
            ...
            if (includeDS)
            {
                ...
                if (WorkshopsCountQuery != null) e.Variables.Add("WorkshopsCountQuery", WorkshopsCountQuery);                                                       
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        OLR.UI.Controls.Show_FieldTrips_Table.RegistrationsTableControl registrationsTableControlObj = (MiscUtils.FindControlRecursively(this.Page, "RegistrationsTableControl") as OLR.UI.Controls.Show_FieldTrips_Table.RegistrationsTableControl);
          
              if (this.GetFromSession(registrationsTableControlObj, "selectedRowID", null) != null)
              {
              registrationsRecordObj = KeyValue.XmlToKey(this.GetFromSession(registrationsTableControlObj, "selectedRowID", null));
              if (registrationsRecordObj != null && registrationsRecordObj.ContainsColumn(RegistrationsTable.RegistrationId))
              {
              wc.iAND(WorkshopsTable.RegistrationId, BaseFilter.ComparisonOperator.EqualsTo, registrationsRecordObj.GetColumnValue(RegistrationsTable.RegistrationId).ToString());
              selectedRecordKeyValue.AddElement(WorkshopsTable.RegistrationId.InternalName, registrationsRecordObj.GetColumnValue(RegistrationsTable.RegistrationId).ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInRegistrationsTableControl = HttpContext.Current.Session["WorkshopsTableControlWhereClause"] as string;
      ...
      WorkshopsRecord rec = new WorkshopsRecord();
        ...
        public virtual void SetPlacesAvailableLabel()
                  {
                      ...
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.PlacesAvailableLabel.Text = "Some value";
                    
                    
        }
                
        public virtual void SetPlacesRequestedLabel()
                  {
                  
                      //Code for the text property is generated inside the .aspx file. 
                      //To override this property you can uncomment the following property and add you own value.
                      //this.PlacesRequestedLabel.Text = "Some value";
                    
                    
        }
                
        public virtual WhereClause CreateWhereClause_WorkshopsCountQuery()
        
        {
            ...
            // Get the static clause defined at design time on the Query Wizard
            WhereClause qc = this.CreateQueryClause_WorkshopsCountQuery();
            if (qc != null) {
                wc.iAND(qc);
            }
        ...
        public virtual WhereClause CreateQueryClause_WorkshopsCountQuery()
        ...
        public virtual void LoadData_WorkshopsCountQuery()
        
        {
          
              if (!(this.ResetData || this.DataChanged || _WorkshopsCountQuery.DataChanged) && this.Page.IsPostBack  && this.Page.Request["__EVENTTARGET"] != "isd_geo_location") return;
        
              _WorkshopsCountQuery.DataChanged = true;
          
              this._WorkshopsCountQuery.Initialize("WorkshopsCountQuery", WorkshopsTable.Instance, 0, 0);
            
               
              // Add the primary key of the record
              WhereClause wc = CreateWhereClause_WorkshopsCountQuery();
              this._WorkshopsCountQuery.WhereClause.iAND(wc);                      
          
              // Define selects
          
              this._WorkshopsCountQuery.AddSelectItem(new SelectItem(WorkshopsTable.WorkshopId, WorkshopsTable.Instance, false, "", ""));
              
                    this._WorkshopsCountQuery.AddSelectItem(new SelectItem(SelectItem.Operation.COUNT, new SelectItem(SelectItem.ItemType.AllColumns, WorkshopsTable.Instance, "WorkshopsCount", ""), "WorkshopsCount"));
              
              // Define joins if there are any
          
              this._WorkshopsCountQuery.LoadData(false, this._WorkshopsCountQuery.PageSize, this._WorkshopsCountQuery.PageIndex);                       
                        
        }
      
        private DataSource _WorkshopsCountQuery = new DataSource();
        public DataSource WorkshopsCountQuery
        {
            get
            {
                return _WorkshopsCountQuery;
             }
        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Label PlacesAvailableLabel {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PlacesAvailableLabel");
            }
        }
        
        public System.Web.UI.WebControls.Label PlacesRequestedLabel {
            get {
                return (System.Web.UI.WebControls.Label)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PlacesRequestedLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual WorkshopsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (WorkshopsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Table.WorkshopsTableControlRow")));
...
// Base class for the AvailableWorkshopsRecordControl control on the Show_FieldTrips_Table page.
// Do not modify this class. Instead override any method in AvailableWorkshopsRecordControl.
public class BaseAvailableWorkshopsRecordControl : OLR.UI.BaseApplicationRecordControl
{
        public BaseAvailableWorkshopsRecordControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
        ...
        // To customize, override this method in AvailableWorkshopsRecordControl.
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "AvailableWorkshopsRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            AvailableWorkshopsRecord[] recList = AvailableWorkshopsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = AvailableWorkshopsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void SetPlacesAvailable2()
        {
            ...
            if (this.DataSource != null && this.DataSource.PlacesAvailableSpecified) {
              ...
              this.PlacesAvailable2.Text = AvailableWorkshopsTable.PlacesAvailable.Format(AvailableWorkshopsTable.PlacesAvailable.DefaultValue);
        ...
        public virtual void SaveData()
        {
          ...
          WorkshopsTableControlRow parentCtrl;
      
            parentCtrl = (WorkshopsTableControlRow)MiscUtils.GetParentControlObject(this, "WorkshopsTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue workshopsRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = workshopsRecordObj;
          workshopsRecordObj = tmp;
        WorkshopsTableControlRow workshopsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "WorkshopsTableControlRow") as WorkshopsTableControlRow);
          
              if (workshopsTableControlObjRow != null && workshopsTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(AvailableWorkshopsTable.AvailableWorkshopId, BaseFilter.ComparisonOperator.EqualsTo, workshopsTableControlObjRow.GetRecord().AvailableWorkshopId.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["AvailableWorkshopsRecordControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
      ...
      string selectedRecordInWorkshopsTableControl = HttpContext.Current.Session["AvailableWorkshopsRecordControlWhereClause"] as string;
      
      if (selectedRecordInWorkshopsTableControl != null && KeyValue.IsXmlKey(selectedRecordInWorkshopsTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInWorkshopsTableControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(AvailableWorkshopsTable.AvailableWorkshopId))
      {
      wc.iAND(AvailableWorkshopsTable.AvailableWorkshopId, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(AvailableWorkshopsTable.AvailableWorkshopId).ToString());
      }
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseAvailableWorkshopsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseAvailableWorkshopsRecordControl_Rec"] = value;
            }
        }
