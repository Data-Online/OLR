...
// This file implements the code-behind class for Edit_HomeTowns_Table.aspx.
// Edit_HomeTowns_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_HomeTowns_Table
        : BaseApplicationPage
// Code-behind class for the Edit_HomeTowns_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_HomeTowns_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetHomeTownsTableControl()
        {
            SetHomeTownsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Edit_HomeTowns_Table.HomeTownsTableControl HomeTownsTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Home Towns");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "HomeTownsTableControl":
                 SetHomeTownsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.HomeTownsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Edit_HomeTowns_Table.HomeTownsTableControl control = new OLR.UI.Controls.Edit_HomeTowns_Table.HomeTownsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetHomeTownsTableControl_Base()           
        
        {        
            if (HomeTownsTableControl.Visible)
            {
                HomeTownsTableControl.LoadData();
                HomeTownsTableControl.DataBind();
            }
        }
