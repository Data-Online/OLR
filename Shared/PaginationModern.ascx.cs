...
namespace OLR.UI
{
  ...
  // Code-behind class for the PaginationModern user control.
public partial class PaginationModern : BaseApplicationUserControl , IPaginationModern
{
        
      #region "Section 1: Place your customizations here."

      public PaginationModern()
        {
            this.Initialize();
      ...
      {
          return this.GetCurrentPageSize_Base();
      }
    ...
    this.LoadData();
      ...
      public void Page_PreRender_Base(object sender, System.EventArgs e)
      {
            ...
            // Data bind for each chart UI control.
                  ...
                  DropDownList ddlPageSize = (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_PageSizeSelector");
                  TextBox textPageSize = (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_PageSize");

                  if ( ddlPageSize != null && textPageSize != null && textPageSize.Text != "" ) {
                      if (ddlPageSize.Items.FindByText(textPageSize.Text) == null) {
                          int idx = 0;

                          foreach (ListItem item in ddlPageSize.Items) {
                              if ((item.Value.CompareTo(textPageSize.Text) > 0 && item.Value.Length == textPageSize.Text.Length) ||
                                item.Value.Length > textPageSize.Text.Length) {
              			break;
                              }
                          ...
                          ddlPageSize.Items.Insert(idx, textPageSize.Text);
                      }

                      ddlPageSize.Text = textPageSize.Text;
                  }
              
      }  
      
        
              public int GetCurrentPageSize_Base()
              {
                  DropDownList ddlPageSize = (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_PageSizeSelector");
                  TextBox textPageSize = (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_PageSize");
                  if (ddlPageSize != null)
                      return Convert.ToInt32(ddlPageSize.SelectedValue);
                  else if (textPageSize != null)
                      return Convert.ToInt32(textPageSize.Text);
                  else
                      return 1;
              }              
...
#region Interface Properties
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public System.Web.UI.WebControls.TextBox PageSize {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_PageSize");
            }
        }
        ...
        NotifyParentProperty(true),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        public System.Web.UI.WebControls.DropDownList PageSizeSelector
        {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "_PageSizeSelector");
            }
        }
