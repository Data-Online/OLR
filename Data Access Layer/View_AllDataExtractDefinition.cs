...
#region "Definition (XML) for View_AllDataExtractDefinition table"
	//Next 1373 lines contain Table Definition (XML) for table "View_AllDataExtractDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName>Attending</columnUIName>");
         tbf.Append(      @"<columnType>Boolean</columnType>");
         tbf.Append(      @"<columnDBType>bit</columnDBType>");
         tbf.Append(      @"<columnLengthSet></columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<columnName>WorkshopDescription2</columnName>");
         tbf.Append(      @"<columnUIName Source=""User"">= &quot;Workshop&quot;</columnUIName>");
         tbf.Append(      @"<columnType>String</columnType>");
         tbf.Append(      @"<columnDBType>nvarchar</columnDBType>");
         tbf.Append(      @"<columnLengthSet>200</columnLengthSet>");
         ...
         tbf.Append(      @"<columnName>Attending2</columnName>");
