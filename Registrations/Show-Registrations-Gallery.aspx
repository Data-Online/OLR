...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-Registrations-Gallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OLR.UI.Show_Registrations_Gallery" %>
...
<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Show_Registrations_Gallery" Assembly="OLR" %>
...
<BaseClasses:QuickSelector runat="server" id="EventIdFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="RegistrationsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3"></th></tr><asp:Repeater runat="server" id="RegistrationsTableControlRepeater">		<ITEMTEMPLATE>
...
<td class="galleryttc" style="width:33%;"><asp:Literal runat="server" id="EventId"></asp:Literal> <br />
<asp:LinkButton runat="server" id="ValidationUid" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <br />
</td></OLR:RegistrationsTableControlRow>
</ITEMTEMPLATE>
