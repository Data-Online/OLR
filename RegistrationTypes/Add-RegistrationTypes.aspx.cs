...
// This file implements the code-behind class for Add_RegistrationTypes.aspx.
// Add_RegistrationTypes.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_RegistrationTypes
        : BaseApplicationPage
// Code-behind class for the Add_RegistrationTypes page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_RegistrationTypes()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetRegistrationTypesRecordControl()
        {
            SetRegistrationTypesRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Add_RegistrationTypes.RegistrationTypesRecordControl RegistrationTypesRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Registration Types");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "RegistrationTypesRecordControl":
                 SetRegistrationTypesRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.RegistrationTypesRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetRegistrationTypesRecordControl_Base()           
        
        {        
            if (RegistrationTypesRecordControl.Visible)
            {
                RegistrationTypesRecordControl.LoadData();
                RegistrationTypesRecordControl.DataBind();
            }
        }
