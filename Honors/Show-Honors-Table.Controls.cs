...
// Show_Honors_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Honors_Table
{
...
// Base class for the HonorsTableControlRow control on the Show_Honors_Table page.
...
// Base class for the HonorsTableControl control on the Show_Honors_Table page.
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Honors-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Honors";
                // If Show-Honors-Table.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Honors-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Honors";
                // If Show-Honors-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual HonorsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (HonorsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Honors_Table.HonorsTableControlRow")));
