...
// Show_Contacts_Gallery2.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Contacts_Gallery2
{
...
// Base class for the ContactsTableControlRow control on the Show_Contacts_Gallery2 page.
...
public class BaseContactsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.Address2.Click += Address2_Click;
        ...
        public virtual void SetAddress2()
        {
            ...
            // Set the Address2 LinkButton on the webpage with value from the
            // DatabaseOLR_db%dbo.Contacts database record.

            // this.DataSource is the DatabaseOLR_db%dbo.Contacts record retrieved from the database.
            // this.Address2 is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.Address2Specified) {
               ...
               string formattedValue = this.DataSource.Format(ContactsTable.Address2);
                ...
                this.Address2.Text = formattedValue;
                  ...
                  this.Address2.ToolTip = "Go to " + this.Address2.Text.Replace("<wbr/>", "");
      ...
      // To customize, override this method in ContactsTableControlRow.
        ...
        public virtual void Address2_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Contacts/Show-Contacts.aspx?Contacts={PK}";
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton Address2 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Address2");
            }
        }
...
// Base class for the ContactsTableControl control on the Show_Contacts_Gallery2 page.
...
public class BaseContactsTableControl : OLR.UI.BaseApplicationTableControl
{
       ...
       public BaseContactsTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.Address1Filter)) 				
                    initialVal = this.GetFromSession(this.Address1Filter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"Address1\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] Address1FilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in Address1FilteritemListFromSession)
                    {
                        ...
                        {
                            this.Address1Filter.Items.Add(item);
                            this.Address1Filter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.Address1Filter.Items)
                    {
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.SortControl.SelectedIndexChanged += new EventHandler(SortControl_SelectedIndexChanged);
              ...
              this.Address1Filter.SelectedIndexChanged += Address1Filter_SelectedIndexChanged;                  
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.Address1Filter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.Address1Filter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.Address1Filter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.Address1Filter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(ContactsTable.Address1, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String Address1FilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "Address1Filter_Ajax"];
            if (MiscUtils.IsValueSelected(Address1FilterSelectedValue)) {

              
        if (Address1FilterSelectedValue != null){
                        string[] Address1FilteritemListFromSession = Address1FilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in Address1FilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(ContactsTable.Address1, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      ContactsRecord rec = new ContactsRecord();
        ...
        public virtual void SetAddress1Filter()
        {
            
            ArrayList Address1FilterselectedFilterItemList = new ArrayList();
            string Address1FilteritemsString = null;
            if (this.InSession(this.Address1Filter))
                Address1FilteritemsString = this.GetFromSession(this.Address1Filter);
            
            if (Address1FilteritemsString != null)
            {
                string[] Address1FilteritemListFromSession = Address1FilteritemsString.Split(',');
                foreach (string item in Address1FilteritemListFromSession)
                {
                    Address1FilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateAddress1Filter(MiscUtils.GetSelectedValueList(this.Address1Filter, Address1FilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../Contacts/Contacts-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.Address1Filter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("Address1")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.Address1Filter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(Address1Filter.AutoPostBack).ToLower() + ", event); return false;";
        ...
        // Get the filters' data for Address1Filter.
                
        protected virtual void PopulateAddress1Filter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_Address1Filter();            
            this.Address1Filter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_Address1Filter function.
            // It is better to customize the where clause there.
             
            
            
            OrderBy orderBy = new OrderBy(false, false);
            orderBy.Add(ContactsTable.Address1, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = ContactsTable.GetValues(ContactsTable.Address1, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( ContactsTable.Address1.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = ContactsTable.Address1.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
                ...
                ListItem dupItem = this.Address1Filter.Items.FindByText(fvalue);
                ...
                this.Address1Filter.Items.Add(newItem);
            ...
            this.Address1Filter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.Address1Filter.Items.Count == 0)
                this.Address1Filter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OLR"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_Address1Filter()
        {
            // Create a where clause for the filter Address1Filter.
            // This function is called by the Populate method to load the items 
            // in the Address1FilterQuickSelector
            ...
            Address1FilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.Address1Filter, Address1FilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (Address1FilterselectedFilterItemList == null || Address1FilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in Address1FilterselectedFilterItemList)
                {
            
      
   
                    wc.iOR(ContactsTable.Address1, BaseFilter.ComparisonOperator.EqualsTo, item);
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList Address1FilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.Address1Filter, null);
            string Address1FilterSessionString = "";
            if (Address1FilterselectedFilterItemList != null){
                foreach (string item in Address1FilterselectedFilterItemList){
                    Address1FilterSessionString = String.Concat(Address1FilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.Address1Filter, Address1FilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("Address1Filter_Ajax", Address1FilterSessionString);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.Address1Filter);
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(Address1Filter))
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Contacts-Gallery2.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If Show-Contacts-Gallery2.PDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Address1}", record.Format(ContactsTable.Address1), ReportEnum.Align.Left, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Contacts-Gallery2.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If Show-Contacts-Gallery2.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void Address1Filter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector Address1Filter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "Address1Filter");
            }
        }              
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Contacts_Gallery2.ContactsTableControlRow")));
