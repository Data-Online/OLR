...
// This file implements the code-behind class for Edit_RegistrationTypes_Table.aspx.
// Edit_RegistrationTypes_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_RegistrationTypes_Table
        : BaseApplicationPage
// Code-behind class for the Edit_RegistrationTypes_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_RegistrationTypes_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Registration Types");
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Edit_RegistrationTypes_Table.RegistrationTypesTableControl control = new OLR.UI.Controls.Edit_RegistrationTypes_Table.RegistrationTypesTableControl();
