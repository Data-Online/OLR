...
<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Edit_AvailableWorkshops_Table" Assembly="OLR" %>

<%@ Register Tagprefix="OLR" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Edit-AvailableWorkshops-Table.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OLR.UI.Edit_AvailableWorkshops_Table" %>
			...
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                  ...
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(&quot;Available Workshops&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<BaseClasses:QuickSelector runat="server" id="EventIdFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="AvailableWorkshopsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thcnb" colspan="3"><asp:CheckBox runat="server" id="ToggleAll" onclick="toggleAllCheckboxes(this);">	</asp:CheckBox></th><th class="thcnb"></th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc">&nbsp;</th><th class="thc"></th><th class="thc"></th></tr><asp:Repeater runat="server" id="AvailableWorkshopsTableControlRepeater">		<ITEMTEMPLATE>		<OLR:AvailableWorkshopsTableControlRow runat="server" id="AvailableWorkshopsTableControlRow">
<tr><td colspan="3">
                        ...
                        </td><td class="tableCellLabel"><asp:Literal runat="server" id="WorkshopDescriptionLabel" Text="Workshop Description">	</asp:Literal> 
<span style="white-space:nowrap;">
<asp:Literal runat="server" id="EventId" visible="False"></asp:Literal></span>
</td><td class="tableCellValue" colspan="3"><asp:TextBox runat="server" id="WorkshopDescription" MaxLength="200" columns="60" cssclass="field_input" rows="4" textmode="MultiLine"></asp:TextBox>&nbsp;
<BaseClasses:TextBoxMaxLengthValidator runat="server" id="WorkshopDescriptionTextBoxMaxLengthValidator" ControlToValidate="WorkshopDescription" ErrorMessage="&lt;%# GetResourceValue(&quot;Val:ValueTooLong&quot;, &quot;OLR&quot;).Replace(&quot;{FieldName}&quot;, &quot;Workshop Description&quot;) %>"></BaseClasses:TextBoxMaxLengthValidator> </td><td class="tableCellValue"><asp:Literal runat="server" id="PlacesAvailableLabel" Text="Places Available">	</asp:Literal></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td></tr><tr><td class="tableRowDivider" colspan="8"></td><td class="tableRowDivider"></td><td class="tableRowDivider"></td></tr></OLR:AvailableWorkshopsTableControlRow>
</ITEMTEMPLATE>
