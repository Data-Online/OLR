...
/// <see cref="WorkshopsTable">OLR.WorkshopsTable</see> class
...
#region "Definition (XML) for WorkshopsDefinition table"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>WorkshopId</columnName>");
         tbf.Append(      @"<columnUIName>Workshop</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_Workshops_Registrations</columnFKName>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_Workshops_AvailableWorkshops</columnFKName>");
         ...
         tbf.Append(        @"<columnFKColumnDisplay>WorkshopDescription</columnFKColumnDisplay>");
         tbf.Append(        @"<foreignKeyType>Explicit</foreignKeyType>");
         tbf.Append(      "</foreignKey>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>Workshops</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>Workshops_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>Workshops</TableCodeName>");
         tbf.Append(  @"<FolderName>Workshops</FolderName>");
         tbf.Append(  @"<MenuName>Workshops</MenuName>");
         tbf.Append(  @"<QSPath>../Workshops/Workshops-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOLRWorkshops</TableStoredProcPrefix>");
