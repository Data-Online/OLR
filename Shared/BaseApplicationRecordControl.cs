...
#region "Section 1: Place your customizations here."
    ...
    public class BaseApplicationRecordControl : BaseApplicationRecordControlGEN
    {
...
#region "Section 2: Do not modify this section."
    ...
    public class BaseApplicationRecordControlGEN : System.Web.UI.Control
    {
        public BaseApplicationRecordControlGEN()
        {
            this.PreRender += new EventHandler(Control_ClearControls_PreRender);
            this.Unload += new EventHandler(Control_SaveControls_Unload);
			this.Load += new EventHandler(BaseLoad_GEN);
        }
        ...
        public virtual decimal Rank(string controlName)
        {
            return FormulaUtils.Rank(this.GetParentTableControl(), this as BaseApplicationRecordControl, controlName);
        }
