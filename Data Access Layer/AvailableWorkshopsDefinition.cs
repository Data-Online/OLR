...
/// <see cref="AvailableWorkshopsTable">OLR.AvailableWorkshopsTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="AvailableWorkshopsTable"></seealso>
public class AvailableWorkshopsDefinition
{
#region "Definition (XML) for AvailableWorkshopsDefinition table"
	//Next 207 lines contain Table Definition (XML) for table "AvailableWorkshopsDefinition"
	...
	/// <see cref="AvailableWorkshopsTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName>Available Workshop</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_AvailableWorkshops_Events</columnFKName>");
         ...
         tbf.Append(      @"<columnName>WorkshopDescription</columnName>");
         tbf.Append(      @"<columnUIName>Workshop Description</columnUIName>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>AvailableWorkshops</TableName>");
         tbf.Append(  @"<Version>3</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>AvailableWorkshops_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>AvailableWorkshops</TableCodeName>");
         tbf.Append(  @"<FolderName>AvailableWorkshops</FolderName>");
         tbf.Append(  @"<MenuName>Available Workshops</MenuName>");
         tbf.Append(  @"<QSPath>../AvailableWorkshops/AvailableWorkshops-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOLRAvailableWorkshops</TableStoredProcPrefix>");
