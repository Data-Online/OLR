...
/// <see cref="ContactsTable">OLR.ContactsTable</see> class
...
#region "Definition (XML) for ContactsDefinition table"
	//Next 549 lines contain Table Definition (XML) for table "ContactsDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnUIName>Hometown</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(        @"<columnFKName>FK_Contacts_HomeTowns</columnFKName>");
         ...
         tbf.Append(      @"<columnName>NZIPPMember</columnName>");
         tbf.Append(      @"<columnUIName>NZIPP Member</columnUIName>");
         tbf.Append(      @"<columnType>Boolean</columnType>");
         tbf.Append(      @"<columnDBType>bit</columnDBType>");
         tbf.Append(      @"<columnLengthSet></columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pOLRContacts</TableStoredProcPrefix>");
