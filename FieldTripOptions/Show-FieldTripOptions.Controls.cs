...
// Show_FieldTripOptions.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_FieldTripOptions
{
...
// Base class for the FieldTripOptionsRecordControl control on the Show_FieldTripOptions page.
// Do not modify this class. Instead override any method in FieldTripOptionsRecordControl.
public class BaseFieldTripOptionsRecordControl : OLR.UI.BaseApplicationRecordControl
{
        public BaseFieldTripOptionsRecordControl()
        {
        ...
        // To customize, override this method in FieldTripOptionsRecordControl.
        ...
        public virtual void LoadData()  
        {
            ...
            FieldTripOptionsRecord[] recList = FieldTripOptionsTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = FieldTripOptionsTable.GetRecord(recList[0].GetID().ToXmlString(), true);
      ...
      // To customize, override this method in FieldTripOptionsRecordControl.
         ...
         
        {
            ...
            bool hasFiltersFieldTripOptionsRecordControl = false;
            hasFiltersFieldTripOptionsRecordControl = hasFiltersFieldTripOptionsRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["FieldTripOptions"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OLR").Replace("{URL}", "FieldTripOptions"));
            }
            HttpContext.Current.Session["QueryString in Show-FieldTripOptions"] = recId;
          ...
          wc.iAND(FieldTripOptionsTable.FieldTripOptionId, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(FieldTripOptionsTable.FieldTripOptionId));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(FieldTripOptionsTable.FieldTripOptionId, BaseFilter.ComparisonOperator.EqualsTo, recId);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void FieldTripId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../FieldTrips/Show-FieldTrips.aspx?FieldTrips={FieldTripOptionsRecordControl:FK:FK_FieldTripOptions_FieldTrips}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseFieldTripOptionsRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseFieldTripOptionsRecordControl_Rec"] = value;
            }
        }
