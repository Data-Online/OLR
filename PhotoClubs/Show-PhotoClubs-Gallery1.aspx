...
<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Show_PhotoClubs_Gallery1" Assembly="OLR" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-PhotoClubs-Gallery1.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OLR.UI.Show_PhotoClubs_Gallery1" %><asp:Content id="PageSection" ContentPlaceHolderID="PageContent" Runat="server">
...
<BaseClasses:QuickSelector runat="server" id="DescriptionFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="gallerydBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <table id="PhotoClubsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="4"></th></tr><asp:Repeater runat="server" id="PhotoClubsTableControlRepeater">		<ITEMTEMPLATE>
		<asp:Repeater runat="server" id="PhotoClubsTableControlRepeater1">				<ITEMTEMPLATE>
<tr><asp:Repeater runat="server" id="PhotoClubsTableControlCellRepeater">		<ITEMTEMPLATE>		<OLR:PhotoClubsTableControlRow runat="server" id="PhotoClubsTableControlRow">
<td class="galleryttc" style="width:25%;"><asp:Literal runat="server" id="ImagewithOverlaidText">	</asp:Literal> </td></OLR:PhotoClubsTableControlRow>
</ITEMTEMPLATE>
