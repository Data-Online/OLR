...
// This file implements the code-behind class for Add_HonourContactLinks.aspx.
// Add_HonourContactLinks.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_HonourContactLinks
        : BaseApplicationPage
// Code-behind class for the Add_HonourContactLinks page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_HonourContactLinks()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetHonourContactLinksRecordControl()
        {
            SetHonourContactLinksRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Add_HonourContactLinks.HonourContactLinksRecordControl HonourContactLinksRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Honour Contact Links");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "HonourContactLinksRecordControl":
                 SetHonourContactLinksRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.HonourContactLinksRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetHonourContactLinksRecordControl_Base()           
        
        {        
            if (HonourContactLinksRecordControl.Visible)
            {
                HonourContactLinksRecordControl.LoadData();
                HonourContactLinksRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.HonourContactLinksRecordControl != null && this.HonourContactLinksRecordControl.DataSource != null)
                  {
                        id = this.HonourContactLinksRecordControl.DataSource.GetValue(this.HonourContactLinksRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.HonourContactLinksRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.HonourContactLinksRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.HonourContactLinksRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.HonourContactLinksRecordControl.DataSource.GetValue(this.HonourContactLinksRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
