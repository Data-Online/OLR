...
// This file implements the code-behind class for Edit_AvailableWorkshops_Table.aspx.
// Edit_AvailableWorkshops_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_AvailableWorkshops_Table
        : BaseApplicationPage
// Code-behind class for the Edit_AvailableWorkshops_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_AvailableWorkshops_Table()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Edit_AvailableWorkshops_Table.AvailableWorkshopsTableControl AvailableWorkshopsTableControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Edit} Available Workshops");
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Edit_AvailableWorkshops_Table.AvailableWorkshopsTableControl control = new OLR.UI.Controls.Edit_AvailableWorkshops_Table.AvailableWorkshopsTableControl();
