...
/// <see cref="PhotoClubContactLinksTable">OLR.PhotoClubContactLinksTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="PhotoClubContactLinksTable"></seealso>
public class PhotoClubContactLinksDefinition
{
#region "Definition (XML) for PhotoClubContactLinksDefinition table"
	//Next 191 lines contain Table Definition (XML) for table "PhotoClubContactLinksDefinition"
	...
	/// <see cref="PhotoClubContactLinksTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_PhotoClubContactLinks_Contacts</columnFKName>");
         ...
         tbf.Append(      @"<columnName>PhotoClubId</columnName>");
         tbf.Append(      @"<columnUIName>Photo Club</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_PhotoClubContactLinks_PhotoClubs</columnFKName>");
         tbf.Append(        @"<columnFKTable>OLR.Business.PhotoClubsTable, OLR.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>PhotoClubId</columnFKColumn>");
         ...
         tbf.Append(      @"<columnName>PhotoClubContactId</columnName>");
         tbf.Append(      @"<columnUIName>Photo Club Contact</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>PhotoClubContactLinks</TableName>");
         tbf.Append(  @"<Version>2</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>PhotoClubContactLinks_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>PhotoClubContactLinks</TableCodeName>");
         tbf.Append(  @"<FolderName>PhotoClubContactLinks</FolderName>");
         tbf.Append(  @"<MenuName>Photo Club Contact Links</MenuName>");
         tbf.Append(  @"<QSPath>../PhotoClubContactLinks/PhotoClubContactLinks-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOLRPhotoClubContactLinks</TableStoredProcPrefix>");
