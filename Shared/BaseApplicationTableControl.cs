...
#region "Section 1: Place your customizations here."
    ...
    public class BaseApplicationTableControl : BaseApplicationTableControlGEN
    {
...
#region "Section 2: Do not modify this section."
    public class BaseApplicationTableControlGEN : System.Web.UI.Control
    {

        public BaseApplicationTableControlGEN()
        {
            this.PreRender += new EventHandler(Control_ClearControls_PreRender);
            this.Unload += new EventHandler(Control_SaveControls_Unload);
			this.Load += new EventHandler(BaseLoad_Base);
        }
        ...
        public virtual bool AreAnyUrlParametersForMe(string url, string arg)
        {
            const string PREFIX_NO_ENCODE = "NoUrlEncode:";
        ...
        public virtual decimal Sum(string controlName)
        {
            return FormulaUtils.Sum(this as BaseApplicationTableControl, controlName);
        }
        ...
        /// <param name="controlName">The string name of the UI control (e.g., "UnitPrice") </param>
        /// <returns>The total of adding the value contained in each of the fields.</returns>
        public virtual decimal Total(string controlName)
        {
            return FormulaUtils.Total(this as BaseApplicationTableControl, controlName);
        }
        ...
        public virtual decimal Max(string controlName)
        {
            return FormulaUtils.Max(this as BaseApplicationTableControl, controlName);
        }        
        ...
        public virtual decimal Min(string controlName)
        {
            return FormulaUtils.Min(this as BaseApplicationTableControl, controlName);
        }        
        ...
        public virtual decimal Count(string controlName)
        {
            return FormulaUtils.Count(this as BaseApplicationTableControl, controlName);
        }
        ...
        /// <param name="controlName">The string name of the UI control (e.g., "UnitPrice") </param>
        /// <returns>The total number of rows in the table control.</returns>
        public virtual decimal CountA(string controlName)
        {
            return FormulaUtils.CountA(this as BaseApplicationTableControl, controlName);
        }
        ...
        /// <param name="controlName">The string name of the UI control (e.g., "UnitPrice") </param>
        /// <returns>The total number of rows in the table control.</returns>
        public virtual decimal Mean(string controlName)
        {
            return FormulaUtils.Mean(this as BaseApplicationTableControl, controlName);
        }
        ...
        /// <param name="controlName">The string name of the UI control (e.g., "UnitPrice") </param>
        /// <returns>The total number of rows in the table control.</returns>
        public virtual decimal Average(string controlName)
        {
            return FormulaUtils.Average(this as BaseApplicationTableControl, controlName);
        }
        ...
        /// <param name="controlName">The string name of the UI control (e.g., "UnitPrice") </param>
        /// <returns>The total number of rows in the table control.</returns>
        public virtual decimal Mode(string controlName)
        {
            return FormulaUtils.Mode(this as BaseApplicationTableControl, controlName);
        }
        ...
        /// <param name="controlName">The string name of the UI control (e.g., "UnitPrice") </param>
        /// <returns>The total number of rows in the table control.</returns>
        public virtual decimal Median(string controlName)
        {
            return FormulaUtils.Median(this as BaseApplicationTableControl, controlName);
        }
        ...
        protected virtual void BaseLoad_Base(object sender, System.EventArgs e)
        {
	        System.Web.UI.WebControls.HiddenField c = (System.Web.UI.WebControls.HiddenField)BaseClasses.Utils.MiscUtils.FindControlRecursively(this as BaseApplicationTableControl, this.ID + "_PostbackTracker");
	        if (c != null) {
        ...
        protected virtual void Postback(object sender, EventArgs e)
        {
