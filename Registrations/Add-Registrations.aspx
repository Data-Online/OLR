...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControlRecursively("SaveButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td>
                    <asp:panel id="RegistrationsRecordControlPanel" runat="server"><table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tableCellLabel"><asp:Literal runat="server" id="EventIdLabel" Text="Event">	</asp:Literal></td><td class="tableCellValue"><BaseClasses:QuickSelector runat="server" id="EventId" redirecturl=""></BaseClasses:QuickSelector> </td><td class="tableCellLabel" style="display:none"><table><tr><td class="tableCellLabel"><BaseClasses:QuickSelector runat="server" id="ContactId" redirecturl="" visible="False"></BaseClasses:QuickSelector></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue"> </td></tr><tr><td class="tableCellLabel"><asp:Literal runat="server" id="ValidationUidLabel" Text="Validation UID">	</asp:Literal></td><td class="tableCellValue"><asp:TextBox runat="server" id="ValidationUid" MaxLength="40" columns="50" cssclass="field_input" rows="2" textmode="MultiLine"></asp:TextBox>&nbsp;
