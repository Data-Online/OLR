...
// Edit_Registrations_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_Registrations_Table
{
...
// Base class for the RegistrationsTableControlRow control on the Edit_Registrations_Table page.
...
public class BaseRegistrationsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetEventId()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = RegistrationsTable.EventId.DefaultValue;
        ...
        public virtual void SetRegistrationTypeId()
        {
            ...
            // If selection was retrieved from UI previously, restore it
            if (this.PreviousUIData.ContainsKey(this.RegistrationTypeId.ID))
            {
                if (this.PreviousUIData[this.RegistrationTypeId.ID] == null)
                    selectedValue = null;
                else
                    selectedValue = this.PreviousUIData[this.RegistrationTypeId.ID].ToString();
            }
      ...
      // To customize, override this method in RegistrationsTableControlRow.
        ...
        RegistrationsTableControl tc= ((RegistrationsTableControl)MiscUtils.GetParentControlObject(this, "RegistrationsTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((RegistrationsTableControlRow)this);
                    }
                    this.Visible = false;
...
// Base class for the RegistrationsTableControl control on the Edit_Registrations_Table page.
    ...
    // Setup default pagination settings.
      ...
      RegistrationsRecord rec = new RegistrationsRecord();
                        ...
                        if (MiscUtils.IsValueSelected(recControl.ContactId)) {
                            rec.Parse(recControl.ContactId.SelectedItem.Value, RegistrationsTable.ContactId);
                        }
        ...
        protected virtual void Control_PreRender(object sender, System.EventArgs e)
        {
            ...
            {
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)this.FindControl("RegistrationsTableControlRepeater");
...
#region "Helper Functions"
        ...
        {
            int counter = 0;
            foreach (RegistrationsTableControlRow recControl in this.GetRecordControls())
            {
        ...
        {
        RegistrationsTableControlRow[] selectedList = this.GetSelectedRecordControls();
        ...
        public virtual RegistrationsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RegistrationsTableControlRow[])(selectedList.ToArray(Type.GetType("OLR.UI.Controls.Edit_Registrations_Table.RegistrationsTableControlRow")));
