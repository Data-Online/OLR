...
/// Provides access to the schema information and record data of a database table or view named DatabaseOLR_db%dbo.Users.
/// </summary>
/// <remarks>
...
public class BaseUsersTable : PrimaryKeyTable, IUserIdentityTable, IUserRoleTable
{
...
#region "IUserRoleTable Members"
	...
	public virtual BaseClasses.Data.BaseColumn UserRole
	{
		get
		{
			return (BaseClasses.Data.BaseColumn)this.TableDefinition.ColumnList[6];
		}
	}
...
#region "Properties for columns"
    ...
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Users_.LastLoginDate column object.
    /// </summary>
    public BaseClasses.Data.DateColumn LastLoginDateColumn
    {
        get
        {
    ...
    /// This is a convenience property that provides direct access to the table's Users_.LastLoginDate column object.
    /// </summary>
    public static BaseClasses.Data.DateColumn LastLoginDate
    {
        get
        {
            return UsersTable.Instance.LastLoginDateColumn;
        }
    }
    ...
    /// <summary>
    /// This is a convenience property that provides direct access to the table's Users_.ActiveEventId column object.
    /// </summary>
    public BaseClasses.Data.NumberColumn ActiveEventIdColumn
    {
        get
        {
    ...
    /// This is a convenience property that provides direct access to the table's Users_.ActiveEventId column object.
    /// </summary>
    public static BaseClasses.Data.NumberColumn ActiveEventId
    {
        get
        {
            return UsersTable.Instance.ActiveEventIdColumn;
        }
    }
...
#region "Shared helper methods"
    ...
    public static UsersRecord[] GetRecords(string where, OrderBy orderBy, int pageIndex, int pageSize)
    {
        ...
        return (UsersRecord[])recList.ToArray(Type.GetType("OLR.Business.UsersRecord"));
    }   
