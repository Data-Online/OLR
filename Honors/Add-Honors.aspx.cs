...
// This file implements the code-behind class for Add_Honors.aspx.
// Add_Honors.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_Honors
        : BaseApplicationPage
// Code-behind class for the Add_Honors page.
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetHonorsRecordControl()
        {
            SetHonorsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Add_Honors.HonorsRecordControl HonorsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Honors");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "HonorsRecordControl":
                 SetHonorsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.HonorsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetHonorsRecordControl_Base()           
        
        {        
            if (HonorsRecordControl.Visible)
            {
                HonorsRecordControl.LoadData();
                HonorsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.HonorsRecordControl != null && this.HonorsRecordControl.DataSource != null)
                  {
                        id = this.HonorsRecordControl.DataSource.GetValue(this.HonorsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.HonorsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.HonorsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.HonorsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.HonorsRecordControl.DataSource.GetValue(this.HonorsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
