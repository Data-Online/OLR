<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Show_Events_Gallery" Assembly="OLR" %>

<%@ Register Tagprefix="OLR" TagName="ThemeButtonWithArrow" Src="../Shared/ThemeButtonWithArrow.ascx" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-Events-Gallery.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OLR.UI.Show_Events_Gallery" %>
...
<BaseClasses:QuickSelector runat="server" id="EventNameFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="EventsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display:none" colspan="3"></th></tr><asp:Repeater runat="server" id="EventsTableControlRepeater">		<ITEMTEMPLATE>
...
<td class="galleryttc" style="width:33%;"><asp:LinkButton runat="server" id="EventName" causesvalidation="False" commandname="Redirect"></asp:LinkButton> <br />
</td></OLR:EventsTableControlRow>
</ITEMTEMPLATE>
