...
// This file implements the code-behind class for Show_View_Stats_Table.aspx.
// Show_View_Stats_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Show_View_Stats_Table
        : BaseApplicationPage
// Code-behind class for the Show_View_Stats_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Show_View_Stats_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetView_StatsTableControl()
        {
            SetView_StatsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Show_View_Stats_Table.View_StatsTableControl View_StatsTableControl;
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        {        
            if (View_StatsTableControl.Visible)
            {
                View_StatsTableControl.LoadData();
                View_StatsTableControl.DataBind();
            }
        }
