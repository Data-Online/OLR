...
// Show_FieldTrips_Table2.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_FieldTrips_Table2
{
...
// Base class for the FieldTripsTableControlRow control on the Show_FieldTrips_Table2 page.
...
// Base class for the FieldTripsTableControl control on the Show_FieldTrips_Table2 page.
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      foreach(BaseColumn col in cols)
      {
          ...
          search.iOR(col, BaseFilter.ComparisonOperator.Contains, MiscUtils.GetSelectedValue(this.SearchText, this.GetFromSession(this.SearchText)), true, false);
            ...
            if (MiscUtils.IsValueSelected(this.DescriptionFilter) || this.InSession(this.DescriptionFilter)){
      ...
      FieldTripsRecord rec = new FieldTripsRecord();
        ...
        public virtual void SetDescriptionFilter()
        {
            ...
            this.PopulateDescriptionFilter(MiscUtils.GetSelectedValueList(this.DescriptionFilter, DescriptionFilterselectedFilterItemList), 500);
              ...
              url += "?Target=" + this.DescriptionFilter.ClientID + "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("Description")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldFilterMultiSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
                    ...
                    
        {
            ...
            if (this.DescriptionFilter.Items.Count == 0)
                this.DescriptionFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:PleaseSelect", "OLR"), "--PLEASE_SELECT--"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTrips-Table2.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTrips";
                // If Show-FieldTrips-Table2.PDFButton.report specifies a valid report template,
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTrips-Table2.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTrips";
                // If Show-FieldTrips-Table2.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual FieldTripsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Table2.FieldTripsTableControlRow")));
