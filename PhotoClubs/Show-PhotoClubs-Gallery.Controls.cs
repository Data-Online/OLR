...
// Show_PhotoClubs_Gallery.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_PhotoClubs_Gallery
{
...
public class PhotoClubsTableControlRow : BasePhotoClubsTableControlRow
{
      
        // The BasePhotoClubsTableControlRow implements code for a ROW within the
        // the PhotoClubsTableControl table.  The BasePhotoClubsTableControlRow implements the DataBind and SaveData methods.
        // The loading of data is actually performed by the LoadData method in the base class of PhotoClubsTableControl.
...
public class PhotoClubsTableControl : BasePhotoClubsTableControl
{
    // The BasePhotoClubsTableControl class implements the LoadData, DataBind, CreateWhereClause
    // and other methods to load and display the data in a table control.

    // This is the ideal place to add your code customizations. You can override the LoadData and CreateWhereClause,
    // The PhotoClubsTableControlRow class offers another place where you can customize
...
// Base class for the PhotoClubsTableControlRow control on the Show_PhotoClubs_Gallery page.
// Do not modify this class. Instead override any method in PhotoClubsTableControlRow.
public class BasePhotoClubsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        public BasePhotoClubsTableControlRow()
        {
        ...
        // To customize, override this method in PhotoClubsTableControlRow.
        ...
        {
            // Load the data from the database into the DataSource DatabaseOLR_db%dbo.PhotoClubs record.
            ...
            if (this.RecordUniqueId != null && this.RecordUniqueId.Length > 0) {
                ...
                this.DataSource = PhotoClubsTable.GetRecord(this.RecordUniqueId, true);
              
                return;
            }
      
            // Since this is a row in the table, the data for this row is loaded by the 
            // LoadData method of the BasePhotoClubsTableControl when the data for the entire
            // table is loaded.
            
            this.DataSource = new PhotoClubsRecord();
        ...
        public virtual void SetDescription()
        {
            ...
            // DatabaseOLR_db%dbo.PhotoClubs database record.

            // this.DataSource is the DatabaseOLR_db%dbo.PhotoClubs record retrieved from the database.
            ...
            if (this.DataSource != null && this.DataSource.DescriptionSpecified) {
               ...
               string formattedValue = this.DataSource.Format(PhotoClubsTable.Description);
              ...
              this.Description.Text = PhotoClubsTable.Description.Format(PhotoClubsTable.Description.DefaultValue);
        ...
        public virtual void SaveData()
        {
            ...
            if (this.DataSource.IsAnyValueChanged) {
                ...
                ((PhotoClubsTableControl)MiscUtils.GetParentControlObject(this, "PhotoClubsTableControl")).DataChanged = true;
                ((PhotoClubsTableControl)MiscUtils.GetParentControlObject(this, "PhotoClubsTableControl")).ResetData = true;
            }
      ...
      // To customize, override this method in PhotoClubsTableControlRow.
         ...
         
        {
            ...
            bool hasFiltersPhotoClubsTableControl = false;
            hasFiltersPhotoClubsTableControl = hasFiltersPhotoClubsTableControl && false; // suppress warning
        ...
        public virtual void Delete()
        {
          ...
          PhotoClubsTable.DeleteRecord(pkValue);
        ...
        public virtual void Description_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../PhotoClubs/Show-PhotoClubs.aspx?PhotoClubs={PK}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BasePhotoClubsTableControlRow_Rec"];
            }
            set {
                this.ViewState["BasePhotoClubsTableControlRow_Rec"] = value;
            }
        }
        
        public PhotoClubsRecord DataSource {
            get {
                return (PhotoClubsRecord)(this._DataSource);
            }
            set {
...
#region "Helper Properties"
    ...
    PhotoClubsRecord rec = null;
        ...
        public virtual PhotoClubsRecord GetRecord()
             
        {
            ...
            if (this.DataSource != null) {
              ...
              if (this.RecordUniqueId != null) {
                ...
                return PhotoClubsTable.GetRecord(this.RecordUniqueId, true);
...
// Base class for the PhotoClubsTableControl control on the Show_PhotoClubs_Gallery page.
// Do not modify this class. Instead override any method in PhotoClubsTableControl.
public class BasePhotoClubsTableControl : OLR.UI.BaseApplicationTableControl
{
         
       public BasePhotoClubsTableControl()
        {
            this.Init += Control_Init;
            this.Load += Control_Load;
            this.PreRender += Control_PreRender;
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
        ...
        public virtual void LoadData()
        {
            ...
            try {
                  ...
                  if (wc != null && !wc.RunQuery) {
                      ...
                      Type myrec = typeof(OLR.Business.PhotoClubsRecord);
                      this.DataSource = (PhotoClubsRecord[])(alist.ToArray(myrec));
                ...
                if (this.AddNewRecord > 0) {
                    ...
                    foreach (PhotoClubsTableControlRow rc in this.GetRecordControls()) {
                        if (!rc.IsNewRecord) {
                    ...
                    Type myrec = typeof(OLR.Business.PhotoClubsRecord);
                    this.DataSource = (PhotoClubsRecord[])(postdata.ToArray(myrec));
                } 
                else {
        ...
        public virtual PhotoClubsRecord[] GetRecords(BaseFilter join, WhereClause where, OrderBy orderBy, int pageIndex, int pageSize)
        {    
            ...
            // selCols.Add(PhotoClubsTable.Column1, true);          
            // selCols.Add(PhotoClubsTable.Column2, true);          
            // selCols.Add(PhotoClubsTable.Column3, true);          
                  ...
                  
            {
                ...
                return PhotoClubsTable.GetRecords(join, where, orderBy, this.PageIndex, (this.PageSize * this.VerticalColumns));
                 
            }
            else
            {
                PhotoClubsTable databaseTable = new PhotoClubsTable();
                ...
                return (recList.ToArray(typeof(PhotoClubsRecord)) as PhotoClubsRecord[]);
            }            
        ...
        public virtual int GetRecordCount(BaseFilter join, WhereClause where)
        {
            ...
            if (selCols.Count == 0)                 
                ...
                return PhotoClubsTable.GetRecordCount(join, where);
            else
            {
                PhotoClubsTable databaseTable = new PhotoClubsTable();
                databaseTable.SelectedColumns.Clear();
      ...
      public virtual PhotoClubsRecord[] CopyArray(int index, PhotoClubsRecord[,] recs, int columns)
      {
        PhotoClubsRecord[] recsCopy = new PhotoClubsRecord[columns];
      ...
      public override void DataBind()
      {
          ...
          //  LoadData for DataSource for chart and report if they exist
            ...
            PhotoClubsRecord[,] recs = new PhotoClubsRecord[Convert.ToInt32(rows - 1) + 1, this.VerticalColumns];
            ...
            PhotoClubsRecord[] HColDataSource = new PhotoClubsRecord[Convert.ToInt32(rows)];

            // Bind the repeater with the list of records to expand the UI.
            
            System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhotoClubsTableControlRepeater");
            if (rep == null) return;
            ...
            System.Web.UI.WebControls.Repeater rep1 = (System.Web.UI.WebControls.Repeater)BaseClasses.Utils.MiscUtils.FindControlRecursively(rep.Items[PageIndex], "PhotoClubsTableControlRepeater1");
            ...
            foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep1.Items)
            {
              ...
              PhotoClubsRecord[] VColDataSource = new PhotoClubsRecord[this.VerticalColumns];

              System.Web.UI.WebControls.Repeater repControl = (System.Web.UI.WebControls.Repeater)repItem.FindControl("PhotoClubsTableControlCellRepeater");
              if (repControl == null)
                  break;
              repControl.DataSource = VColDataSource;
              repControl.DataBind();

              PhotoClubsRecord[] recsCopy = CopyArray(index, recs, this.VerticalColumns);
              int indexInnerRep = 0;
              foreach (System.Web.UI.WebControls.RepeaterItem innerRepItem in repControl.Items) {
                PhotoClubsTableControlRow recControl = (PhotoClubsTableControlRow)innerRepItem.FindControl("PhotoClubsTableControlRow");
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        protected virtual void BindPaginationControls()
        {
            ...
            // Bind the buttons for PhotoClubsTableControl pagination.
        ...
        public virtual void SaveData()
        {
            ...
            foreach (PhotoClubsTableControlRow recCtl in this.GetRecordControls())
            {
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            PhotoClubsTable.Instance.InnerFilter = null;
            ...
            if (MiscUtils.IsValueSelected(this.DescriptionFilter)) {
                ...
                foreach (ListItem item in this.DescriptionFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(PhotoClubsTable.Description, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      cols.Add(PhotoClubsTable.Description, true);
      ...
      String DescriptionFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "DescriptionFilter_Ajax"];
        ...
        if (DescriptionFilterSelectedValue != null){
                        ...
                        foreach (string item in DescriptionFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(PhotoClubsTable.Description, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      foreach(BaseColumn col in cols)
      {
        ...
        public virtual string[] GetAutoCompletionList_SearchText(String prefixText,int count)
        {
            ...
            if(count==0) count = 10;
            OLR.Business.PhotoClubsRecord[] recordList  = PhotoClubsTable.GetRecords(filterJoin, wc, null, 0, count, ref count);
            String resultItem = "";
            if (resultItem == "") resultItem = "";
            foreach (PhotoClubsRecord rec in recordList ){
                ...
                resultItem = rec.Format(PhotoClubsTable.Description);
  
                if (resultItem != null) {
                    string prText = prefixText;
                    if(PhotoClubsTable.Description.IsFullTextSearchable) {
                        FullTextExpression ft = new FullTextExpression();
                        prText = ft.GetFirstNonExcludedTerm(prText);
                    }
                    if (!string.IsNullOrEmpty(prText) && resultItem.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture).Contains(prText.ToUpper(System.Threading.Thread.CurrentThread.CurrentCulture))) {
                        bool isAdded = FormatSuggestions(prText, resultItem, 50, "InMiddleOfMatchedString", "WordsStartingWithSearchString", "[^a-zA-Z0-9]", resultList, PhotoClubsTable.Description.IsFullTextSearchable);
                        if (isAdded) {
                            continue;
                        }
                    }
        ...
        protected virtual void AddNewRecords()
        {
            ...
            if (!this.ResetData)
            {
              System.Web.UI.WebControls.Repeater rep = (System.Web.UI.WebControls.Repeater)(BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PhotoClubsTableControlRepeater"));
              if (rep == null){return;}
              PhotoClubsTableControlRow[] recControls = this.GetRecordControls();
                foreach (PhotoClubsTableControlRow recControl in recControls) 
		{
              
                // Loop through all rows in the table, set its DataSource and call DataBind().
                
                    if (recControl.Visible && recControl.IsNewRecord) {
      PhotoClubsRecord rec = new PhotoClubsRecord();
        
                        if (recControl.Description.Text != "") {
                            rec.Parse(recControl.Description.Text, PhotoClubsTable.Description);
                  }
            ...
            for (int count = 1; count <= this.AddNewRecord; count++) {
                ...
                newRecordList.Insert(0, new PhotoClubsRecord());
            ...
            if (newRecordList.Count > 0) {
                ...
                Type myrec = typeof(OLR.Business.PhotoClubsRecord);
                this.DataSource = (PhotoClubsRecord[])(finalList.ToArray(myrec));
        ...
        public void AddToDeletedRecordIds(PhotoClubsTableControlRow rec)
        {
            if (rec.IsNewRecord) {
                return;
            }
        ...
        protected virtual bool InDeletedRecordIds(PhotoClubsTableControlRow rec)            
        {
            if (this.DeletedRecordIds == null || this.DeletedRecordIds.Length == 0) {
                return (false);
            }
        ...
        public virtual void SetDescriptionFilter()
        {
            ...
            this.PopulateDescriptionFilter(MiscUtils.GetSelectedValueList(this.DescriptionFilter, DescriptionFilterselectedFilterItemList), 500);
              ...
              string url = this.ModifyRedirectUrl("../PhotoClubs/PhotoClubs-QuickSelector.aspx", "", true);
                    ...
                    
        {
            ...
            orderBy.Add(PhotoClubsTable.Description, OrderByItem.OrderDir.Asc);                
            ...
            if (wc.RunQuery)
            {
                ...
                values = PhotoClubsTable.GetValues(PhotoClubsTable.Description, wc, orderBy, maxItems);
            ...
            string fvalue;
            if ( PhotoClubsTable.Description.IsColumnValueTypeBoolean()) {
                    fvalue = cvalue;
                }else {
                    fvalue = PhotoClubsTable.Description.Format(cvalue);
                }
                if (fvalue == null) {
                    fvalue = "";
                }
        ...
        public virtual WhereClause CreateWhereClause_DescriptionFilter()
        {
            ...
            else            
            {
                foreach (string item in DescriptionFilterselectedFilterItemList)
                {
                    ...
                    wc.iOR(PhotoClubsTable.Description, BaseFilter.ComparisonOperator.EqualsTo, item);
    ...
    this.RemoveFromSession(this, "Page_Size");
      ...
      this.RemoveFromSession(this, "Vertical_Columns");
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            string orderByStr = (string)ViewState["PhotoClubsTableControl_OrderBy"];
        ...
        {            
            ...
            if (this.CurrentSortOrder != null) {
                this.ViewState["PhotoClubsTableControl_OrderBy"] = this.CurrentSortOrder.ToXmlString();
            }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
      ...
      this.ViewState["Vertical_Columns"] = this.VerticalColumns;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=PhotoClubs" ;
              ...
              
        {
              ...
              try
              {
                    string url = "../PhotoClubs/Add-PhotoClubs.aspx?TabVisible=False&SaveAndNewVisible=False";
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "PhotoClubsTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage(document.getElementById('" + MiscUtils.FindControlRecursively(this, "PhotoClubsTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = PhotoClubsTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             PhotoClubsTable.Description,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(PhotoClubsTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(PhotoClubsTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(PhotoClubsTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(PhotoClubsTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(PhotoClubsTable.Description, "Default"));
              ...
              {
                val = PhotoClubsTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-PhotoClubs-Gallery.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PhotoClubs";
                // If Show-PhotoClubs-Gallery.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(PhotoClubsTable.Description.Name, ReportEnum.Align.Left, "${Description}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = PhotoClubsTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = PhotoClubsTable.GetRecordCount(joinFilter,whereClause);
                PhotoClubsRecord[] records = null;
                
                do
                {
                    
                    records = PhotoClubsTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( PhotoClubsRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                                 report.AddData("${Description}", record.Format(PhotoClubsTable.Description), ReportEnum.Align.Left);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-PhotoClubs-Gallery.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "PhotoClubs";
                // If Show-PhotoClubs-Gallery.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void SortControl_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in PhotoClubsTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(PhotoClubsTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (PhotoClubsTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && PhotoClubsTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(PhotoClubsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(PhotoClubsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
        ...
        public int TotalRecords 
        {
            get {
                if (_TotalRecords < 0)
                {
                    _TotalRecords = PhotoClubsTable.GetRecordCount(CreateCompoundJoinFilter(), CreateWhereClause());
                }
        ...
        public  PhotoClubsRecord[] DataSource {
            ...
            get {
                return (PhotoClubsRecord[])(base._DataSource);
            }
            set {
                this._DataSource = value;
            }
...
#region "Helper Functions"
        ...
        public override string EvaluateExpressions(string url, string arg, bool bEncrypt)
        {
            ...
            if (needToProcess) {
                PhotoClubsTableControlRow recCtl = this.GetSelectedRecordControl();
        ...
        public virtual PhotoClubsTableControlRow GetSelectedRecordControl()
        {
        ...
        public virtual PhotoClubsTableControlRow[] GetSelectedRecordControls()
        {
        
            return (PhotoClubsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_PhotoClubs_Gallery.PhotoClubsTableControlRow")));
          
        }

        public virtual void DeleteSelectedRecords(bool deferDeletion)
        {
            PhotoClubsTableControlRow[] recordList = this.GetSelectedRecordControls();
            if (recordList.Length == 0) {
                // Localization.
                throw new Exception(Page.GetResourceValue("Err:NoRecSelected", "OLR"));
            }
            
            foreach (PhotoClubsTableControlRow recCtl in recordList)
            {
                if (deferDeletion) {
        ...
        public virtual PhotoClubsTableControlRow[] GetRecordControls()
        {
            Control[] recCtrls = BaseClasses.Utils.MiscUtils.FindControlsRecursively(this, "PhotoClubsTableControlRow");
	          List<PhotoClubsTableControlRow> list = new List<PhotoClubsTableControlRow>();
	          foreach (PhotoClubsTableControlRow recCtrl in recCtrls) {
		          list.Add(recCtrl);
	          }
	          return list.ToArray();
        }
