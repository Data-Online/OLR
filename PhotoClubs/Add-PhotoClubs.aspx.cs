...
// This file implements the code-behind class for Add_PhotoClubs.aspx.
// Add_PhotoClubs.Controls.vb contains the Table, Row and Record control classes
...
public partial class Add_PhotoClubs
        : BaseApplicationPage
// Code-behind class for the Add_PhotoClubs page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Add_PhotoClubs()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetPhotoClubsRecordControl()
        {
            SetPhotoClubsRecordControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Add_PhotoClubs.PhotoClubsRecordControl PhotoClubsRecordControl;
    ...
    this.LoadData();
            ...
            Page.Title = ExpandResourceValue("{Title:Add} Photo Clubs");
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "PhotoClubsRecordControl":
                 SetPhotoClubsRecordControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.PhotoClubsRecordControl.SaveData();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPhotoClubsRecordControl_Base()           
        
        {        
            if (PhotoClubsRecordControl.Visible)
            {
                PhotoClubsRecordControl.LoadData();
                PhotoClubsRecordControl.DataBind();
            }
        }
        ...
        if (target == null) target = ""; // avoid warning on VS
          ...
          this.CommitTransaction(sender);
            ...
            if (!string.IsNullOrEmpty(target) && !string.IsNullOrEmpty(field))
            {
                  ...
                  if (this.PhotoClubsRecordControl != null && this.PhotoClubsRecordControl.DataSource != null)
                  {
                        id = this.PhotoClubsRecordControl.DataSource.GetValue(this.PhotoClubsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(field)).ToString();
                        if (!string.IsNullOrEmpty(formula))
                        {
                            System.Collections.Generic.IDictionary<String, Object> variables = new System.Collections.Generic.Dictionary<String, Object>();
                            variables.Add(this.PhotoClubsRecordControl.DataSource.TableAccess.TableDefinition.TableCodeName, this.PhotoClubsRecordControl.DataSource);
                            value = EvaluateFormula(formula, this.PhotoClubsRecordControl.DataSource, null,variables);
                        }
                        ...
                        {
                            value = this.PhotoClubsRecordControl.DataSource.GetValue(this.PhotoClubsRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(displayFieldName)).ToString();
                        }
                  }
                  if (value == null)
                      value = id;
