...
// Email_Contacts.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Email_Contacts
{
...
// Base class for the ContactsRecordControl control on the Email_Contacts page.
...
public class BaseContactsRecordControl : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in ContactsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Email-Contacts"] = recId;
