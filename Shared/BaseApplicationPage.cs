...
#region "Section 1: Place your customizations here."
    ...
    public class BaseApplicationPage : BaseApplicationPageGEN
    {
...
#region "Section 2: Do not modify this section."
    public class BaseApplicationPageGEN : BaseClasses.Web.UI.BasePage
    {
        public BaseApplicationPageGEN()
        {
            this.Load += new EventHandler(Page_Load_GEN);
            this.PreRender += new EventHandler(Control_ClearControls_PreRender);
            this.Unload += new EventHandler(Page_SaveControls_Unload);
            base.PreInit += new EventHandler(Page_PreInit_GEN);
        ...
        protected virtual void Page_Load_GEN(object sender, System.EventArgs e)
        {
        ...
        protected virtual void Page_PreInit_GEN(object sender, System.EventArgs e)
        {
              ...
              if ( StringUtils.InvariantUCase(deviceSize).Equals(StringUtils.InvariantUCase("Small")) ) {
                  this.Page.Theme = this.Page.Theme + " Mobile";
              }
        }
       ...
       private const string SCRIPT_DOFOCUS = "" + "<script language=\"javascript\" type=\"text/javascript\">" + 
        ...
        public virtual void LoadFocusScripts(Control CurrentControl)
        {
        ...
        public virtual string GetSelectedTheme()
        {
         ...
         protected virtual void IncludeLegacyJavaScript(Object sender , EventArgs e){
        ...
        public virtual string GetSelectedLanguage()
        {
        ...
        protected virtual void GetAllRecordAndTableControls(Control ctl, ArrayList controlList, bool withParents)
        {
	        if (ctl == null) {
		        return;
	        }
        ...
        protected ArrayList GetAllRecordAndTableControls()
        {
            ArrayList controlList = new ArrayList();
        ...
        public virtual string ExpandResourceValue(string keyVal)
        {
        ...
        public virtual bool ShouldSaveControlsToSession
        {
            get
            {
        ...
        protected virtual void Page_SaveControls_Unload(object sender, EventArgs e)
        {
...
#region Methods to encrypt and decrypt URL parameters
        ...
        public virtual string EncryptUrlParameter(string url)
        {
            if (url == null)
            {
                return "";
...
#region Chart control initialization
        ...
        public virtual string GetImageWithOverlaidText(string imgFieldName, PrimaryKeyRecord dataSource, object otherFieldName, string redirectURL) {
        ...
        // </summary>
        // <returns>ExportFieldValue URL for the Image with the Background styles</returns>
        public virtual string GetImageWithOverlaidText(string imgFieldName, KeylessRecord dataSource, object otherFieldName, string redirectURL) {
            if (dataSource == null) return ""; 
        ...
        // </summary>
        // <returns>ExportFieldValue URL for the Image with the Background styles</returns>   
        public virtual string GetImageWithOverlaidText(string imgURL, object otherFieldName, string redirectURL) {
            string fieldValue = "";
