...
#region "Section 2: Do not modify this section."
    ...
    this.LoadData();
      ...
      protected virtual void UserStatusInit() {
        ...
        case null:
        case "":
          this.UserStatusLbl.Text = GetResourceValue("Txt:UserNotSignedIn", "OLR");
        break;
        default:
          this.UserStatusLbl.Text = GetResourceValue("Txt:Hello", "OLR");
      ...
      protected virtual void SignInButtonInit(){
        ...
        switch (((BaseApplicationPage)(this.Page)).CurrentSecurity.GetUserStatus()) {
          ...
          case "":
              ...
              this.SignIn.Text = GetResourceValue("Txt:SignIn", "OLR");
              this.SignIn.ToolTip = GetResourceValue("Txt:SignIn", "OLR");
              
            break;
          default:
          
            this.SignIn.Text = GetResourceValue("Txt:SignOut", "OLR");
            this.SignIn.ToolTip = GetResourceValue("Txt:SignOut", "OLR");
