...
// This file implements the code-behind class for Edit_Honors_Table.aspx.
// Edit_Honors_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_Honors_Table
        : BaseApplicationPage
// Code-behind class for the Edit_Honors_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_Honors_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetHonorsTableControl()
        {
            SetHonorsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Edit_Honors_Table.HonorsTableControl HonorsTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "HonorsTableControl":
                 SetHonorsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.HonorsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Edit_Honors_Table.HonorsTableControl control = new OLR.UI.Controls.Edit_Honors_Table.HonorsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetHonorsTableControl_Base()           
        
        {        
            if (HonorsTableControl.Visible)
            {
                HonorsTableControl.LoadData();
                HonorsTableControl.DataBind();
            }
        }
