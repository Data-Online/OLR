...
// This file implements the code-behind class for Edit_PhotoClubs_Table.aspx.
// Edit_PhotoClubs_Table.Controls.vb contains the Table, Row and Record control classes
...
public partial class Edit_PhotoClubs_Table
        : BaseApplicationPage
// Code-behind class for the Edit_PhotoClubs_Table page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public Edit_PhotoClubs_Table()
        {
            this.Initialize();
...
#region "Ajax Functions"
      ...
      // Page Event Handlers - buttons, sort, links
        ...
        public void SetPhotoClubsTableControl()
        {
            SetPhotoClubsTableControl_Base(); 
        }
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.Edit_PhotoClubs_Table.PhotoClubsTableControl PhotoClubsTableControl;
    ...
    this.LoadData();
      ...
      public void SetControl_Base(string control)
      {
          ...
          switch (control)
          {
              ...
              case "PhotoClubsTableControl":
                 SetPhotoClubsTableControl();
                 break;
      ...
      public void SaveData_Base()
      {
        ...
        this.PhotoClubsTableControl.SaveData();
    ...
    public static string[] GetAutoCompletionList_SearchText_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.Edit_PhotoClubs_Table.PhotoClubsTableControl control = new OLR.UI.Controls.Edit_PhotoClubs_Table.PhotoClubsTableControl();
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void SetPhotoClubsTableControl_Base()           
        
        {        
            if (PhotoClubsTableControl.Visible)
            {
                PhotoClubsTableControl.LoadData();
                PhotoClubsTableControl.DataBind();
            }
        }
