...
namespace OLR.UI.Controls.Show_Contacts_Table
{
...
public class BaseContactsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetRegistrationsTableControl()           
        ...
        public virtual void SaveData()
        {
          ...
          RegistrationsTableControl recRegistrationsTableControl = (RegistrationsTableControl)(MiscUtils.FindControlRecursively(this, "RegistrationsTableControl"));
        recRegistrationsTableControl.SaveData();
      ...
      this.Page.CommitTransaction(sender);
        ...
        public virtual void EditRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            string url = @"../Contacts/Edit-Contacts.aspx?Contacts={PK}";
...
#region "Helper Properties"
        ...
        public RegistrationsTableControl RegistrationsTableControl {
            get {
                return (RegistrationsTableControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegistrationsTableControl");
            }
        }
      ...
      ContactsRecord rec = new ContactsRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Email {Txt:Ascending}"), "Email Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Email {Txt:Descending}"), "Email Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Hometown {Txt:Ascending}"), "HometownId Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Hometown {Txt:Descending}"), "HometownId Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Mobile Number {Txt:Ascending}"), "MobileNumber Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("Mobile Number {Txt:Descending}"), "MobileNumber Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("PSNZ Member {Txt:Ascending}"), "PSNZMember Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("PSNZ Member {Txt:Descending}"), "PSNZMember Desc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("PSNZ Membership Check {Txt:Ascending}"), "PSNZMembershipCheck Asc"));
              
                this.SortControl.Items.Add(new ListItem(this.Page.ExpandResourceValue("PSNZ Membership Check {Txt:Descending}"), "PSNZMembershipCheck Desc"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             ContactsTable.HometownId,
             ContactsTable.MobileNumber,
             ...
             data.ColumnList.Add(new ExcelColumn(ContactsTable.HometownId, "Default"));
             data.ColumnList.Add(new ExcelColumn(ContactsTable.MobileNumber, "Standard"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Contacts-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If Show-Contacts-Table.PDFButton.report specifies a valid report template,
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${Address2}", record.Format(ContactsTable.Address2), ReportEnum.Align.Left, 300);
                             report.AddData("${Address3}", record.Format(ContactsTable.Address3), ReportEnum.Align.Left, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.HometownId)){
                                 report.AddData("${HometownId}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = ContactsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(ContactsTable.HometownId);
                                 _DFKA = ContactsTable.GetDFKA(record.HometownId.ToString(), ContactsTable.HometownId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  ContactsTable.HometownId.IsApplyDisplayAs){
                                     report.AddData("${HometownId}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${HometownId}", record.Format(ContactsTable.HometownId), ReportEnum.Align.Left, 300);
                                 }
                             }
                             report.AddData("${MobileNumber}", record.Format(ContactsTable.MobileNumber), ReportEnum.Align.Right, 300);
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-Contacts-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "Contacts";
                // If Show-Contacts-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual ContactsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (ContactsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Contacts_Table.ContactsTableControlRow")));
...
// Base class for the RegistrationsTableControlRow control on the Show_Contacts_Table page.
...
// Base class for the RegistrationsTableControl control on the Show_Contacts_Table page.
    ...
    public virtual void AddWarningMessageOnClick() {
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
        ...
        ContactsTableControlRow contactsTableControlObjRow = (MiscUtils.GetParentControlObject(this, "ContactsTableControlRow") as ContactsTableControlRow);
              ...
              {
              wc.iAND(RegistrationsTable.ContactId, BaseFilter.ComparisonOperator.EqualsTo, contactsTableControlObjRow.GetRecord().ContactId.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      string selectedRecordInContactsTableControl = HttpContext.Current.Session["RegistrationsTableControlWhereClause"] as string;
      ...
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(RegistrationsTable.ContactId))
      {
      wc.iAND(RegistrationsTable.ContactId, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(RegistrationsTable.ContactId).ToString());
      }
...
#region "Helper Functions"
        ...
        public virtual RegistrationsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RegistrationsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_Contacts_Table.RegistrationsTableControlRow")));
