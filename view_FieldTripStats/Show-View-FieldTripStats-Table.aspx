...
<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Show_View_FieldTripStats_Table" Assembly="OLR" %>

<%@ Register Tagprefix="OLR" TagName="ThemeButton" Src="../Shared/ThemeButton.ascx" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Show-View-FieldTripStats-Table.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/HorizontalMenu.master" Inherits="OLR.UI.Show_View_FieldTripStats_Table" %>
		...
		<asp:UpdatePanel runat="server" id="UpdatePanel1" UpdateMode="Conditional">
			<ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="updatePanelContent"><tr><td>
                        <OLR:View_FieldTripStatsTableControl runat="server" id="View_FieldTripStatsTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td class="panelTL"><img src="../Images/space.gif" class="panelTLSpace" alt="" /></td><td class="panelT"></td><td class="panelTR"><img src="../Images/space.gif" class="panelTRSpace" alt="" /></td></tr><tr><td class="panelHeaderL"></td><td class="dh">
                  <table cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="dhel"><img src="../Images/space.gif" alt="" /></td><td class="dhb"><table cellpadding="0" cellspacing="0" border="0"><tr><td class="dht" valign="middle">
                        <asp:Literal runat="server" id="Title0" Text="&lt;%#String.Concat(&quot;Field Trip Stats&quot;) %>">	</asp:Literal>
                      </td></tr></table>
...
<BaseClasses:QuickSelector runat="server" id="FieldTripIdFilter" onkeypress="dropDownListTypeAhead(this,false)" redirecturl="" selectionmode="Single">	</BaseClasses:QuickSelector><%= SystemUtils.GenerateEnterKeyCaptureEndTag(FindControlRecursively("FilterButton"))%>
                  ...
                  <asp:panel id="CollapsibleRegion" runat="server"><table class="dBody" cellpadding="0" cellspacing="0" border="0" width="100%"><tr><td class="tre">
                    <table id="View_FieldTripStatsTableControlGrid" cellpadding="0" cellspacing="0" border="0" width="100%" onkeydown="captureUpDownKey(this, event)"><tr class="tch"><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th><th class="thc" style="display: none"></th></tr><asp:Repeater runat="server" id="View_FieldTripStatsTableControlRepeater">		<ITEMTEMPLATE>		<OLR:View_FieldTripStatsTableControlRow runat="server" id="View_FieldTripStatsTableControlRow">
<tr><td class="largeText" colspan="4"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="FieldTripId"></asp:Literal></span>
</td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Label runat="server" id="Label1" Text="Field Trip">	</asp:Label></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"><asp:Label runat="server" id="Label" Text="Totals so far">	</asp:Label></td><td class="tableCellValue"><span style="white-space:nowrap;">
...
</td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableCellLabel"></td><td class="tableCellValue" colspan="3"><OLR:FieldTripOptionsTableControl runat="server" id="FieldTripOptionsTableControl">	<table class="dv" cellpadding="0" cellspacing="0" border="0"><tr><td></td><td></td><td></td></tr><tr><td></td><td>
...
</td><td class="tableCellValue"><asp:Literal runat="server" id="Description"></asp:Literal> </td><td class="tableCellLabel"><asp:Literal runat="server" id="PlacesAvailableLabel" Text="Places Available">	</asp:Literal> 
</td><td class="tableCellValue"><span style="white-space:nowrap;">
<asp:Literal runat="server" id="PlacesAvailable"></asp:Literal></span>
 </td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="6"></td></tr></OLR:FieldTripOptionsTableControlRow>
</ITEMTEMPLATE>
...
</td><td class="tableCellLabel"></td><td class="tableCellValue"></td></tr><tr><td class="tableRowDivider" colspan="6"></td></tr></OLR:View_FieldTripStatsTableControlRow>
</ITEMTEMPLATE>
	...
	<asp:hiddenfield id="View_FieldTripStatsTableControl_PostbackTracker" runat="server" />
</OLR:View_FieldTripStatsTableControl>
