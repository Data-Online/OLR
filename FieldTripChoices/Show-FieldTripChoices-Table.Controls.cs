...
// Show_FieldTripChoices_Table.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_FieldTripChoices_Table
{
...
// Base class for the FieldTripChoicesTableControlRow control on the Show_FieldTripChoices_Table page.
...
public class BaseFieldTripChoicesTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        {      
              ...
              // Register the event handlers.
                    ...
                    this.FieldTripId.Click += FieldTripId_Click;
                        
                    this.FieldTripOptionId.Click += FieldTripOptionId_Click;
                        
                    this.FieldTripOptionId2.Click += FieldTripOptionId2_Click;
                        
                    this.FieldTripOptionId3.Click += FieldTripOptionId3_Click;
        ...
        public override void DataBind()
        {
            ...
            // Call the Set methods for each controls on the panel
                ...
                SetFieldTripChoicesTabContainer();
                SetFieldTripId();
                SetFieldTripIdLabel();
        ...
        public virtual void SetFieldTripId()
        {
            ...
            // this.DataSource is the DatabaseOLR_db%dbo.FieldTripChoices record retrieved from the database.
            // this.FieldTripId is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.FieldTripIdSpecified) {
               ...
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                ...
                this.FieldTripId.Text = formattedValue;
                  ...
                  this.FieldTripId.ToolTip = "Go to " + this.FieldTripId.Text.Replace("<wbr/>", "");
              ...
              this.FieldTripId.Text = FieldTripChoicesTable.FieldTripId.Format(FieldTripChoicesTable.FieldTripId.DefaultValue);
        ...
        public virtual void SetFieldTripOptionId()
        {
            ...
            // this.DataSource is the DatabaseOLR_db%dbo.FieldTripChoices record retrieved from the database.
            // this.FieldTripOptionId is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.FieldTripOptionIdSpecified) {
               ...
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                ...
                this.FieldTripOptionId.Text = formattedValue;
                  ...
                  this.FieldTripOptionId.ToolTip = "Go to " + this.FieldTripOptionId.Text.Replace("<wbr/>", "");
              ...
              this.FieldTripOptionId.Text = FieldTripChoicesTable.FieldTripOptionId.Format(FieldTripChoicesTable.FieldTripOptionId.DefaultValue);
        ...
        public virtual void SetFieldTripOptionId2()
        {
            ...
            // this.DataSource is the DatabaseOLR_db%dbo.FieldTripChoices record retrieved from the database.
            // this.FieldTripOptionId2 is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.FieldTripOptionId2Specified) {
               ...
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                ...
                this.FieldTripOptionId2.Text = formattedValue;
                  ...
                  this.FieldTripOptionId2.ToolTip = "Go to " + this.FieldTripOptionId2.Text.Replace("<wbr/>", "");
              ...
              this.FieldTripOptionId2.Text = FieldTripChoicesTable.FieldTripOptionId2.Format(FieldTripChoicesTable.FieldTripOptionId2.DefaultValue);
        ...
        public virtual void SetFieldTripOptionId3()
        {
            ...
            // this.DataSource is the DatabaseOLR_db%dbo.FieldTripChoices record retrieved from the database.
            // this.FieldTripOptionId3 is the ASP:LinkButton on the webpage.
            ...
            if (this.DataSource != null && this.DataSource.FieldTripOptionId3Specified) {
               ...
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                ...
                this.FieldTripOptionId3.Text = formattedValue;
                  ...
                  this.FieldTripOptionId3.ToolTip = "Go to " + this.FieldTripOptionId3.Text.Replace("<wbr/>", "");
              ...
              this.FieldTripOptionId3.Text = FieldTripChoicesTable.FieldTripOptionId3.Format(FieldTripChoicesTable.FieldTripOptionId3.DefaultValue);
        ...
        public virtual void SetRecordDeleted()
        {
            ...
            if (this.DataSource != null && this.DataSource.RecordDeletedSpecified) {
               ...
               string formattedValue = this.DataSource.Format(FieldTripChoicesTable.RecordDeleted);
              ...
              this.RecordDeleted.Text = FieldTripChoicesTable.RecordDeleted.Format(FieldTripChoicesTable.RecordDeleted.DefaultValue);
        ...
        public virtual void SetRegistrationId()
        {
            ...
            if (this.DataSource != null && this.DataSource.RegistrationIdSpecified) {
               ...
               if(_isExpandableNonCompositeForeignKey &&FieldTripChoicesTable.RegistrationId.IsApplyDisplayAs)
                     ...
                     formattedValue = FieldTripChoicesTable.GetDFKA(this.DataSource.RegistrationId.ToString(),FieldTripChoicesTable.RegistrationId, null);
                                    
               if ((!_isExpandableNonCompositeForeignKey) || (String.IsNullOrEmpty(formattedValue)))
                     formattedValue = this.DataSource.Format(FieldTripChoicesTable.RegistrationId);
              ...
              this.RegistrationId.Text = FieldTripChoicesTable.RegistrationId.Format(FieldTripChoicesTable.RegistrationId.DefaultValue);
        ...
        public virtual void SetFieldTripChoicesTabContainer()    
        
        {
                            
                   
            if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "true") 
                MiscUtils.FindControlRecursively(this, "FieldTripChoicesTabContainer").Visible = true;
            else if (EvaluateFormula("URL(\"TabVisible\")").ToLower() == "false") 
                MiscUtils.FindControlRecursively(this, "FieldTripChoicesTabContainer").Visible = false;
         
  
        }      
      
        public virtual void SetRegistrationsRecordControl()           
        ...
        public virtual void SaveData()
        {
          ...
          RegistrationsRecordControl recRegistrationsRecordControl = (RegistrationsRecordControl)(MiscUtils.FindControlRecursively(this, "RegistrationsRecordControl"));
        recRegistrationsRecordControl.SaveData();
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void ExpandRowButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                FieldTripChoicesTableControl panelControl = (MiscUtils.GetParentControlObject(this, "FieldTripChoicesTableControl") as FieldTripChoicesTableControl);

          FieldTripChoicesTableControlRow[] repeatedRows = panelControl.GetRecordControls();
          foreach (FieldTripChoicesTableControlRow repeatedRow in repeatedRows)
          {
              System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(repeatedRow, "FieldTripChoicesTableControlAltRow") as System.Web.UI.Control);
              if (altRow != null)
              {
        ...
        public virtual void FieldTripAllocated_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../FieldTripOptions/Show-FieldTripOptions.aspx?FieldTripOptions={FieldTripChoicesTableControlRow:FK:FK_FieldTripChoices_FieldTripOptions3}";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for LinkButton
        public virtual void FieldTripId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../FieldTrips/Show-FieldTrips.aspx?FieldTrips={FieldTripChoicesTableControlRow:FK:FK_FieldTripChoices_FieldTrips}";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for LinkButton
        public virtual void FieldTripOptionId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../FieldTripOptions/Show-FieldTripOptions.aspx?FieldTripOptions={FieldTripChoicesTableControlRow:FK:FK_FieldTripChoices_FieldTripOptions}";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for LinkButton
        public virtual void FieldTripOptionId2_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../FieldTripOptions/Show-FieldTripOptions.aspx?FieldTripOptions={FieldTripChoicesTableControlRow:FK:FK_FieldTripChoices_FieldTripOptions1}";
      ...
      this.Page.Response.Redirect(url);
        ...
        // event handler for LinkButton
        public virtual void FieldTripOptionId3_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../FieldTripOptions/Show-FieldTripOptions.aspx?FieldTripOptions={FieldTripChoicesTableControlRow:FK:FK_FieldTripChoices_FieldTripOptions2}";
...
#region "Helper Properties"
        ...
        public AjaxControlToolkit.TabContainer FieldTripChoicesTabContainer {
            get {
                return (AjaxControlToolkit.TabContainer)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FieldTripChoicesTabContainer");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton FieldTripId {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FieldTripId");
            }
        }
            
        public System.Web.UI.WebControls.Literal FieldTripIdLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FieldTripIdLabel");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton FieldTripOptionId {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FieldTripOptionId");
            }
        }
            
        public System.Web.UI.WebControls.LinkButton FieldTripOptionId2 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FieldTripOptionId2");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton FieldTripOptionId3 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "FieldTripOptionId3");
            }
        }
        ...
        public RegistrationsRecordControl RegistrationsRecordControl {
            get {
                return (RegistrationsRecordControl)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegistrationsRecordControl");
            }
        }
...
// Base class for the FieldTripChoicesTableControl control on the Show_FieldTripChoices_Table page.
...
public class BaseFieldTripChoicesTableControl : OLR.UI.BaseApplicationTableControl
{
       ...
       public BaseFieldTripChoicesTableControl()
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
           ...
           // Setup the filter and search.
            ...
            {
                string initialVal = "";
                if  (this.InSession(this.RegistrationIdFilter)) 				
                    initialVal = this.GetFromSession(this.RegistrationIdFilter);
                
                else
                    
                    initialVal = EvaluateFormula("URL(\"RegistrationId\")");
                ...
                if (initialVal != null && initialVal != "")		
                {
                    ...
                    string[] RegistrationIdFilteritemListFromSession = initialVal.Split(',');
                    int index = 0;
                    foreach (string item in RegistrationIdFilteritemListFromSession)
                    {
                        ...
                        {
                            this.RegistrationIdFilter.Items.Add(item);
                            this.RegistrationIdFilter.Items[index].Selected = true;
                            index += 1;
                        }
                    }
                    foreach (ListItem listItem in this.RegistrationIdFilter.Items)
                    {
    ...
    // Setup default pagination settings.
       ...
       // Setup the sorting events.
            ...
            this.SortControl.SelectedIndexChanged += new EventHandler(SortControl_SelectedIndexChanged);
              ...
              this.RegistrationIdFilter.SelectedIndexChanged += RegistrationIdFilter_SelectedIndexChanged;                  
      ...
      public override void DataBind()
      {
        ...
        FieldTripChoicesTableControlRow[] recControls = this.GetRecordControls();
            for (int i = 0; i < recControls.Length; i++)
            {
                System.Web.UI.Control altRow = (MiscUtils.FindControlRecursively(recControls[i], "FieldTripChoicesTableControlAltRow") as System.Web.UI.Control);
                if (altRow != null){
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public virtual void ResetControl()
        {
            ...
            this.RegistrationIdFilter.ClearSelection();
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.RegistrationIdFilter)) {
                        
                int selectedItemCount = 0;
                foreach (ListItem item in this.RegistrationIdFilter.Items){
                    if (item.Selected) {
                        selectedItemCount += 1;
                ...
                foreach (ListItem item in this.RegistrationIdFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(FieldTripChoicesTable.RegistrationId, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String RegistrationIdFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "RegistrationIdFilter_Ajax"];
            if (MiscUtils.IsValueSelected(RegistrationIdFilterSelectedValue)) {

              
        if (RegistrationIdFilterSelectedValue != null){
                        string[] RegistrationIdFilteritemListFromSession = RegistrationIdFilterSelectedValue.Split(',');
                        int index = 0;
                        WhereClause filter = new WhereClause();
                        foreach (string item in RegistrationIdFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(FieldTripChoicesTable.RegistrationId, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      FieldTripChoicesRecord rec = new FieldTripChoicesRecord();
                        ...
                        if (recControl.FieldTripId.Text != "") {
                            rec.Parse(recControl.FieldTripId.Text, FieldTripChoicesTable.FieldTripId);
                  }
                
                        if (recControl.FieldTripOptionId.Text != "") {
                            rec.Parse(recControl.FieldTripOptionId.Text, FieldTripChoicesTable.FieldTripOptionId);
                  }
                
                        if (recControl.FieldTripOptionId2.Text != "") {
                            rec.Parse(recControl.FieldTripOptionId2.Text, FieldTripChoicesTable.FieldTripOptionId2);
                  }
                
                        if (recControl.FieldTripOptionId3.Text != "") {
                            rec.Parse(recControl.FieldTripOptionId3.Text, FieldTripChoicesTable.FieldTripOptionId3);
                  }
                
                        if (recControl.RecordDeleted.Text != "") {
                            rec.Parse(recControl.RecordDeleted.Text, FieldTripChoicesTable.RecordDeleted);
                  }
                
                        if (recControl.RegistrationId.Text != "") {
                            rec.Parse(recControl.RegistrationId.Text, FieldTripChoicesTable.RegistrationId);
                  }
        ...
        public virtual void SetRegistrationIdLabel1()
                  {
        ...
        public virtual void SetRegistrationIdFilter()
        {
            
            ArrayList RegistrationIdFilterselectedFilterItemList = new ArrayList();
            string RegistrationIdFilteritemsString = null;
            if (this.InSession(this.RegistrationIdFilter))
                RegistrationIdFilteritemsString = this.GetFromSession(this.RegistrationIdFilter);
            
            if (RegistrationIdFilteritemsString != null)
            {
                string[] RegistrationIdFilteritemListFromSession = RegistrationIdFilteritemsString.Split(',');
                foreach (string item in RegistrationIdFilteritemListFromSession)
                {
                    RegistrationIdFilterselectedFilterItemList.Add(item);
                }
            }
              
            			
            this.PopulateRegistrationIdFilter(MiscUtils.GetSelectedValueList(this.RegistrationIdFilter, RegistrationIdFilterselectedFilterItemList), 500);
                    
              string url = this.ModifyRedirectUrl("../Registrations/Registrations-QuickSelector.aspx", "", true);
              
              url = this.Page.ModifyRedirectUrl(url, "", true);                                  
              
              url += "?Target=" + this.RegistrationIdFilter.ClientID + "&DFKA=" + (this.Page as BaseApplicationPage).Encrypt("AdditionalDinnerName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("RegistrationId")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--ANY--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:All")) + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
              
              this.RegistrationIdFilter.Attributes["onClick"] = "initializePopupPage(this, '" + url + "', " + Convert.ToString(RegistrationIdFilter.AutoPostBack).ToLower() + ", event); return false;";
        ...
        // Get the filters' data for RegistrationIdFilter.
                
        protected virtual void PopulateRegistrationIdFilter(ArrayList selectedValue, int maxItems)
                    
        {
            ...
            WhereClause wc = this.CreateWhereClause_RegistrationIdFilter();            
            this.RegistrationIdFilter.Items.Clear();
            			  			
            // Set up the WHERE and the ORDER BY clause by calling the CreateWhereClause_RegistrationIdFilter function.
            ...
            RegistrationsRecord[] itemValues  = null;
            if (wc.RunQuery)
            {
                int counter = 0;
                int pageNum = 0;
                ...
                do
                {
                    ...
                    itemValues = RegistrationsTable.GetRecords(wc, orderBy, pageNum, maxItems);
                                    
                    foreach (RegistrationsRecord itemValue in itemValues) 
                    {
                        ...
                        if (itemValue.RegistrationIdSpecified) 
                        {
                            ...
                            if (counter < maxItems && this.RegistrationIdFilter.Items.FindByValue(cvalue) == null)
                            {
                                ...
                                ListItem dupItem = this.RegistrationIdFilter.Items.FindByText(fvalue);
                                ...
                                this.RegistrationIdFilter.Items.Add(newItem);
            ...
            this.RegistrationIdFilter.SetFieldMaxLength(50);
                                 
                  
            // Add the selected value.
            if (this.RegistrationIdFilter.Items.Count == 0)
                this.RegistrationIdFilter.Items.Add(new ListItem(Page.GetResourceValue("Txt:All", "OLR"), "--ANY--"));
        ...
        public virtual WhereClause CreateWhereClause_RegistrationIdFilter()
        {
            // Create a where clause for the filter RegistrationIdFilter.
            // This function is called by the Populate method to load the items 
            // in the RegistrationIdFilterQuickSelector
            ...
            RegistrationIdFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.RegistrationIdFilter, RegistrationIdFilterselectedFilterItemList); 
            WhereClause wc = new WhereClause();
            if (RegistrationIdFilterselectedFilterItemList == null || RegistrationIdFilterselectedFilterItemList.Count == 0)
                wc.RunQuery = false;
            else            
            {
                foreach (string item in RegistrationIdFilterselectedFilterItemList)
                {
            	  
                    wc.iOR(RegistrationsTable.RegistrationId, BaseFilter.ComparisonOperator.EqualsTo, item);                  
        ...
        protected override void SaveControlsToSession()
        {
            ...
            ArrayList RegistrationIdFilterselectedFilterItemList = MiscUtils.GetSelectedValueList(this.RegistrationIdFilter, null);
            string RegistrationIdFilterSessionString = "";
            if (RegistrationIdFilterselectedFilterItemList != null){
                foreach (string item in RegistrationIdFilterselectedFilterItemList){
                    RegistrationIdFilterSessionString = String.Concat(RegistrationIdFilterSessionString ,"," , item);
                }
            }
            this.SaveToSession(this.RegistrationIdFilter, RegistrationIdFilterSessionString);
        ...
        protected  void SaveControlsToSession_Ajax()
        {
            ...
            this.SaveToSession("RegistrationIdFilter_Ajax", RegistrationIdFilterSessionString);
        ...
        protected override void ClearControlsFromSession()
        {
            ...
            this.RemoveFromSession(this.RegistrationIdFilter);
    ...
    this.ViewState["Page_Size"] = this.PageSize;
              ...
              
        {
                    ...
                    this.ImportButton.PostBackUrl = "../Shared/SelectFileToImport.aspx?TableName=FieldTripChoices" ;
              ...
              
        {
              ...
              try
              {
                    ...
                    url = url + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup") + "&Target=" + (this.Page as BaseApplicationPage).Encrypt(MiscUtils.FindControlRecursively(this, "FieldTripChoicesTableControl_PostbackTracker").ClientID);                           
                                
                string javascriptCall = "";
                
                    javascriptCall = "initializePopupPage2(document.getElementById('" + MiscUtils.FindControlRecursively(this, "FieldTripChoicesTableControl_PostbackTracker").ClientID + "'), '" + url + "', true, event);";                                      
              ...
              
        {
         ...
         themeButtonFiltersButton.ArrowImage.ImageUrl = "../Images/ButtonExpandArrow.png";
            ...
            if (MiscUtils.IsValueSelected(RegistrationIdFilter))
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
              ...
              this.TotalRecords = FieldTripChoicesTable.GetRecordCount(join, wc);
              if (this.TotalRecords > 10000)
              {
              
                // Add each of the columns in order of export.
                BaseColumn[] columns = new BaseColumn[] {
                             FieldTripChoicesTable.FieldTripOptionId,
             FieldTripChoicesTable.RegistrationId,
             FieldTripChoicesTable.FieldTripOptionId2,
             FieldTripChoicesTable.FieldTripOptionId3,
             FieldTripChoicesTable.FieldTripId,
             FieldTripChoicesTable.RecordDeleted,
             FieldTripChoicesTable.FieldTripAllocated,
             null};
                ExportDataToCSV exportData = new ExportDataToCSV(FieldTripChoicesTable.Instance,wc,orderBy,columns);
                exportData.StartExport(this.Page.Response, true);

                DataForExport dataForCSV = new DataForExport(FieldTripChoicesTable.Instance, wc, orderBy, columns,join);
              ...
              ExportDataToExcel excelReport = new ExportDataToExcel(FieldTripChoicesTable.Instance, wc, orderBy);
              // Add each of the columns in order of export.
              ...
              int width = 0;
              int columnCounter = 0;
              DataForExport data = new DataForExport(FieldTripChoicesTable.Instance, wc, orderBy, null,join);
                           data.ColumnList.Add(new ExcelColumn(FieldTripChoicesTable.FieldTripOptionId, "Default"));
             data.ColumnList.Add(new ExcelColumn(FieldTripChoicesTable.RegistrationId, "Default"));
             data.ColumnList.Add(new ExcelColumn(FieldTripChoicesTable.FieldTripOptionId2, "Default"));
             data.ColumnList.Add(new ExcelColumn(FieldTripChoicesTable.FieldTripOptionId3, "Default"));
             data.ColumnList.Add(new ExcelColumn(FieldTripChoicesTable.FieldTripId, "Default"));
             data.ColumnList.Add(new ExcelColumn(FieldTripChoicesTable.RecordDeleted, "Default"));
             data.ColumnList.Add(new ExcelColumn(FieldTripChoicesTable.FieldTripAllocated, "Default"));
              ...
              {
                val = FieldTripChoicesTable.GetDFKA(rec.GetValue(col.DisplayColumn).ToString(), col.DisplayColumn, null) as string;
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTripChoices-Table.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTripChoices";
                // If Show-FieldTripChoices-Table.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 report.AddColumn(FieldTripChoicesTable.FieldTripOptionId.Name, ReportEnum.Align.Left, "${FieldTripOptionId}", ReportEnum.Align.Left, 22);
                 report.AddColumn(FieldTripChoicesTable.RegistrationId.Name, ReportEnum.Align.Left, "${RegistrationId}", ReportEnum.Align.Left, 28);
                 report.AddColumn(FieldTripChoicesTable.FieldTripOptionId2.Name, ReportEnum.Align.Left, "${FieldTripOptionId2}", ReportEnum.Align.Left, 22);
                 report.AddColumn(FieldTripChoicesTable.FieldTripOptionId3.Name, ReportEnum.Align.Left, "${FieldTripOptionId3}", ReportEnum.Align.Left, 22);
                 report.AddColumn(FieldTripChoicesTable.FieldTripId.Name, ReportEnum.Align.Left, "${FieldTripId}", ReportEnum.Align.Left, 30);
                 report.AddColumn(FieldTripChoicesTable.RecordDeleted.Name, ReportEnum.Align.Left, "${RecordDeleted}", ReportEnum.Align.Left, 15);
                 report.AddColumn(FieldTripChoicesTable.FieldTripAllocated.Name, ReportEnum.Align.Left, "${FieldTripAllocated}", ReportEnum.Align.Left, 28);
                ...
                ColumnList columns = FieldTripChoicesTable.GetColumnList();
                ...
                int pageNum = 0;
                int totalRows = FieldTripChoicesTable.GetRecordCount(joinFilter,whereClause);
                FieldTripChoicesRecord[] records = null;
                
                do
                {
                    
                    records = FieldTripChoicesTable.GetRecords(joinFilter,whereClause, orderBy, pageNum, rowsPerQuery);
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                        foreach ( FieldTripChoicesRecord record in records)
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                                 ...
                                 report.AddData("${FieldTripOptionId}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = FieldTripChoicesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(FieldTripChoicesTable.FieldTripOptionId);
                                 _DFKA = FieldTripChoicesTable.GetDFKA(record.FieldTripOptionId.ToString(), FieldTripChoicesTable.FieldTripOptionId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  FieldTripChoicesTable.FieldTripOptionId.IsApplyDisplayAs){
                                     report.AddData("${FieldTripOptionId}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${FieldTripOptionId}", record.Format(FieldTripChoicesTable.FieldTripOptionId), ReportEnum.Align.Left);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.RegistrationId)){
                                 report.AddData("${RegistrationId}", "",ReportEnum.Align.Left, 300);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = FieldTripChoicesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(FieldTripChoicesTable.RegistrationId);
                                 _DFKA = FieldTripChoicesTable.GetDFKA(record.RegistrationId.ToString(), FieldTripChoicesTable.RegistrationId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  FieldTripChoicesTable.RegistrationId.IsApplyDisplayAs){
                                     report.AddData("${RegistrationId}", _DFKA,ReportEnum.Align.Left, 300);
                                 }else{
                                     report.AddData("${RegistrationId}", record.Format(FieldTripChoicesTable.RegistrationId), ReportEnum.Align.Left, 300);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.FieldTripOptionId2)){
                                 report.AddData("${FieldTripOptionId2}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = FieldTripChoicesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(FieldTripChoicesTable.FieldTripOptionId2);
                                 _DFKA = FieldTripChoicesTable.GetDFKA(record.FieldTripOptionId2.ToString(), FieldTripChoicesTable.FieldTripOptionId2,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  FieldTripChoicesTable.FieldTripOptionId2.IsApplyDisplayAs){
                                     report.AddData("${FieldTripOptionId2}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${FieldTripOptionId2}", record.Format(FieldTripChoicesTable.FieldTripOptionId2), ReportEnum.Align.Left);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.FieldTripOptionId3)){
                                 report.AddData("${FieldTripOptionId3}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = FieldTripChoicesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(FieldTripChoicesTable.FieldTripOptionId3);
                                 _DFKA = FieldTripChoicesTable.GetDFKA(record.FieldTripOptionId3.ToString(), FieldTripChoicesTable.FieldTripOptionId3,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  FieldTripChoicesTable.FieldTripOptionId3.IsApplyDisplayAs){
                                     report.AddData("${FieldTripOptionId3}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${FieldTripOptionId3}", record.Format(FieldTripChoicesTable.FieldTripOptionId3), ReportEnum.Align.Left);
                                 }
                             }
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.FieldTripId)){
                                 report.AddData("${FieldTripId}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = FieldTripChoicesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(FieldTripChoicesTable.FieldTripId);
                                 _DFKA = FieldTripChoicesTable.GetDFKA(record.FieldTripId.ToString(), FieldTripChoicesTable.FieldTripId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  FieldTripChoicesTable.FieldTripId.IsApplyDisplayAs){
                                     report.AddData("${FieldTripId}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${FieldTripId}", record.Format(FieldTripChoicesTable.FieldTripId), ReportEnum.Align.Left);
                                 }
                             }
                             report.AddData("${RecordDeleted}", record.Format(FieldTripChoicesTable.RecordDeleted), ReportEnum.Align.Left, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.FieldTripAllocated)){
                                 report.AddData("${FieldTripAllocated}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = FieldTripChoicesTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(FieldTripChoicesTable.FieldTripAllocated);
                                 _DFKA = FieldTripChoicesTable.GetDFKA(record.FieldTripAllocated.ToString(), FieldTripChoicesTable.FieldTripAllocated,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  FieldTripChoicesTable.FieldTripAllocated.IsApplyDisplayAs){
                                     report.AddData("${FieldTripAllocated}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${FieldTripAllocated}", record.Format(FieldTripChoicesTable.FieldTripAllocated), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTripChoices-Table.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTripChoices";
                // If Show-FieldTripChoices-Table.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
        ...
        protected virtual void RegistrationIdFilter_SelectedIndexChanged(object sender, EventArgs args)
        {
            // Setting the DataChanged to True results in the page being refreshed with
            // the most recent data from the database.  This happens in PreRender event
            // based on the current sort, search and filter criteria.
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector RegistrationIdFilter {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegistrationIdFilter");
            }
        }              
        
        public System.Web.UI.WebControls.Literal RegistrationIdLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RegistrationIdLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public virtual FieldTripChoicesTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripChoicesTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTripChoices_Table.FieldTripChoicesTableControlRow")));
...
// Base class for the RegistrationsRecordControl control on the Show_FieldTripChoices_Table page.
...
public class BaseRegistrationsRecordControl : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SaveData()
        {
          ...
          FieldTripChoicesTableControlRow parentCtrl;
      
            parentCtrl = (FieldTripChoicesTableControlRow)MiscUtils.GetParentControlObject(this, "FieldTripChoicesTableControlRow");
      ...
      KeyValue selectedRecordKeyValue = new KeyValue();
          ...
          KeyValue fieldTripChoicesRecordObj = null;
          // make variable assignment here to avoid possible incorrect compiler warning
          KeyValue tmp = fieldTripChoicesRecordObj;
          fieldTripChoicesRecordObj = tmp;
        FieldTripChoicesTableControlRow fieldTripChoicesTableControlObjRow = (MiscUtils.GetParentControlObject(this, "FieldTripChoicesTableControlRow") as FieldTripChoicesTableControlRow);
          
              if (fieldTripChoicesTableControlObjRow != null && fieldTripChoicesTableControlObjRow.GetRecord() != null)
              {
              wc.iAND(RegistrationsTable.RegistrationId, BaseFilter.ComparisonOperator.EqualsTo, fieldTripChoicesTableControlObjRow.GetRecord().RegistrationId.ToString());
              }
              else
              {
              wc.RunQuery = false;
      ...
      HttpContext.Current.Session["RegistrationsRecordControlWhereClause"] = selectedRecordKeyValue.ToXmlString();
      ...
      string selectedRecordInFieldTripChoicesTableControl = HttpContext.Current.Session["RegistrationsRecordControlWhereClause"] as string;
      
      if (selectedRecordInFieldTripChoicesTableControl != null && KeyValue.IsXmlKey(selectedRecordInFieldTripChoicesTableControl))
      {
      KeyValue selectedRecordKeyValue = KeyValue.XmlToKey(selectedRecordInFieldTripChoicesTableControl);
      
      if (selectedRecordKeyValue != null && selectedRecordKeyValue.ContainsColumn(RegistrationsTable.RegistrationId))
      {
      wc.iAND(RegistrationsTable.RegistrationId, BaseFilter.ComparisonOperator.EqualsTo, selectedRecordKeyValue.GetColumnValue(RegistrationsTable.RegistrationId).ToString());
      }
        ...
        public virtual void ContactId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Contacts/Show-Contacts.aspx?Contacts={RegistrationsRecordControl:FK:FK_Registrations_Contacts}";
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void RegistrationTypeId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../RegistrationTypes/Show-RegistrationTypes.aspx?RegistrationTypes={RegistrationsRecordControl:FK:FK_Registrations_RegistrationTypes}";
