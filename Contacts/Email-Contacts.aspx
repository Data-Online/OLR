<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" Codebehind="Email-Contacts.aspx.cs" Culture="en-NZ" MasterPageFile="../Master Pages/Email.master" Inherits="OLR.UI.Email_Contacts" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<%@ Register Tagprefix="OLR" Namespace="OLR.UI.Controls.Email_Contacts" Assembly="OLR" %>
