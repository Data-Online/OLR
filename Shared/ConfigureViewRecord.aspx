                                        ...
                                        <ol>
                                            ...
                                            <li>Go to the Application Explorer tab, navigate in the tree to the page that contains
                                                ...
                                                <ul style="list-style-type: disc">
                                                    <li>Select the name of the View button or icon on the page. Then click the 'Redirect' property present in the 'Button Actions' section on the Properties sheet.</li>
