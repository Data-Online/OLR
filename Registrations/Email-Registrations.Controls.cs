...
// Email_Registrations.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Email_Registrations
{
...
// Base class for the RegistrationsRecordControl control on the Email_Registrations page.
...
public class BaseRegistrationsRecordControl : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RegistrationsRecordControl.
         ...
         
        {
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["Registrations"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OLR").Replace("{URL}", "Registrations"));
            }
            HttpContext.Current.Session["QueryString in Email-Registrations"] = recId;
