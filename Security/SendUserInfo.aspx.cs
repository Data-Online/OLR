...
public partial class SendUserInfo
        : BaseApplicationPage
...
#region "Section 2: Do not modify this section."
        ...
        public System.Web.UI.WebControls.Label InformationLabel;
        
        public System.Web.UI.WebControls.Literal MyLoginInfo;
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void EmailSetupError(string msg)
        {
            string stlTable = "style=\"font-family:Verdana,Geneva,ms sans serif; font-size:12px;\"";
            msg = "<tr><td>" + msg + "</td><tr>" + Environment.NewLine;
            this.MyLoginInfo.Text = "<table width=100% " + stlTable + ">" + Environment.NewLine + msg + "</table>";
