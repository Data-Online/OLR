...
// This file implements the code-behind class for AvailableWorkshops_QuickSelector.aspx.
// AvailableWorkshops_QuickSelector.Controls.vb contains the Table, Row and Record control classes
...
public partial class AvailableWorkshops_QuickSelector
        : BaseApplicationPage
// Code-behind class for the AvailableWorkshops_QuickSelector page.
// Place your customizations in Section 1. Do not modify Section 2.
{
        
      #region "Section 1: Place your customizations here."

      public AvailableWorkshops_QuickSelector()
        {
            this.Initialize();
...
#region "Section 2: Do not modify this section."
        ...
        public OLR.UI.Controls.AvailableWorkshops_QuickSelector.SelectorTableControl SelectorTableControl;
    ...
    public static string[] GetAutoCompletionList_Search_Base(string prefixText, int count)
    {
        ...
        OLR.UI.Controls.AvailableWorkshops_QuickSelector.SelectorTableControl control = new OLR.UI.Controls.AvailableWorkshops_QuickSelector.SelectorTableControl();
