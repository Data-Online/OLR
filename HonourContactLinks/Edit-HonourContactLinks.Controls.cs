...
// Edit_HonourContactLinks.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Edit_HonourContactLinks
{
...
public class HonourContactLinksRecordControl : BaseHonourContactLinksRecordControl
{
      
        // The BaseHonourContactLinksRecordControl implements the LoadData, DataBind and other
...
// Base class for the HonourContactLinksRecordControl control on the Edit_HonourContactLinks page.
// Do not modify this class. Instead override any method in HonourContactLinksRecordControl.
public class BaseHonourContactLinksRecordControl : OLR.UI.BaseApplicationRecordControl
{
        public BaseHonourContactLinksRecordControl()
        {
        ...
        // To customize, override this method in HonourContactLinksRecordControl.
        ...
        {      
              ...
              this.HonourId.SelectedIndexChanged += HonourId_SelectedIndexChanged;                  
        ...
        public virtual void LoadData()  
        {
            ...
            System.Web.UI.WebControls.Panel Panel = (System.Web.UI.WebControls.Panel)MiscUtils.FindControlRecursively(this, "HonourContactLinksRecordControlPanel");
            if (Panel != null){
                Panel.Visible = true;
            }
            ...
            HonourContactLinksRecord[] recList = HonourContactLinksTable.GetRecords(wc, null, 0, 2);
            if (recList.Length == 0) {
            ...
            this.DataSource = HonourContactLinksTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual void SetContactId()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = HonourContactLinksTable.ContactId.DefaultValue;
                ...
                !MiscUtils.SetSelectedDisplayText(this.ContactId, selectedValue))
            {
                ...
                try
                {
                    ...
                    if (rc != null && rc.Length == 1)
                    {
                        ...
                        Boolean _isExpandableNonCompositeForeignKey = HonourContactLinksTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(HonourContactLinksTable.ContactId);
                        if(_isExpandableNonCompositeForeignKey && HonourContactLinksTable.ContactId.IsApplyDisplayAs)
                            fvalue = HonourContactLinksTable.GetDFKA(itemValue, HonourContactLinksTable.ContactId);
              ...
              url += "?Target=" + this.ContactId.ClientID + "&Formula=" + (this.Page as BaseApplicationPage).Encrypt("= LastName + \", \" + FirstName")+ "&IndexField=" + (this.Page as BaseApplicationPage).Encrypt("ContactId")+ "&EmptyValue=" + (this.Page as BaseApplicationPage).Encrypt("--PLEASE_SELECT--") + "&EmptyDisplayText=" + (this.Page as BaseApplicationPage).Encrypt(this.Page.GetResourceValue("Txt:PleaseSelect"))+ "&Mode=" + (this.Page as BaseApplicationPage).Encrypt("FieldValueSingleSelection") + "&RedirectStyle=" + (this.Page as BaseApplicationPage).Encrypt("Popup");
        ...
        public virtual void SetHonourId()
        {
            ...
            else
            {
                ...
                if (this.DataSource != null && this.DataSource.IsCreated)
                    ...
                    selectedValue = HonourContactLinksTable.HonourId.DefaultValue;
        ...
        public virtual void SetHonourIdLabel()
                  {
        ...
        public virtual void GetContactId()
        {
         // Retrieve the value entered by the user on the ContactId ASP:QuickSelector, and
            // save it into the ContactId field in DataSource DatabaseOLR_db%dbo.HonourContactLinks record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.ContactId), HonourContactLinksTable.ContactId);			
                			 
        }
                
        public virtual void GetHonourId()
        {
         // Retrieve the value entered by the user on the HonourId ASP:QuickSelector, and
            // save it into the HonourId field in DataSource DatabaseOLR_db%dbo.HonourContactLinks record.
            
            // Custom validation should be performed in Validate, not here.
            
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.HonourId), HonourContactLinksTable.HonourId);			
      ...
      // To customize, override this method in HonourContactLinksRecordControl.
         ...
         
        {
            ...
            bool hasFiltersHonourContactLinksRecordControl = false;
            hasFiltersHonourContactLinksRecordControl = hasFiltersHonourContactLinksRecordControl && false; // suppress warning
            ...
            string recId = ((BaseApplicationPage)(this.Page)).Decrypt(this.Page.Request.QueryString["HonourContactLinks"]);
                
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "OLR").Replace("{URL}", "HonourContactLinks"));
            }
            HttpContext.Current.Session["QueryString in Edit-HonourContactLinks"] = recId;
          ...
          wc.iAND(HonourContactLinksTable.HonourContactLinkId, BaseFilter.ComparisonOperator.EqualsTo, pkValue.GetColumnValueString(HonourContactLinksTable.HonourContactLinkId));
          
            }
            else {
                // The URL parameter contains the actual value, not an XML structure.
            
          wc.iAND(HonourContactLinksTable.HonourContactLinkId, BaseFilter.ComparisonOperator.EqualsTo, recId);
        ...
        protected virtual void HonourId_SelectedIndexChanged(object sender, EventArgs args)
        {
        ...
        public String RecordUniqueId {
            get {
                return (string)this.ViewState["BaseHonourContactLinksRecordControl_Rec"];
            }
            set {
                this.ViewState["BaseHonourContactLinksRecordControl_Rec"] = value;
            }
        }
...
#region "Helper Properties"
        ...
        public BaseClasses.Web.UI.WebControls.QuickSelector HonourId {
            get {
                return (BaseClasses.Web.UI.WebControls.QuickSelector)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HonourId");
            }
        }              
            
        public System.Web.UI.WebControls.Literal HonourIdLabel {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "HonourIdLabel");
            }
        }
