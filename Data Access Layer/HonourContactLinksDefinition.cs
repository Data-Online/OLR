...
/// <see cref="HonourContactLinksTable">OLR.HonourContactLinksTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="HonourContactLinksTable"></seealso>
public class HonourContactLinksDefinition
{
#region "Definition (XML) for HonourContactLinksDefinition table"
	//Next 191 lines contain Table Definition (XML) for table "HonourContactLinksDefinition"
	...
	/// <see cref="HonourContactLinksTable"></see>
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(        @"<columnFKName>FK_HonorContactLinks_Honors</columnFKName>");
         tbf.Append(        @"<columnFKTable>OLR.Business.HonoursTable, OLR.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>HonourId</columnFKColumn>");
         tbf.Append(        @"<columnFKColumnDisplay>= Honours.Description</columnFKColumnDisplay>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_HonorContactLinks_Contacts</columnFKName>");
         ...
         tbf.Append(      @"<columnName>HonourContactLinkId</columnName>");
         tbf.Append(      @"<columnUIName>Honour Contact Link</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         tbf.Append(      @"<columnDefault></columnDefault>");
         ...
         tbf.Append(    "</Column>");
         tbf.Append(  "</ColumnDefinition>");
         tbf.Append(  @"<TableName>HonourContactLinks</TableName>");
         tbf.Append(  @"<Version>3</Version>");
         tbf.Append(  @"<Owner>dbo</Owner>");
         tbf.Append(  @"<TableAliasName>HonourContactLinks_</TableAliasName>");
         ...
         tbf.Append(  @"<TableCodeName>HonourContactLinks</TableCodeName>");
         tbf.Append(  @"<FolderName>HonourContactLinks</FolderName>");
         tbf.Append(  @"<MenuName>Honour Contact Links</MenuName>");
         tbf.Append(  @"<QSPath>../HonourContactLinks/HonourContactLinks-QuickSelector.aspx</QSPath>");
         tbf.Append(  @"<TableStoredProcPrefix>pOLRHonourContactLinks</TableStoredProcPrefix>");
