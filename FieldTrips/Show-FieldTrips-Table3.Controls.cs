...
// Show_FieldTrips_Table3.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_FieldTrips_Table3
{
...
// Base class for the FieldTripOptionsTableControlRow control on the Show_FieldTrips_Table3 page.
...
// Base class for the FieldTripOptionsTableControl control on the Show_FieldTrips_Table3 page.
...
public class BaseFieldTripOptionsTableControl : OLR.UI.BaseApplicationTableControl
{
      ...
      FieldTripOptionsRecord rec = new FieldTripOptionsRecord();
                    ...
                    
        {
              ...
              // 1. Setup the static list items
                ...
                this.SortControl1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Places Available {Txt:Ascending}"), "PlacesAvailable Asc"));
              
                this.SortControl1.Items.Add(new ListItem(this.Page.ExpandResourceValue("Places Available {Txt:Descending}"), "PlacesAvailable Desc"));
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        protected virtual void SortControl1_SelectedIndexChanged(object sender, EventArgs args)
        {
                  ...
                  foreach (BaseClasses.Data.BaseColumn ColumnNam in FieldTripOptionsTable.GetColumns())
                  {
                ...
                OrderByItem sd = this.CurrentSortOrder.Find(FieldTripOptionsTable.GetColumnByName(SelVal1));
                if (sd == null || this.CurrentSortOrder.Items != null)
                {
                // First time sort, so add sort order for Discontinued.
                if (FieldTripOptionsTable.GetColumnByName(SelVal1) != null)
                {
                  this.CurrentSortOrder.Reset();
                }
                ...
                if ((this.CurrentSortOrder).GetType() == typeof(GeoOrderBy)) this.CurrentSortOrder = new OrderBy(true, false);
                  ...
                  if (SelVal1 != "--PLEASE_SELECT--" && FieldTripOptionsTable.GetColumnByName(SelVal1) != null)
                  {
                    if (words1[words1.Length - 1].Contains("ASC"))
                  {
                  this.CurrentSortOrder.Add(FieldTripOptionsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Asc);
                    }
                    else
                    {
                      if (words1[words1.Length - 1].Contains("DESC"))
                  {
                  this.CurrentSortOrder.Add(FieldTripOptionsTable.GetColumnByName(SelVal1),OrderByItem.OrderDir.Desc );
                      }
                    }
                  }
...
#region "Helper Functions"
        ...
        public virtual FieldTripOptionsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripOptionsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Table3.FieldTripOptionsTableControlRow")));
...
// Base class for the FieldTripsTableControlRow control on the Show_FieldTrips_Table3 page.
...
public class BaseFieldTripsTableControlRow : OLR.UI.BaseApplicationRecordControl
{
        ...
        public virtual void SetEventId()
        {
            ...
            if (this.DataSource != null && this.DataSource.EventIdSpecified) {
              ...
              this.EventId.Text = FieldTripsTable.EventId.Format(FieldTripsTable.EventId.DefaultValue);
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void EventId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Events/Show-Events.aspx?Events={FieldTripsTableControlRow:FK:FK_FieldTrips_Events}";
...
// Base class for the FieldTripsTableControl control on the Show_FieldTrips_Table3 page.
...
public class BaseFieldTripsTableControl : OLR.UI.BaseApplicationTableControl
{
    ...
    public virtual void AddWarningMessageOnClick() {
        ...
        public void PreFetchForeignKeyValues() {
            ...
            this.Page.PregetDfkaRecords(FieldTripsTable.EventId, this.DataSource);
        }
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (MiscUtils.IsValueSelected(this.EventIdFilter)) {
                ...
                foreach (ListItem item in this.EventIdFilter.Items){
                    ...
                    if (item.Selected){
                        filter.iOR(FieldTripsTable.EventId, BaseFilter.ComparisonOperator.EqualsTo, item.Value, false, false);
                    }
                }
                wc.iAND(filter);
      ...
      String EventIdFilterSelectedValue = (String)HttpContext.Current.Session[HttpContext.Current.Session.SessionID + appRelativeVirtualPath + "EventIdFilter_Ajax"];
        ...
        if (EventIdFilterSelectedValue != null){
                        ...
                        foreach (string item in EventIdFilteritemListFromSession)
                        {
                            ...
                            {
                                filter.iOR(FieldTripsTable.EventId, BaseFilter.ComparisonOperator.EqualsTo, item, false, false);
                                index += 1;
                            }
                        }
                        wc.iAND(filter);
      ...
      FieldTripsRecord rec = new FieldTripsRecord();
                        ...
                        if (recControl.EventId.Text != "") {
                            rec.Parse(recControl.EventId.Text, FieldTripsTable.EventId);
                  }
    ...
    this.ViewState["Page_Size"] = this.PageSize;
        ...
        public virtual void ExcelButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            // Create the Order By clause based on the user's current sorting preference.
             ...
             FieldTripsTable.Time,
             FieldTripsTable.EventId,
             null};
             ...
             data.ColumnList.Add(new ExcelColumn(FieldTripsTable.Time, "Short Date"));
             data.ColumnList.Add(new ExcelColumn(FieldTripsTable.EventId, "Default"));
        ...
        public virtual void PDFButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTrips-Table3.PDFButton.report");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTrips";
                // If Show-FieldTrips-Table3.PDFButton.report specifies a valid report template,
                ...
                // The 5th parameter represents the relative width of the column
                 ...
                 report.AddColumn(FieldTripsTable.Time.Name, ReportEnum.Align.Left, "${Time}", ReportEnum.Align.Left, 20);
                 report.AddColumn(FieldTripsTable.EventId.Name, ReportEnum.Align.Left, "${EventId}", ReportEnum.Align.Left, 28);
                     ...
                     if (records != null && records.Length > 0 && whereClause.RunQuery)
                    {
                    ...
                    
                        {
                            ...
                            // The 4th parameter represent the maximum length of the data value being shown
                             ...
                             report.AddData("${Time}", record.Format(FieldTripsTable.Time), ReportEnum.Align.Left, 300);
                             if (BaseClasses.Utils.MiscUtils.IsNull(record.EventId)){
                                 report.AddData("${EventId}", "",ReportEnum.Align.Left);
                             }else{
                                 Boolean _isExpandableNonCompositeForeignKey;
                                 String _DFKA = "";
                                 _isExpandableNonCompositeForeignKey = FieldTripsTable.Instance.TableDefinition.IsExpandableNonCompositeForeignKey(FieldTripsTable.EventId);
                                 _DFKA = FieldTripsTable.GetDFKA(record.EventId.ToString(), FieldTripsTable.EventId,null);
                                 if (_isExpandableNonCompositeForeignKey &&  ( _DFKA  != null)  &&  FieldTripsTable.EventId.IsApplyDisplayAs){
                                     report.AddData("${EventId}", _DFKA,ReportEnum.Align.Left);
                                 }else{
                                     report.AddData("${EventId}", record.Format(FieldTripsTable.EventId), ReportEnum.Align.Left);
                                 }
                             }
        ...
        public virtual void WordButton_Click(object sender, ImageClickEventArgs args)
        {
            ...
            try {
                ...
                report.SpecificReportFileName = Page.Server.MapPath("Show-FieldTrips-Table3.WordButton.word");
                // report.Title replaces the value tag of page header and footer containing ${ReportTitle}
                report.Title = "FieldTrips";
                // If Show-FieldTrips-Table3.WordButton.report specifies a valid report template,
                // AddColumn methods will generate a report template.
                // Each AddColumn method-call specifies a column
                // The 1st parameter represents the text of the column header
                // The 2nd parameter represents the horizontal alignment of the column header
...
#region "Helper Functions"
        ...
        public virtual FieldTripsTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (FieldTripsTableControlRow[])((new ArrayList()).ToArray(Type.GetType("OLR.UI.Controls.Show_FieldTrips_Table3.FieldTripsTableControlRow")));
