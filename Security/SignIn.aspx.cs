...
namespace OLR.UI
{
    ...
    // Place your customizations in Section 1. Do not modify Section 2.
    {
        ...
        protected void RedirectOnSuccess()
        {
            ...
            else
            {
                ...
                rolesToCheck = new string[] { "Administrator" };
                bool admin = UserSecurityTools.UserInTheseRoles(rolesToCheck, roles);
        ...
        protected void SignIn_LoginSucceeded(object sender, System.EventArgs e)
        {
            ...
            //// Create where string 
            //string whereStr = UsersTable.ActiveEventId.UniqueName + " = " + "'" + userId + "'";

            //// Create the order by string
            //BaseClasses.Data.OrderBy oB = null;

            //// Get the record
            //UsersRecord myRecord = UsersTable.GetRecord(whereStr, oB);
            ...
            UserSecurityTools.SetEventIdSessionVariable(false);
        }
    ...
    public string EvaluateFormula_Base(string formula, BaseClasses.Data.BaseRecord dataSourceForEvaluate, string format, System.Collections.Generic.IDictionary<string, object> variables, bool includeDS)
        ...
        public void EmailLinkButton_Click_Base(object sender, EventArgs args)
        {
            ...
            // redirected to the URL.
              ...
              string url = BaseClasses.Configuration.ApplicationSettings.Current.ForgotUserPageUrl;
   ...
   #region " Misc Methods "
        ...
        get { return ((BaseApplicationPage)this.Page).GetResourceValue("Err:InvalidLoginInfo", "OLR"); }
        }


        public string ERR_INTERNAL_ERROR {
            get { return ((BaseApplicationPage)this.Page).GetResourceValue("Err:InternalErrorLogin", "OLR"); }
        }


        public string LOGIN_MSG {
            get { return ((BaseApplicationPage)this.Page).GetResourceValue("Txt:LoginMsg", "OLR"); }
        }


        public string LOGIN_MSG_SESSION_INVALID {
            get { return ((BaseApplicationPage)this.Page).GetResourceValue("Txt:LoginMsgSessionInvalid", "OLR"); }
        }
   #endregion
