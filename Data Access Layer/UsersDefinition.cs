...
/// <see cref="UsersTable">OLR.UsersTable</see> class
...
#region "Definition (XML) for UsersDefinition table"
	//Next 504 lines contain Table Definition (XML) for table "UsersDefinition"
	...
	public static string GetXMLString()
	{
		if(_DefinitionString == "")
		{
         ...
         tbf.Append(      @"<columnName>LastLoginDate</columnName>");
         tbf.Append(      @"<columnUIName>Last Login Date</columnUIName>");
         ...
         tbf.Append(        @"<columnFKName>FK_Users_Roles</columnFKName>");
         tbf.Append(        @"<columnFKTable>OLR.Business.Roles1Table, OLR.Business</columnFKTable>");
         tbf.Append(        @"<columnFKOwner>dbo</columnFKOwner>");
         tbf.Append(        @"<columnFKColumn>RoleID</columnFKColumn>");
         tbf.Append(        @"<columnFKColumnDisplay>RoleName</columnFKColumnDisplay>");
         ...
         tbf.Append(      @"<columnName>ActiveEventId</columnName>");
         tbf.Append(      @"<columnUIName>Active Event</columnUIName>");
         tbf.Append(      @"<columnType>Number</columnType>");
         tbf.Append(      @"<columnDBType>int</columnDBType>");
         tbf.Append(      @"<columnLengthSet>10.0</columnLengthSet>");
         ...
         tbf.Append(      @"<applyLabelText>Y</applyLabelText>");
         tbf.Append(      @"<foreignKey>");
         tbf.Append(        @"<columnFKName>FK_Users_Events</columnFKName>");
         ...
         tbf.Append(  @"<TableStoredProcPrefix>pOLRUsers</TableStoredProcPrefix>");
