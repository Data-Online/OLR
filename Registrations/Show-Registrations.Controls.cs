...
// Show_Registrations.aspx page.  The Row or RecordControl classes are the 
...
namespace OLR.UI.Controls.Show_Registrations
{
...
// Base class for the RegistrationsRecordControl control on the Show_Registrations page.
...
public class BaseRegistrationsRecordControl : OLR.UI.BaseApplicationRecordControl
{
      ...
      // To customize, override this method in RegistrationsRecordControl.
         ...
         
        {
            ...
            HttpContext.Current.Session["QueryString in Show-Registrations"] = recId;
      ...
      this.Page.Response.Redirect(url);
        ...
        public virtual void EventId_Click(object sender, EventArgs args)
        {
            ...
            string url = @"../Events/Show-Events.aspx?Events={RegistrationsRecordControl:FK:FK_Registrations_Events}";
